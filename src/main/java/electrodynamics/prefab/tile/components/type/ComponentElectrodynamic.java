...
public class ComponentElectrodynamic implements IComponent, ICapabilityElectrodynamic {
	...
	@Override
	@Deprecated // "This is only if you need to force the internal joules count and is overriden in classes where you can do this."
	...
	public void overVoltage(TransferPack transfer) {
		...
		world.explode(null, pos.getX(), pos.getY(), pos.getZ(), (float) Math.log10(10 + transfer.getVoltage() / getVoltage()), Mode.DESTROY);
	}
