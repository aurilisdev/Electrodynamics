...
public abstract class AbstractFluidHandler<A extends Component> implements Component, IFluidHandler{
	...
	public AbstractFluidHandler(GenericTile tile) {
		holder(tile);
    ...
    public boolean hasCapability(Capability<?> capability, Direction side) {
		...
		Direction dir = getHolder().hasComponent(ComponentType.Direction) ? getHolder().<ComponentDirection>getComponent(ComponentType.Direction).getDirection()
			: null;
		if (dir != null) {
    ...
    public int fill(FluidStack resource, FluidAction action) {
		Direction relative = UtilitiesTiles.getRelativeSide(
			getHolder().hasComponent(ComponentType.Direction) ? getHolder().<ComponentDirection>getComponent(ComponentType.Direction).getDirection()
				: Direction.UP,
			lastDirection);
