...
public class ButtonInventoryIOView extends ScreenComponentButton<ButtonInventoryIOView> {
	...
	public void renderBackground(PoseStack stack, int xAxis, int yAxis, int guiWidth, int guiHeight) {
		...
		blit(stack, guiWidth + xLocation + slotXOffset, guiHeight + yLocation + slotYOffset, icon.textureU(), icon.textureV(), icon.textureWidth(), icon.textureHeight(), icon.imageWidth(), icon.imageHeight());
