...
public class ButtonSwappableLabel extends Button {
	...
	public ButtonSwappableLabel(int xLoc, int yLoc, int length, int width, Component labelOff, 
			Component labelOn, Supplier<Boolean> initialStatus, OnPress onPressed) {
	...
	public ButtonSwappableLabel(int xLoc, int yLoc, int length, int width, Component labelOff,
			Component labelOn, Supplier<Boolean> initialStatus, OnPress onPressed, OnTooltip tooltip) {
