...
public class ScreenComponentChemicalGauge extends ScreenComponentGeneric {
	...
	if (!stack.isEmpty()) {
	    int scale = (int) (stack.getAmount()
		    * (AbstractScreenComponentGauge.GaugeTextures.BACKGROUND_DEFAULT.textureHeight() - 2)
		    / TileRotaryUnifier.MAX_CHEM_AMOUNT);
	...
	graphics.blit(super.texture.getLocation(), guiWidth + xLocation, guiHeight + yLocation,
		AbstractScreenComponentGauge.GaugeTextures.LEVEL_DEFAULT.textureU(), 0,
