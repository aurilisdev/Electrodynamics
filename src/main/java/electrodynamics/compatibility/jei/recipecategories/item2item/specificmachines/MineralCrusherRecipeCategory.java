...
public class MineralCrusherRecipeCategory extends Item2ItemRecipeCategory<MineralCrusherRecipe> {
    ...
    public static final RecipeType<MineralCrusherRecipe> RECIPE_TYPE = RecipeType.create(Electrodynamics.ID,
	    MineralCrusherRecipe.RECIPE_GROUP, MineralCrusherRecipe.class);
