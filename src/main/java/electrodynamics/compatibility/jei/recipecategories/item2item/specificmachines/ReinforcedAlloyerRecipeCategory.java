...
public class ReinforcedAlloyerRecipeCategory extends Item2ItemRecipeCategory<ReinforcedAlloyerRecipe> {
    ...
    public static final RecipeType<ReinforcedAlloyerRecipe> RECIPE_TYPE = RecipeType.create(Electrodynamics.ID, ReinforcedAlloyerRecipe.RECIPE_GROUP, ReinforcedAlloyerRecipe.class);
