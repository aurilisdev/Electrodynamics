...
public class OxidationFurnaceRecipeCategory extends Item2ItemRecipeCategory<OxidationFurnaceRecipe> {
	...
	private static final PowerLabelWrapper POWER_LABEL = new PowerLabelWrapper(2, 49, 240);
	...
	private static final String RECIPE_GROUP = SubtypeMachine.oxidationfurnace.tag();
	...
	public OxidationFurnaceRecipeCategory(IGuiHelper guiHelper) {
		super(guiHelper, RECIPE_GROUP, INPUT_MACHINE, BACK_WRAP, OxidationFurnaceRecipe.class, ANIM_TIME);
