...
public class OxidationFurnaceRecipeCategory extends Item2ItemRecipeCategory<OxidationFurnaceRecipe> {
	...
	private static PowerLabelWrapper POWER_LABEL = new PowerLabelWrapper(2, 49, Constants.OXIDATIONFURNACE_USAGE_PER_TICK, 240);
	...
	public static ItemStack INPUT_MACHINE = new ItemStack(ElectrodynamicsRegisters.getSafeBlock(SubtypeMachine.oxidationfurnace));
