...
public class EnergizedAlloyerRecipeCategory extends Item2ItemRecipeCategory<EnergizedAlloyerRecipe> {
    ...
    public static final ItemSlotObject INPUT_SLOT_1 = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 17, 11, RecipeIngredientRole.INPUT);
    public static final ItemSlotObject INPUT_SLOT_2 = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 17, 30, RecipeIngredientRole.INPUT);
    ...
    public static final RecipeType<EnergizedAlloyerRecipe> RECIPE_TYPE = RecipeType.create(Electrodynamics.ID, EnergizedAlloyerRecipe.RECIPE_GROUP, EnergizedAlloyerRecipe.class);

    public EnergizedAlloyerRecipeCategory(IGuiHelper guiHelper) {
        super(guiHelper, ElectroTextUtils.jeiTranslated(EnergizedAlloyerRecipe.RECIPE_GROUP), INPUT_MACHINE, BACK_WRAP, RECIPE_TYPE, ANIM_TIME);
