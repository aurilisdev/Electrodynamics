...
public class EnergizedAlloyerRecipeCategory extends Item2ItemRecipeCategory<EnergizedAlloyerRecipe> {
    ...
    public static final RecipeType<EnergizedAlloyerRecipe> RECIPE_TYPE = RecipeType.create(Electrodynamics.ID,
	    EnergizedAlloyerRecipe.RECIPE_GROUP, EnergizedAlloyerRecipe.class);

    public EnergizedAlloyerRecipeCategory(IGuiHelper guiHelper) {
	super(guiHelper, ElectroTextUtils.jeiTranslated(EnergizedAlloyerRecipe.RECIPE_GROUP), INPUT_MACHINE, BACK_WRAP,
