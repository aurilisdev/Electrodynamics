...
public class EnergizedAlloyerRecipeCategory extends Item2ItemRecipeCategory {
	...
	private static PowerLabelWrapper POWER_LABEL = new PowerLabelWrapper(2, 49, Constants.ENERGIZEDALLOYER_USAGE_PER_TICK, 480);
