...
public class EnergizedAlloyerRecipeCategory extends Item2ItemRecipeCategory<EnergizedAlloyerRecipe> {
	...
	private static final PowerLabelWrapper POWER_LABEL = new PowerLabelWrapper(2, 49, 480);
	...
	private static final String RECIPE_GROUP = SubtypeMachine.energizedalloyer.tag();
	...
	public EnergizedAlloyerRecipeCategory(IGuiHelper guiHelper) {
		super(guiHelper, RECIPE_GROUP, INPUT_MACHINE, BACK_WRAP, EnergizedAlloyerRecipe.class, ANIM_TIME);
