...
public class ElectrolyticSeparatorRecipeCategory extends Fluid2FluidRecipeCategory<ElectrolyticSeparatorRecipe> {
    ...
    public static final ItemSlotObject IN_BUCKET_SLOT = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, ScreenComponentSlot.IconType.FLUID_DARK, 26, 36, true);
    public static final ItemSlotObject OUTPUT_BUCKET_SLOT = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, ScreenComponentSlot.IconType.FLUID_DARK, 66, 36, false);
    public static final ItemSlotObject BIPRODUCT_BUCKET_SLOT = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, ScreenComponentSlot.IconType.FLUID_DARK, 106, 36, false);
    ...
    public static final FluidGaugeObject OUT_GAUGE = new FluidGaugeObject(48, 5);
    public static final FluidGaugeObject BIPRODUCT_GAUGE = new FluidGaugeObject(88, 5);
