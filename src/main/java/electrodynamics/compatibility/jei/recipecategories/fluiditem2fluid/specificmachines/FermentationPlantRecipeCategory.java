...
public class FermentationPlantRecipeCategory extends FluidItem2FluidRecipeCategory<FermentationPlantRecipe> {
	...
	private static PowerLabelWrapper POWER_LABEL = new PowerLabelWrapper(2, 55, Constants.FERMENTATIONPLANT_USAGE_PER_TICK, 120);
	...
	public static ItemStack INPUT_MACHINE = new ItemStack(ElectrodynamicsRegisters.getSafeBlock(SubtypeMachine.fermentationplant));
