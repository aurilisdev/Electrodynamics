...
public class ChemicalMixerRecipeCategory extends FluidItem2FluidRecipeCategory<ChemicalMixerRecipe> {
    ...
    public static final ItemSlotObject INPUT_SLOT = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 57, 16, true);
    public static final ItemSlotObject INPUT_BUCKET_SLOT = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, ScreenComponentSlot.IconType.FLUID_DARK, 26, 36, true);
    public static final ItemSlotObject OUTPUT_BUCKET_SLOT = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, ScreenComponentSlot.IconType.FLUID_DARK, 88, 36, false);
    ...
    public static ItemStack INPUT_MACHINE = new ItemStack(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.chemicalmixer));

    public static final RecipeType<ChemicalMixerRecipe> RECIPE_TYPE = RecipeType.create(Electrodynamics.ID, ChemicalMixerRecipe.RECIPE_GROUP, ChemicalMixerRecipe.class);
