...
public class ChemicalMixerRecipeCategory extends FluidItem2FluidRecipeCategory<ChemicalMixerRecipe> {
    ...
    public static final RecipeType<ChemicalMixerRecipe> RECIPE_TYPE = RecipeType.create(Electrodynamics.ID,
	    ChemicalMixerRecipe.RECIPE_GROUP, ChemicalMixerRecipe.class);

    public ChemicalMixerRecipeCategory(IGuiHelper guiHelper) {
	super(guiHelper, ElectroTextUtils.jeiTranslated(ChemicalMixerRecipe.RECIPE_GROUP), INPUT_MACHINE, BACK_WRAP,
