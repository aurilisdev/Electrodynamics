...
public abstract class AbstractRecipeCategory<T> implements IRecipeCategory<T> {
	...
	public void preLabels(PoseStack stack, T recipe) {

	}

	public void postLabels(PoseStack stack, T recipe) {
