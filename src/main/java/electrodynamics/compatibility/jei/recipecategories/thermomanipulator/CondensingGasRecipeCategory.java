...
import electrodynamics.compatibility.jei.recipecategories.psuedo.PsuedoRecipeCategory;
...
public class CondensingGasRecipeCategory extends PsuedoRecipeCategory<PsuedoGas2FluidRecipe> {
	...
	public CondensingGasRecipeCategory(IGuiHelper guiHelper) {
		super(guiHelper, RECIPE_GROUP, INPUT_MACHINE, BACK_WRAP, PsuedoGas2FluidRecipe.class, ANIM_TIME);
		// TODO Auto-generated constructor stub
	}

	@Override
	public RecipeType<PsuedoGas2FluidRecipe> getRecipeType() {
