...
public class CondensingGasRecipeCategory extends AbstractRecipeCategory<PsuedoGas2FluidRecipe> {
    ...
    private static final PowerLabelWrapperConstant POWER_LABEL = new PowerLabelWrapperConstant(2, 60,
	    ElectroConstants.THERMOELECTRIC_MANIPULATOR_USAGE_PER_TICK, 120);
    ...
    public static final RecipeType<PsuedoGas2FluidRecipe> RECIPE_TYPE = RecipeType.create(Electrodynamics.ID,
	    RECIPE_GROUP, PsuedoGas2FluidRecipe.class);
