...
public class ChemicalCrystallizerRecipeCategory extends Fluid2ItemRecipeCategory<ChemicalCrystalizerRecipe> {
	...
	public static final ItemSlotObject IN_BUCKET_SLOT = new ItemSlotObject(SlotType.NORMAL, IconType.FLUID_DARK, 58, 36, true);

	public static final ItemSlotObject OUT_SLOT = new ItemSlotObject(SlotType.NORMAL, 100, 16, false);
