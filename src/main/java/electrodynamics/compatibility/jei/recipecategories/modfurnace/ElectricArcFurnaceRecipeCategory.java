...
public class ElectricArcFurnaceRecipeCategory extends AbstractRecipeCategory<BlastingRecipe> {
    ...
    public static final PowerLabelWrapperConstant POWER_LABEL = new PowerLabelWrapperConstant(2, 48,
	    ElectrodynamicsConfig.INSTANCE.ELECTRICARCFURNACE_USAGE_PER_TICK.get(), 120);
    public static final TimeLabelWrapperConstant TIME_LABEL = new TimeLabelWrapperConstant(130, 48,
	    ElectrodynamicsConfig.INSTANCE.ELECTRICARCFURNACE_REQUIRED_TICKS.get());
    ...
    public static final RecipeType<BlastingRecipe> RECIPE_TYPE = RecipeType.create(Electrodynamics.ID, RECIPE_GROUP,
