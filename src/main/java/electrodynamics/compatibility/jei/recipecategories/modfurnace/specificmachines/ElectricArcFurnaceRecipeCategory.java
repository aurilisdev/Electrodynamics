...
public class ElectricArcFurnaceRecipeCategory extends ModFurnaceRecipeCategory<BlastingRecipe> {
	...
	private static final PowerLabelWrapper POWER_LABEL = new PowerLabelWrapper(2, 48, Constants.ELECTRICARCFURNACE_USAGE_PER_TICK, 120);
	private static final TimeLabelWrapper TIME_LABEL = new TimeLabelWrapper(130, 48, Constants.ELECTRICARCFURNACE_REQUIRED_TICKS);
	...
	public ElectricArcFurnaceRecipeCategory(IGuiHelper guiHelper) {
		super(guiHelper, RECIPE_GROUP, INPUT_MACHINE, BACK_WRAP, BlastingRecipe.class, ANIM_TIME);
