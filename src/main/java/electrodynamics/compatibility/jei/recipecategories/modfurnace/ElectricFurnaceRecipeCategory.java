...
public class ElectricFurnaceRecipeCategory extends AbstractRecipeCategory<SmeltingRecipe> {
	...
	private static final PowerLabelWrapperConstant POWER_LABEL = new PowerLabelWrapperConstant(2, 48, Constants.ELECTRICFURNACE_USAGE_PER_TICK, 120);
	private static final TimeLabelWrapperConstant TIME_LABEL = new TimeLabelWrapperConstant(130, 48, Constants.ELECTRICFURNACE_REQUIRED_TICKS);
