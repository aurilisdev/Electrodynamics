...
public class ElectricFurnaceRecipeCategory extends AbstractRecipeCategory<FurnaceRecipe> {

	public static final BackgroundObject BACK_WRAP = new BackgroundObject(132, 58);

	public static final ItemSlotObject INPUT_SLOT = new ItemSlotObject(SlotType.NORMAL, 22, 20, true);
	public static final ItemSlotObject OUTPUT_SLOT = new ItemSlotObject(SlotType.BIG, 83, 16, false);
	...
	public static final PowerLabelWrapperConstant POWER_LABEL = new PowerLabelWrapperConstant(2, 48, Constants.ELECTRICFURNACE_USAGE_PER_TICK, 120);
	public static final TimeLabelWrapperConstant TIME_LABEL = new TimeLabelWrapperConstant(130, 48, Constants.ELECTRICFURNACE_REQUIRED_TICKS);
	...
	public static final RecipeType<FurnaceRecipe> RECIPE_TYPE = RecipeType.create(References.ID, RECIPE_GROUP, FurnaceRecipe.class);
	...
	@Override
	public List<List<ItemStack>> getItemInputs(FurnaceRecipe recipe) {
	...
	@Override
	public List<ItemStack> getItemOutputs(FurnaceRecipe recipe) {
