...
public class ElectricFurnaceRecipeCategory extends AbstractRecipeCategory<SmeltingRecipe> {
	...
	public static final PowerLabelWrapperConstant POWER_LABEL = new PowerLabelWrapperConstant(2, 48, ElectrodynamicsConfig.INSTANCE.ELECTRICFURNACE_USAGE_PER_TICK.get(), 120);
	public static final TimeLabelWrapperConstant TIME_LABEL = new TimeLabelWrapperConstant(130, 48, ElectrodynamicsConfig.INSTANCE.ELECTRICFURNACE_REQUIRED_TICKS.get());
