...
public class ElectricFurnaceRecipeCategory extends AbstractRecipeCategory<FurnaceRecipe> {
	...
	public static final ItemSlotObject INPUT_SLOT = new ItemSlotObject(ScreenComponentSlot.SlotType.NORMAL, 22, 20, true);
	public static final ItemSlotObject OUTPUT_SLOT = new ItemSlotObject(ScreenComponentSlot.SlotType.BIG, 83, 16, false);
	...
	public static final RecipeType<FurnaceRecipe> RECIPE_TYPE = RecipeType.create(Electrodynamics.ID, RECIPE_GROUP, FurnaceRecipe.class);
