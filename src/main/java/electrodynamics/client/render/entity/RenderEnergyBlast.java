...
public class RenderEnergyBlast extends EntityRenderer<EntityEnergyBlast> {
	...
	RenderingUtils.renderStar(matrixStack, buffer, gameTime + partialTicks, 250 / distance, red, green, blue, alpha,
		false);
	RenderingUtils.renderStar(matrixStack, buffer, gameTime + 20f + partialTicks, 250 / distance, red, green, blue,
		alpha, false);
	RenderingUtils.renderStar(matrixStack, buffer, gameTime + 40f + partialTicks, 250 / distance, red, green, blue,
		alpha, false);

	RenderingUtils.renderStar(matrixStack, buffer, gameTime + 60f + partialTicks, 250 / distance, red, green, blue,
		alpha, false);
