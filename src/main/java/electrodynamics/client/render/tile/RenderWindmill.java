...
public class RenderWindmill extends AbstractTileRenderer<TileWindmill> {
	...
	@Override
	public void render(@Nonnull TileWindmill tileEntityIn, float partialTicks, @Nonnull MatrixStack matrixStackIn, @Nonnull IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
		IBakedModel ibakedmodel = getModel(ElectrodynamicsClientRegister.MODEL_WINDMILLBLADES);
