...
public class RenderMineralGrinder extends TileEntityRenderer<TileMineralGrinder> {

    public RenderMineralGrinder(TileEntityRendererDispatcher rendererDispatcherIn) {
