...
public class RenderMineralGrinder extends BlockEntityRenderer<TileMineralGrinder> {

    public RenderMineralGrinder(BlockEntityRenderDispatcher rendererDispatcherIn) {
