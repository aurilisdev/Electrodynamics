...
public class RenderMineralGrinderDouble extends BlockEntityRenderer<TileMineralGrinder> {

    public RenderMineralGrinderDouble(BlockEntityRenderDispatcher rendererDispatcherIn) {
