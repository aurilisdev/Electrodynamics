...
public class RenderMineralGrinderTriple extends BlockEntityRenderer<TileMineralGrinder> {

    public RenderMineralGrinderTriple(BlockEntityRenderDispatcher rendererDispatcherIn) {
