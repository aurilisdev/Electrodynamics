...
public class RenderMineralGrinderTriple extends TileEntityRenderer<TileMineralGrinder> {

    public RenderMineralGrinderTriple(TileEntityRendererDispatcher rendererDispatcherIn) {
