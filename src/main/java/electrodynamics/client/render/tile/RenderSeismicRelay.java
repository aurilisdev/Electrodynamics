...
public class RenderSeismicRelay extends AbstractTileRenderer<TileSeismicRelay> {
	...
	if (tile.markerLocs.getValue().size() > 3) {
	    ...
	    RenderingUtils.renderFilledBoxNoOverlay(stack, sheetBuilder, beam, 1.0F, 0, 0, alpha, whiteTexture.getU0(),
		    whiteTexture.getV0(), whiteTexture.getV1(), whiteTexture.getV1(), 255, RenderingUtils.ALL_FACES);
	}
    }
