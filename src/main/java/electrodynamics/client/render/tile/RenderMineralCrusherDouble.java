...
public class RenderMineralCrusherDouble extends AbstractTileRenderer<TileMineralCrusherDouble> {
	...
	@Override
	public void render(@NotNull TileMineralCrusherDouble tile, float partialTicks, PoseStack matrixStackIn, @NotNull MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
