...
public class ModelCompositeArmor<Type extends LivingEntity> extends HumanoidModel<Type> {
	...
	case LEGS, FEET:
	    ...
	    break;
	/*
	 * case FEET: this.head.visible = false; this.chest.visible = false;
	 * this.rightArm.visible = false; this.leftArm.visible = false;
	 * this.rightLeg.visible = false; this.leftLeg.visible = false; /*
	 * this.rightLeg.getChild(RLEG).visible = false;
	...
	/*
	 * 
	 * //PartDefinition combinedRight = part.addOrReplaceChild(RIGHT_LEG,
	 * CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));
	 * 
	 * //right leg combinedRight.addOrReplaceChild(RLEG, CubeListBuilder.create()
	 * .texOffs(77, 43).addBox(-2.1F, 0.0F, -3.0F, 4.0F, 9.0F, 1.0F, new
	 * CubeDeformation(0.0F)) .texOffs(77, 17).addBox(-2.1F, 0.0F, 2.0F, 4.0F, 9.0F,
	 * 1.0F, new CubeDeformation(0.0F)) .texOffs(66, 41).addBox(-3.1F, 0.0F, -2.0F,
	 * 1.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)) .texOffs(71, 55).addBox(2.0F,
	 * 0.0F, -2.0F, 0.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)) .texOffs(51,
	 * 79).addBox(-1.6F, 3.0F, -4.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
	 * PartPose.offset(-1.9F, 12.0F, 0.0F));
	 * 
	 * //right shoe combinedRight.addOrReplaceChild(RSHOE, CubeListBuilder.create()
	 * .texOffs(70, 22).addBox(2.0F, 9.0F, -4.0F, 0.0F, 3.0F, 6.0F, new
	 * CubeDeformation(0.0F)) .texOffs(57, 13).addBox(-3.0F, 9.0F, -4.0F, 1.0F,
	 * 3.0F, 6.0F, new CubeDeformation(0.0F)) .texOffs(76, 54).addBox(-2.0F, 9.0F,
	 * 2.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)) .texOffs(42,
	 * 72).addBox(-2.0F, 9.0F, -4.0F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
	 * .texOffs(45, 48).addBox(-2.0F, 12.1F, -4.0F, 4.0F, 0.0F, 6.0F, new
	 * CubeDeformation(0.0F)), PartPose.offset(1.9F, 17.0F, 0.0F));
	 * 
	 * //PartDefinition combinedLeft = part.addOrReplaceChild(LEFT_LEG,
	 * CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));
	 * 
	 * //left leg combinedLeft.addOrReplaceChild(LLEG, CubeListBuilder.create()
	 * .texOffs(74, 32).addBox(-1.9F, 0.0F, -3.0F, 4.0F, 9.0F, 1.0F, new
	 * CubeDeformation(0.0F)) .texOffs(71, 73).addBox(-1.9F, 0.0F, 2.0F, 4.0F, 9.0F,
	 * 1.0F, new CubeDeformation(0.0F)) .texOffs(33, 71).addBox(-1.8F, 0.0F, -2.0F,
	 * 0.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)) .texOffs(60, 55).addBox(2.1F,
	 * 0.0F, -2.0F, 1.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)) .texOffs(42,
	 * 79).addBox(-1.4F, 3.0F, -4.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
	 * PartPose.offset(1.9F, 12.0F, 0.0F));
	 * 
	 * //left shoe combinedLeft.addOrReplaceChild(LSHOE, CubeListBuilder.create()
	 * .texOffs(57, 3).addBox(2.0F, 9.0F, -4.0F, 1.0F, 3.0F, 6.0F, new
	 * CubeDeformation(0.0F)) .texOffs(66, 7).addBox(-2.0F, 9.0F, -4.0F, 0.0F, 3.0F,
	 * 6.0F, new CubeDeformation(0.0F)) .texOffs(11, 27).addBox(-2.0F, 9.0F, -4.0F,
	 * 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)) .texOffs(55, 41).addBox(-2.0F,
	 * 9.0F, 2.0F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)) .texOffs(30,
	 * 47).addBox(-2.0F, 12.1F, -4.0F, 4.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)),
	 * PartPose.offset(-1.9F, 17.0F, 0.0F));
	 * 
	 */
	 ...
	 * rightLeg.getChild(RLEG).render(poseStack, buffer, packedLight,
	 * packedOverlay); leftLeg.getChild(LLEG).render(poseStack, buffer, packedLight,
	 * packedOverlay); } if(rightLeg.getChild(RSHOE).visible) {
	 * rightLeg.getChild(RSHOE).render(poseStack, buffer, packedLight,
	 * packedOverlay); leftLeg.getChild(LSHOE).render(poseStack, buffer,
