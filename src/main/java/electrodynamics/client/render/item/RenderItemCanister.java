...
public class RenderItemCanister implements IModelGeometry<RenderItemCanister> {
	...
	ImmutableMap<TransformType, TransformationMatrix> transformMap = PerspectiveMapWrapper
	...
	public CanisterFluidOverrideHandler(ItemOverrideList nested, ModelBakery bakery, IModelConfiguration owner, RenderItemCanister parent) {
	...
	public IBakedModel getOverrideModel(IBakedModel originalModel, ItemStack stack, @Nullable ClientWorld world, @Nullable LivingEntity entity) {
		...
		if (!cache.containsKey(name)) {
		    ...
		    IBakedModel bakedModel = unbaked.bake(owner, bakery, ModelLoader.defaultTextureGetter(), ModelRotation.X0_Y0, this,
