...
public class ScreenMineralCrusher extends GenericContainerScreenUpgradeable<ContainerMineralCrusher> implements IHasContainer<ContainerMineralCrusher> {
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int mouseX, int mouseY) {
		...
		font.func_238422_b_(matrixStack, new TranslationTextComponent("gui.mineralcrusher.usage", ElectricityChatFormatter.getDisplayShort(TileMineralCrusher.REQUIRED_JOULES_PER_TICK * 20, ElectricUnit.WATT)),
				(float) playerInventoryTitleX + 77, (float) playerInventoryTitleY - 11, 4210752);
		font.func_238422_b_(matrixStack, new TranslationTextComponent("gui.mineralcrusher.voltage", ElectricityChatFormatter.getDisplayShort(GenericTileProcessor.DEFAULT_BASIC_MACHINE_VOLTAGE * 2, ElectricUnit.VOLTAGE)),
