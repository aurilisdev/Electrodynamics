...
public class ScreenCoalGenerator extends GenericContainerScreen<ContainerCoalGenerator> {
	...
	TransferPack output = TransferPack.ampsVoltage(
		Constants.COALGENERATOR_MAX_OUTPUT.getAmps()
			* Math.min((container.getHeat() - 27.0) / (3000.0 - 27.0), 1),
		Constants.COALGENERATOR_MAX_OUTPUT.getVoltage());
	font.func_243248_b(matrixStack,
		new TranslationTextComponent("gui.coalgenerator.timeleft", container.getBurnTicksLeft() / 20 + "s"),
		(float) playerInventoryTitleX + 60, (float) playerInventoryTitleY - 53, 4210752);
	font.func_243248_b(matrixStack,
		...
		(float) playerInventoryTitleX + 60, (float) playerInventoryTitleY - 40, 4210752);
	font.func_243248_b(matrixStack,
		...
		(float) playerInventoryTitleX + 60, (float) playerInventoryTitleY - 27, 4210752);
	font.func_243248_b(matrixStack,
		...
		(float) playerInventoryTitleX + 60, (float) playerInventoryTitleY - 14, 4210752);
    }
