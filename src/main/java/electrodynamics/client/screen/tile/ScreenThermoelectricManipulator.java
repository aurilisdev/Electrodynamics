...
public class ScreenThermoelectricManipulator extends GenericScreen<ContainerThermoelectricManipulator> {
	...
	} else if (temperature > ElectrodynamicsConfig.INSTANCE.GAS_TRANSFORMER_OUTPUT_TEMP_CAP.get()) {
	    temperature = ElectrodynamicsConfig.INSTANCE.GAS_TRANSFORMER_OUTPUT_TEMP_CAP.get();
