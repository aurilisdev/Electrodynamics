...
public class ScreenCompressor extends GenericScreen<ContainerCompressor> {

	public ScreenCompressor(ContainerCompressor container, Inventory inv, Component titleIn) {
		super(container, inv, titleIn);
		components.add(new ScreenComponentGeneric(ProgressTextures.COMPRESS_ARROW_OFF, this, 65, 40));
