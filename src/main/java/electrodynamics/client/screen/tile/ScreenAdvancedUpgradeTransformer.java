...
public class ScreenAdvancedUpgradeTransformer extends GenericScreen<ContainerAdvancedUpgradeTransformer> {
	...
	public ScreenAdvancedUpgradeTransformer(ContainerAdvancedUpgradeTransformer container, Inventory inv, Component title) {
		...
		addComponent(new ScreenComponentMultiLabel(0, 0, poseStack -> {
			...
			Component bottom = new TextComponent("1 : " + wholeRatio).withStyle(ChatFormatting.BOLD);
		...
		addComponent(new ScreenComponentButton<>(75, 20, 40, 20).setLabel(new TextComponent("1 : 2")).setOnPress(button -> {
			TileAdvancedUpgradeTransformer xfmr = menu.getSafeHost();
			if (xfmr == null) {
				return;
			}
		...
		addComponent(new ScreenComponentButton<>(75, 40, 40, 20).setLabel(new TextComponent("1 : 4")).setOnPress(button -> {
			TileAdvancedUpgradeTransformer xfmr = menu.getSafeHost();
			if (xfmr == null) {
				return;
			}
		...
		addComponent(new ScreenComponentButton<>(75, 60, 40, 20).setLabel(new TextComponent("1 : 8")).setOnPress(button -> {
			TileAdvancedUpgradeTransformer xfmr = menu.getSafeHost();
			if (xfmr == null) {
				return;
			}
		...
		addComponent(new ScreenComponentButton<>(75, 80, 40, 20).setLabel(new TextComponent("1 : 16")).setOnPress(button -> {
			TileAdvancedUpgradeTransformer xfmr = menu.getSafeHost();
			if (xfmr == null) {
				return;
			}
		...
		addComponent(new ScreenComponentButton<>(120, 20, 40, 20).setLabel(new TextComponent("1 : 32")).setOnPress(button -> {
			TileAdvancedUpgradeTransformer xfmr = menu.getSafeHost();
			if (xfmr == null) {
				return;
			}
		...
		addComponent(new ScreenComponentButton<>(120, 40, 40, 20).setLabel(new TextComponent("1 : 64")).setOnPress(button -> {
			TileAdvancedUpgradeTransformer xfmr = menu.getSafeHost();
			if (xfmr == null) {
				return;
			}
		...
		addComponent(new ScreenComponentButton<>(120, 60, 40, 20).setLabel(new TextComponent("1 : 128")).setOnPress(button -> {
			TileAdvancedUpgradeTransformer xfmr = menu.getSafeHost();
			if (xfmr == null) {
				return;
			}
		...
		addComponent(new ScreenComponentButton<>(120, 80, 40, 20).setLabel(new TextComponent("1 : 256")).setOnPress(button -> {
			TileAdvancedUpgradeTransformer xfmr = menu.getSafeHost();
			if (xfmr == null) {
				return;
			}
