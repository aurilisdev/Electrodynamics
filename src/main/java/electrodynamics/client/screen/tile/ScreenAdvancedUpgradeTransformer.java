...
public class ScreenAdvancedUpgradeTransformer extends GenericScreen<ContainerAdvancedUpgradeTransformer> {
	...
	addComponent(
		new ScreenComponentButton<>(75, 20, 40, 20).setLabel(Component.literal("1 : 2")).setOnPress(button -> {
		    TileAdvancedUpgradeTransformer xfmr = menu.getSafeHost();
		    if (xfmr == null) {
			return;
		    }
	...
	addComponent(
		new ScreenComponentButton<>(75, 40, 40, 20).setLabel(Component.literal("1 : 4")).setOnPress(button -> {
		    TileAdvancedUpgradeTransformer xfmr = menu.getSafeHost();
		    if (xfmr == null) {
			return;
		    }
	...
	addComponent(
		new ScreenComponentButton<>(75, 60, 40, 20).setLabel(Component.literal("1 : 8")).setOnPress(button -> {
		    TileAdvancedUpgradeTransformer xfmr = menu.getSafeHost();
		    if (xfmr == null) {
			return;
		    }
	...
	addComponent(
		new ScreenComponentButton<>(75, 80, 40, 20).setLabel(Component.literal("1 : 16")).setOnPress(button -> {
		    TileAdvancedUpgradeTransformer xfmr = menu.getSafeHost();
		    if (xfmr == null) {
			return;
		    }
	...
	addComponent(new ScreenComponentButton<>(120, 20, 40, 20).setLabel(Component.literal("1 : 32"))
		.setOnPress(button -> {
		    TileAdvancedUpgradeTransformer xfmr = menu.getSafeHost();
		    if (xfmr == null) {
			return;
	...
	addComponent(new ScreenComponentButton<>(120, 40, 40, 20).setLabel(Component.literal("1 : 64"))
		.setOnPress(button -> {
		    TileAdvancedUpgradeTransformer xfmr = menu.getSafeHost();
		    if (xfmr == null) {
			return;
	...
	addComponent(new ScreenComponentButton<>(120, 60, 40, 20).setLabel(Component.literal("1 : 128"))
		.setOnPress(button -> {
		    TileAdvancedUpgradeTransformer xfmr = menu.getSafeHost();
		    if (xfmr == null) {
			return;
	...
	addComponent(new ScreenComponentButton<>(120, 80, 40, 20).setLabel(Component.literal("1 : 256"))
		.setOnPress(button -> {
		    TileAdvancedUpgradeTransformer xfmr = menu.getSafeHost();
		    if (xfmr == null) {
			return;
