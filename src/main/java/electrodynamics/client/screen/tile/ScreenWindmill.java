...
public class ScreenWindmill extends GenericScreen<ContainerWindmill> {
	...
	private List<? extends FormattedCharSequence> getEnergyInformation() {
		...
		if (menu.getUnsafeHost() instanceof IElectricGenerator gen) {
			...
			list.add(new TranslatableComponent("gui.windmill.current",
			...
			list.add(new TranslatableComponent("gui.windmill.output",
					new TextComponent(ChatFormatter.getElectricDisplayShort(transfer.getWatts(), ElectricUnit.WATT)).withStyle(ChatFormatting.GRAY))
							.withStyle(ChatFormatting.DARK_GRAY).getVisualOrderText());
			list.add(new TranslatableComponent("gui.windmill.voltage",
