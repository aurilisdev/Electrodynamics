...
public class ScreenQuarry extends GenericScreen<ContainerQuarry> {
	...
	private List<? extends FormattedCharSequence> getEnchantmentInformation() {
		...
		list.add(ElectroTextUtils.gui("quarry.fortune", new TextComponent(quarry.fortuneLevel.getValue() + "").withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.DARK_GRAY).getVisualOrderText());
		list.add(ElectroTextUtils.gui("quarry.silktouch", new TextComponent(quarry.silkTouchLevel.getValue() + "").withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.DARK_GRAY).getVisualOrderText());
		list.add(ElectroTextUtils.gui("quarry.unbreaking", new TextComponent(quarry.unbreakingLevel.getValue() + "").withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.DARK_GRAY).getVisualOrderText());
		return list;
	...
	private List<? extends FormattedCharSequence> getMiningLocationInformation() {
		...
		if (quarry.miningPos.getValue().equals(BlockEntityUtils.OUT_OF_REACH)) {
			...
			location = new TextComponent(quarry.miningPos.getValue().toShortString()).withStyle(ChatFormatting.GRAY);
		}
