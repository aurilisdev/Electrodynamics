...
public class ScreenAdvancedDecompressor extends GenericMaterialScreen<ContainerAdvancedDecompressor> {
	...
	addComponent(new ScreenComponentGeneric(ScreenComponentProgress.ProgressTextures.DECOMPRESS_ARROW_OFF, 65, 40)
		.onTooltip((graphics, component, xAxis, yAxis) -> graphics.renderTooltip(getFontRenderer(),
			Component.literal("1.0 / " + 1.0 / container.getSafeHost().pressureMultiplier.getValue()),
			xAxis, yAxis)));
	...
	addComponent(
		new ScreenComponentButton<>(8, 75, 40, 20).setLabel(Component.literal("1/2")).setOnPress(button -> {
	...
	addComponent(
		new ScreenComponentButton<>(48, 75, 40, 20).setLabel(Component.literal("1/4")).setOnPress(button -> {
		    GenericTileAdvancedCompressor.TileAdvancedDecompressor compressor = menu.getSafeHost();
		    if (compressor == null) {
			return;
		    }
	...
	addComponent(
		new ScreenComponentButton<>(88, 75, 40, 20).setLabel(Component.literal("1/8")).setOnPress(button -> {
		    GenericTileAdvancedCompressor.TileAdvancedDecompressor compressor = menu.getSafeHost();
		    if (compressor == null) {
			return;
		    }
	...
	addComponent(
		new ScreenComponentButton<>(128, 75, 40, 20).setLabel(Component.literal("1/16")).setOnPress(button -> {
		    GenericTileAdvancedCompressor.TileAdvancedDecompressor compressor = menu.getSafeHost();
		    if (compressor == null) {
			return;
		    }
	...
	addComponent(
		new ScreenComponentButton<>(8, 95, 40, 20).setLabel(Component.literal("1/32")).setOnPress(button -> {
		    GenericTileAdvancedCompressor.TileAdvancedDecompressor compressor = menu.getSafeHost();
		    if (compressor == null) {
			return;
		    }
	...
	addComponent(
		new ScreenComponentButton<>(48, 95, 40, 20).setLabel(Component.literal("1/64")).setOnPress(button -> {
		    GenericTileAdvancedCompressor.TileAdvancedDecompressor compressor = menu.getSafeHost();
		    if (compressor == null) {
			return;
		    }
	...
	addComponent(
		new ScreenComponentButton<>(88, 95, 40, 20).setLabel(Component.literal("1/128")).setOnPress(button -> {
		    GenericTileAdvancedCompressor.TileAdvancedDecompressor compressor = menu.getSafeHost();
		    if (compressor == null) {
			return;
		    }
	...
	addComponent(
		new ScreenComponentButton<>(128, 95, 40, 20).setLabel(Component.literal("1/256")).setOnPress(button -> {
		    GenericTileAdvancedCompressor.TileAdvancedDecompressor compressor = menu.getSafeHost();
		    if (compressor == null) {
			return;
		    }
