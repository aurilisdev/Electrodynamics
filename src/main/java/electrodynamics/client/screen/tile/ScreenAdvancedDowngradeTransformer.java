...
public class ScreenAdvancedDowngradeTransformer extends GenericScreen<ContainerAdvancedDowngradeTransformer> {
	...
	public ScreenAdvancedDowngradeTransformer(ContainerAdvancedDowngradeTransformer container, Inventory inv, Component title) {
		...
		addComponent(new ScreenComponentMultiLabel(0, 0, poseStack -> {
			...
			Component bottom = new TextComponent(wholeRatio + " : 1").withStyle(ChatFormatting.BOLD);
		...
		addComponent(new ScreenComponentButton<>(75, 20, 40, 20).setLabel(new TextComponent("2 : 1")).setOnPress(button -> {
			TileAdvancedDowngradeTransformer xfmr = menu.getSafeHost();
			if (xfmr == null) {
				return;
			}
		...
		addComponent(new ScreenComponentButton<>(75, 40, 40, 20).setLabel(new TextComponent("4 : 1")).setOnPress(button -> {
			TileAdvancedDowngradeTransformer xfmr = menu.getSafeHost();
			if (xfmr == null) {
				return;
			}
		...
		addComponent(new ScreenComponentButton<>(75, 60, 40, 20).setLabel(new TextComponent("8 : 1")).setOnPress(button -> {
			TileAdvancedDowngradeTransformer xfmr = menu.getSafeHost();
			if (xfmr == null) {
				return;
			}
		...
		addComponent(new ScreenComponentButton<>(75, 80, 40, 20).setLabel(new TextComponent("16 : 1")).setOnPress(button -> {
			TileAdvancedDowngradeTransformer xfmr = menu.getSafeHost();
			if (xfmr == null) {
				return;
			}
		...
		addComponent(new ScreenComponentButton<>(120, 20, 40, 20).setLabel(new TextComponent("32 : 1")).setOnPress(button -> {
			TileAdvancedDowngradeTransformer xfmr = menu.getSafeHost();
			if (xfmr == null) {
				return;
			}
		...
		addComponent(new ScreenComponentButton<>(120, 40, 40, 20).setLabel(new TextComponent("64 : 1")).setOnPress(button -> {
			TileAdvancedDowngradeTransformer xfmr = menu.getSafeHost();
			if (xfmr == null) {
				return;
			}
		...
		addComponent(new ScreenComponentButton<>(120, 60, 40, 20).setLabel(new TextComponent("128 : 1")).setOnPress(button -> {
			TileAdvancedDowngradeTransformer xfmr = menu.getSafeHost();
			if (xfmr == null) {
				return;
			}
		...
		addComponent(new ScreenComponentButton<>(120, 80, 40, 20).setLabel(new TextComponent("256 : 1")).setOnPress(button -> {
			TileAdvancedDowngradeTransformer xfmr = menu.getSafeHost();
			if (xfmr == null) {
				return;
			}
