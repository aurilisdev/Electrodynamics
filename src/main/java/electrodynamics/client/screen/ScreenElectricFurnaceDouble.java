...
public class ScreenElectricFurnaceDouble extends GenericScreen<ContainerElectricFurnaceDouble> {
	...
	if (box != null) {
	    ...
	    ComponentProcessor processor0 = box.getProcessor(0);
	    ComponentProcessor processor1 = box.getProcessor(1);

	    list.add(new TranslationTextComponent("gui.o2oprocessor.usage",
		    new StringTextComponent(
			    ChatFormatter.getElectricDisplayShort(processor0.getUsage() * 20 + processor1.getUsage() * 20, ElectricUnit.WATT))
