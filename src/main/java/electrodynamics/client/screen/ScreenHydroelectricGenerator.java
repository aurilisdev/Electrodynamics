...
public class ScreenHydroelectricGenerator extends GenericScreen<ContainerHydroelectricGenerator> {
	...
	private List<? extends FormattedCharSequence> getEnergyInformation() {
		...
		if (menu.getUnsafeHost() instanceof IElectricGenerator gen) {
			...
			list.add(new TranslatableComponent("gui.hydroelectricgenerator.current",
			...
			list.add(new TranslatableComponent("gui.hydroelectricgenerator.output",
					new TextComponent(ChatFormatter.getElectricDisplayShort(transfer.getWatts(), ElectricUnit.WATT)).withStyle(ChatFormatting.GRAY))
							.withStyle(ChatFormatting.DARK_GRAY).getVisualOrderText());
			list.add(new TranslatableComponent("gui.hydroelectricgenerator.voltage",
	...
	protected void renderLabels(PoseStack matrixStack, int mouseX, int mouseY) {
		...
		if (menu.getUnsafeHost() instanceof IElectricGenerator gen) {
			...
			font.draw(matrixStack,
					new TranslatableComponent("gui.hydroelectricgenerator.current",
			...
			font.draw(matrixStack,
					new TranslatableComponent("gui.hydroelectricgenerator.output",
			...
			font.draw(matrixStack,
					new TranslatableComponent("gui.hydroelectricgenerator.voltage",
