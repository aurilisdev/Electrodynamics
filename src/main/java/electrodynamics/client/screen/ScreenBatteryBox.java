...
public class ScreenBatteryBox extends GenericContainerScreenUpgradeable<ContainerBatteryBox> implements IHasContainer<ContainerBatteryBox> {
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int mouseX, int mouseY) {
		...
		font.func_243248_b(matrixStack, new TranslationTextComponent("gui.batterybox.voltage", ElectricityChatFormatter.getDisplayShort(TileBatteryBox.DEFAULT_VOLTAGE, ElectricUnit.VOLTAGE)), playerInventoryTitleX,
