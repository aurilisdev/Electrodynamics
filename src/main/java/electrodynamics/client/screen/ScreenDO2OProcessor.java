...
public class ScreenDO2OProcessor extends GenericContainerScreenUpgradeable<ContainerDO2OProcessor> implements IHasContainer<ContainerDO2OProcessor> {
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int mouseX, int mouseY) {
		...
		font.func_243248_b(matrixStack, new TranslationTextComponent("gui.do2oprocessor.usage", ElectricityChatFormatter.getDisplayShort(container.getJoulesPerTick() * 20, ElectricUnit.WATT)),
				(float) playerInventoryTitleX + 77, (float) playerInventoryTitleY - 11, 4210752);
		font.func_243248_b(matrixStack, new TranslationTextComponent("gui.do2oprocessor.voltage", ElectricityChatFormatter.getDisplayShort(container.getVoltage(), ElectricUnit.VOLTAGE)),
