...
@OnlyIn(Dist.CLIENT)
public class ScreenMineralGrinder extends GenericContainerScreenUpgradeable<ContainerMineralGrinder> implements IHasContainer<ContainerMineralGrinder> {
	public static final ResourceLocation SCREEN_BACKGROUND = new ResourceLocation(References.ID + ":textures/gui/mineralgrinder.png");

	public ScreenMineralGrinder(ContainerMineralGrinder container, PlayerInventory playerInventory, ITextComponent title) {
