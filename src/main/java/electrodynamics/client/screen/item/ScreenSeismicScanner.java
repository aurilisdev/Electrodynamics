...
public class ScreenSeismicScanner extends GenericScreen<ContainerSeismicScanner> {
	...
	private List<? extends FormattedCharSequence> getElectricInformation() {
		...
		if(ownerItem.getItem() instanceof ItemSeismicScanner scanner) {
			list.add(new TranslatableComponent("gui.seismicscanner.usage", new TextComponent(ChatFormatter
					.getElectricDisplayShort(ItemSeismicScanner.JOULES_PER_SCAN / 20, ElectricUnit.WATT))
