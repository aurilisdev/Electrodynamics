...
public class ElectrodynamicsClientEvents {
	...
	POST_GUI_OVERLAY_HANDLERS.forEach(handler -> handler.renderToScreen(event.getOverlay(), event.getGuiGraphics(),
		event.getWindow(), Minecraft.getInstance(), event.getPartialTick()));
    }
