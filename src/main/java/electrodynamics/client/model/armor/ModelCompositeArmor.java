...
public class ModelCompositeArmor<T extends LivingEntity> extends GenericArmorModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
	    Electrodynamics.rl("composite_armor"), "main");
	...
	part.addOrReplaceChild(HEAD, CubeListBuilder.create().texOffs(19, 27)
		...
		//
		.addBox(-3.0F, -6.0F, -5.0F, 6.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
	...
	if (parentHead.visible) {
	    parentHead.render(poseStack,
		    getCustomConsumer(RenderType
			    .entityTranslucent(new ResourceLocation(ItemCompositeArmor.ARMOR_TEXTURE_LOCATION))),
