...
public class ChapterQuarry extends Chapter {
	...
	public void addData() {
		...
		//Step 1
		pageData.add(new TextWrapperObject(TextUtils.guidebook("chapter.quarry.step", 1).withStyle(ChatFormatting.BOLD)).setSeparateStart().setNewPage());
		...
		//Step 2
		pageData.add(new TextWrapperObject(TextUtils.guidebook("chapter.quarry.step", 2).withStyle(ChatFormatting.BOLD)).setSeparateStart().setNewPage());
		...
		//Step 3
		pageData.add(new TextWrapperObject(TextUtils.guidebook("chapter.quarry.step", 3).withStyle(ChatFormatting.BOLD)).setSeparateStart().setNewPage());
		...
		//Step 4
		pageData.add(new TextWrapperObject(TextUtils.guidebook("chapter.quarry.step", 4).withStyle(ChatFormatting.BOLD)).setSeparateStart().setNewPage());
		...
		//Step 5
		pageData.add(new TextWrapperObject(TextUtils.guidebook("chapter.quarry.step", 5).withStyle(ChatFormatting.BOLD)).setSeparateStart().setNewPage());
		...
		//Step 6
		pageData.add(new TextWrapperObject(TextUtils.guidebook("chapter.quarry.step", 6).withStyle(ChatFormatting.BOLD)).setSeparateStart().setNewPage());
		...
		//Step 7
		pageData.add(new TextWrapperObject(TextUtils.guidebook("chapter.quarry.step", 7).withStyle(ChatFormatting.BOLD)).setSeparateStart().setNewPage());
		...
		//Step 8
		pageData.add(new TextWrapperObject(TextUtils.guidebook("chapter.quarry.step", 8).withStyle(ChatFormatting.BOLD)).setSeparateStart().setNewPage());
