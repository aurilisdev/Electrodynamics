...
public class ChapterArmor extends Chapter {
    ...
    private static final ItemWrapperObject LOGO = new ItemWrapperObject(7, 10, 32, 32, 32, 2.0F,
	    ElectrodynamicsItems.ITEM_COMPOSITEHELMET.get());
	...
	pageData.add(new TextWrapperObject(
		ElectrodynamicsItems.ITEM_JETPACK.get().getDescription().copy().withStyle(ChatFormatting.BOLD))
	...
	// Hydraulic Boots
	pageData.add(new TextWrapperObject(
		ElectrodynamicsItems.ITEM_HYDRAULICBOOTS.get().getDescription().copy().withStyle(ChatFormatting.BOLD))
	...
	pageData.add(
		new TextWrapperObject(ElectroTextUtils.guidebook("chapter.armor.hydraulicboots")).setSeparateStart());

	// Combat Helmet
	pageData.add(new TextWrapperObject(
		ElectrodynamicsItems.ITEM_COMBATHELMET.get().getDescription().copy().withStyle(ChatFormatting.BOLD))
		.setCentered().setNewPage());
	pageData.add(new ItemWrapperObject(7 + ScreenGuidebook.TEXT_WIDTH / 2 - 16, 10, 32, 32, 32, 2.0F,
	...
	pageData.add(
		new TextWrapperObject(ElectroTextUtils.guidebook("chapter.armor.combathelmet")).setSeparateStart());

	// Combat Chestplate
	pageData.add(new TextWrapperObject(
		ElectrodynamicsItems.ITEM_COMBATCHESTPLATE.get().getDescription().copy().withStyle(ChatFormatting.BOLD))
		.setCentered().setNewPage());
	pageData.add(new ItemWrapperObject(7 + ScreenGuidebook.TEXT_WIDTH / 2 - 16, 10, 32, 32, 32, 2.0F,
	...
	pageData.add(
		new TextWrapperObject(ElectroTextUtils.guidebook("chapter.armor.combatchestplate")).setSeparateStart());

	// Combat Leggings
	pageData.add(new TextWrapperObject(
		ElectrodynamicsItems.ITEM_COMBATLEGGINGS.get().getDescription().copy().withStyle(ChatFormatting.BOLD))
		.setCentered().setNewPage());
	pageData.add(new ItemWrapperObject(7 + ScreenGuidebook.TEXT_WIDTH / 2 - 16, 10, 32, 32, 32, 2.0F,
	...
	pageData.add(
		new TextWrapperObject(ElectroTextUtils.guidebook("chapter.armor.combatleggings")).setSeparateStart());

	// Combat Boots
	pageData.add(new TextWrapperObject(
		ElectrodynamicsItems.ITEM_COMBATBOOTS.get().getDescription().copy().withStyle(ChatFormatting.BOLD))
		.setCentered().setNewPage());
	...
	pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.armor.ceramicl1")).setIndentions(1)
		.setSeparateStart());
	pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.armor.ceramicl2")).setIndentions(1)
		.setSeparateStart());
