...
public class ChapterFluids extends Chapter {
    ...
    public void addData() {
        ...
        for (RegistryObject<? extends Fluid> fluid : ElectrodynamicsFluids.FLUIDS.getEntries()) {
            pageData.add(new FluidWrapperObject(0, 0, 32, 32, 36, fluid.get(), new AbstractGraphicWrapper.GraphicTextDescriptor(36, 11, new TranslationTextComponent(fluid.get().getAttributes().getTranslationKey())))
        ...
        pageData.add(new ImageWrapperObject(0, 0, 0, 0, 150, 79, 150, 79, 81, Electrodynamics.rl("textures/screen/guidebook/fluidio.png")).onTooltip(new OnTooltip() {
            ...
            public void onTooltip(MatrixStack poseStack, int xAxis, int yAxis, ScreenGuidebook screen) {
                ...
                tooltips.add(ElectroTextUtils.guidebook("chapter.electricity.middle", ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.chemicalcrystallizer).getDescription().copy().withStyle(TextFormatting.DARK_GRAY)).withStyle(TextFormatting.GRAY).getVisualOrderText());
                tooltips.add(ElectroTextUtils.guidebook("chapter.electricity.right", ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.electricpump).getDescription().copy().withStyle(TextFormatting.DARK_GRAY)).withStyle(TextFormatting.GRAY).getVisualOrderText());
        ...
        pageData.add(new TextWrapperObject(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.fluidvalve).getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
        ...
        pageData.add(new TextWrapperObject(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.fluidpipepump).getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
        ...
        pageData.add(new TextWrapperObject(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.fluidpipefilter).getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
        ...
        pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.fluids.l5.fluidfilterpipe.3", ElectroTextUtils.guidebook("chapter.fluids.blacklist").withStyle(TextFormatting.BOLD), ElectroTextUtils.guidebook("chapter.fluids.whitelist").withStyle(TextFormatting.BOLD))).setSeparateStart());
        ...
        pageData.add(new TextWrapperObject(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.fluidvoid).getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
