...
public class ChapterFluids extends Chapter {
	...
	public void addData() {
		...
		pageData.add(new TextWrapperObject(TextUtils.guidebook("chapter.fluids.pipecapacity", TextUtils.guidebook("chapter.fluids.pipecopper"), SubtypePipe.copper.maxTransfer)).setSeparateStart().setIndentions(1));
		pageData.add(new TextWrapperObject(TextUtils.guidebook("chapter.fluids.pipecapacity", TextUtils.guidebook("chapter.fluids.pipesteel"), SubtypePipe.steel.maxTransfer)).setSeparateStart().setIndentions(1));
		blankLine();
