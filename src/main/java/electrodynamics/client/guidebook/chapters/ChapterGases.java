...
public class ChapterGases extends Chapter {
	...
	public void addData() {
		...
		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.gases.l15", ElectrodynamicsItems.ITEM_COMPRESSOR.get().getDescription().copy().withStyle(ChatFormatting.BOLD), ElectrodynamicsItems.ITEM_DECOMPRESSOR.get().getDescription().copy().withStyle(ChatFormatting.BOLD), ElectrodynamicsConfig.INSTANCE.COMPRESSOR_CONVERSION_RATE.get(), ElectrodynamicsConfig.INSTANCE.ADVANCED_COMPRESSOR_CONVERSION_RATE.get())).setIndentions(1).setSeparateStart());
