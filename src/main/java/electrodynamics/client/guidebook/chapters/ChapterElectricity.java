...
public class ChapterElectricity extends Chapter {
	...
	public void addData() {
		...
		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.topic.electricbasics").withStyle(TextFormatting.BOLD, TextFormatting.UNDERLINE)).setNewPage());

		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.l2.1")).setIndentions(1).setSeparateStart());
		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.powerformula").withStyle(TextFormatting.BOLD)).setIndentions(1).setSeparateStart());
		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.l2.2")).setSeparateStart());

		/* Machine Fundamentals */

		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.topic.machinefundamentals").withStyle(TextFormatting.BOLD, TextFormatting.UNDERLINE)).setNewPage());
		...
		pageData.add(new ImageWrapperObject(0, 0, 0, 0, 150, 79, 150, 79, 81, new ResourceLocation(References.ID, "textures/screen/guidebook/120vmachines.png")).onTooltip(new OnTooltip() {
			...
			public void onTooltip(MatrixStack stack, int xAxis, int yAxis, ScreenGuidebook screen) {
				...
				tooltips.add(ElectroTextUtils.guidebook("chapter.electricity.left", ElectrodynamicsItems.getItem(SubtypeMachine.mineralgrinder).getDescription().copy().withStyle(TextFormatting.DARK_GRAY)).withStyle(TextFormatting.GRAY).getVisualOrderText());
				tooltips.add(ElectroTextUtils.guidebook("chapter.electricity.middle", ElectrodynamicsItems.getItem(SubtypeMachine.batterybox).getDescription().copy().withStyle(TextFormatting.DARK_GRAY)).withStyle(TextFormatting.GRAY).getVisualOrderText());
				tooltips.add(ElectroTextUtils.guidebook("chapter.electricity.right", ElectrodynamicsItems.getItem(SubtypeMachine.electricfurnace).getDescription().copy().withStyle(TextFormatting.DARK_GRAY)).withStyle(TextFormatting.GRAY).getVisualOrderText());
		...
		pageData.add(new ImageWrapperObject(0, 0, 0, 0, 150, 79, 150, 79, 81, new ResourceLocation(References.ID, "textures/screen/guidebook/240vmachines.png")).onTooltip(new OnTooltip() {
			...
			public void onTooltip(MatrixStack stack, int xAxis, int yAxis, ScreenGuidebook screen) {
				...
				List<IReorderingProcessor> tooltips = new ArrayList<>();
				tooltips.add(ElectroTextUtils.guidebook("chapter.electricity.left", ElectrodynamicsItems.getItem(SubtypeMachine.chemicalmixer).getDescription().copy().withStyle(TextFormatting.DARK_GRAY)).withStyle(TextFormatting.GRAY).getVisualOrderText());
				tooltips.add(ElectroTextUtils.guidebook("chapter.electricity.middle", ElectrodynamicsItems.getItem(SubtypeMachine.lathe).getDescription().copy().withStyle(TextFormatting.DARK_GRAY)).withStyle(TextFormatting.GRAY).getVisualOrderText());
				tooltips.add(ElectroTextUtils.guidebook("chapter.electricity.right", ElectrodynamicsItems.getItem(SubtypeMachine.oxidationfurnace).getDescription().copy().withStyle(TextFormatting.DARK_GRAY)).withStyle(TextFormatting.GRAY).getVisualOrderText());
		...
		pageData.add(new ImageWrapperObject(0, 0, 0, 0, 150, 79, 150, 79, 81, new ResourceLocation(References.ID, "textures/screen/guidebook/480vmachines.png")).onTooltip(new OnTooltip() {
			...
			public void onTooltip(MatrixStack stack, int xAxis, int yAxis, ScreenGuidebook screen) {
				...
				tooltips.add(ElectroTextUtils.guidebook("chapter.electricity.middle", ElectrodynamicsItems.getItem(SubtypeMachine.energizedalloyer).getDescription().copy().withStyle(TextFormatting.DARK_GRAY)).withStyle(TextFormatting.GRAY).getVisualOrderText());
				tooltips.add(ElectroTextUtils.guidebook("chapter.electricity.right", ElectrodynamicsItems.getItem(SubtypeMachine.mineralgrinderdouble).getDescription().copy().withStyle(TextFormatting.DARK_GRAY)).withStyle(TextFormatting.GRAY).getVisualOrderText()); 
		...
		pageData.add(new ImageWrapperObject(0, 0, 0, 0, 150, 79, 150, 79, 81, new ResourceLocation(References.ID, "textures/screen/guidebook/960vmachines.png")).onTooltip(new OnTooltip() {
			...
			public void onTooltip(MatrixStack stack, int xAxis, int yAxis, ScreenGuidebook screen) {
				List<IReorderingProcessor> tooltips = new ArrayList<>();
				tooltips.add(ElectroTextUtils.guidebook("chapter.electricity.left", ElectrodynamicsItems.getItem(SubtypeMachine.reinforcedalloyer).getDescription().copy().withStyle(TextFormatting.DARK_GRAY)).withStyle(TextFormatting.GRAY).getVisualOrderText());
				tooltips.add(ElectroTextUtils.guidebook("chapter.electricity.middle", ElectrodynamicsItems.getItem(SubtypeMachine.mineralcrushertriple).getDescription().copy().withStyle(TextFormatting.DARK_GRAY)).withStyle(TextFormatting.GRAY).getVisualOrderText());
		...
		pageData.add(new ImageWrapperObject(0, 0, 0, 0, 150, 79, 150, 79, new ResourceLocation(References.ID, "textures/screen/guidebook/energyio.png")).onTooltip(new OnTooltip() {
			...
			public void onTooltip(MatrixStack stack, int xAxis, int yAxis, ScreenGuidebook screen) {
				List<IReorderingProcessor> tooltips = new ArrayList<>();
				tooltips.add(ElectroTextUtils.guidebook("chapter.electricity.left", ElectrodynamicsItems.getItem(SubtypeMachine.batterybox).getDescription().copy().withStyle(TextFormatting.DARK_GRAY)).withStyle(TextFormatting.GRAY).getVisualOrderText());
				tooltips.add(ElectroTextUtils.guidebook("chapter.electricity.middle", ElectrodynamicsItems.getItem(SubtypeMachine.downgradetransformer).getDescription().copy().withStyle(TextFormatting.DARK_GRAY)).withStyle(TextFormatting.GRAY).getVisualOrderText());
				tooltips.add(ElectroTextUtils.guidebook("chapter.electricity.right", ElectrodynamicsItems.getItem(SubtypeMachine.circuitbreaker).getDescription().copy().withStyle(TextFormatting.DARK_GRAY)).withStyle(TextFormatting.GRAY).getVisualOrderText()); //TODO reshoot
		...
		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.topic.wirebasics").withStyle(TextFormatting.BOLD, TextFormatting.UNDERLINE)).setNewPage());

		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.l10", ElectroTextUtils.guidebook("chapter.electricity.wires").withStyle(TextFormatting.BOLD))).setSeparateStart().setIndentions(1));
		...
		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.l11.1", ElectroTextUtils.guidebook("chapter.electricity.resistance").withStyle(TextFormatting.BOLD), ElectroTextUtils.guidebook("chapter.electricity.powerfromcurrent").withStyle(TextFormatting.BOLD))).setSeparateStart().setIndentions(1));
		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.l11.2", ElectroTextUtils.guidebook("chapter.electricity.ampacity").withStyle(TextFormatting.BOLD))).setSeparateStart().setIndentions(1));
		...
		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.l11.4", ElectroTextUtils.guidebook("chapter.electricity.insulation").withStyle(TextFormatting.BOLD))).setSeparateStart().setIndentions(1));

		/* Wire Insulation */

		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.topic.wireinsulation").withStyle(TextFormatting.BOLD, TextFormatting.UNDERLINE)).setNewPage());

		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.l12.1")).setSeparateStart().setIndentions(1));
		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.l12.2", ElectrodynamicsItems.ITEM_RUBBERBOOTS.get().getDescription().copy().withStyle(TextFormatting.BOLD))).setSeparateStart().setIndentions(1));
		...
		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.topic.wiremodification").withStyle(TextFormatting.BOLD, TextFormatting.UNDERLINE)).setNewPage());

		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.l16")).setSeparateStart().setIndentions(1));

		/* Transformers */

		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.topic.transformers").withStyle(TextFormatting.BOLD, TextFormatting.UNDERLINE)).setNewPage());

		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.l17.1")).setSeparateStart().setIndentions(1));
		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.turnsratioformula").withStyle(TextFormatting.BOLD)).setSeparateStart().setIndentions(1));
		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.l17.2")).setSeparateStart());
		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.l17.3", ElectroTextUtils.guidebook("chapter.electricity.upgrade").withStyle(TextFormatting.BOLD), ElectroTextUtils.guidebook("chapter.electricity.downgrade").withStyle(TextFormatting.BOLD))).setSeparateStart().setIndentions(1));

		/* Grid Concepts */

		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.topic.gridconcepts").withStyle(TextFormatting.BOLD, TextFormatting.UNDERLINE)).setNewPage());

		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.l18.1", ElectroTextUtils.guidebook("chapter.electricity.grid").withStyle(TextFormatting.BOLD))).setSeparateStart().setIndentions(1));
		...
		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.l18.4", ElectroTextUtils.guidebook("chapter.electricity.neutralcurrent").withStyle(TextFormatting.BOLD))).setSeparateStart().setIndentions(1));
		...
		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.neutralwirenote").withStyle(TextFormatting.ITALIC)));
		blankLine();
		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.l18.5", ElectroTextUtils.guidebook("chapter.electricity.neutralloss").withStyle(TextFormatting.BOLD))).setSeparateStart());

		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.l18.6")).setSeparateStart().setIndentions(1));

		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.l18.7", ElectroTextUtils.guidebook("chapter.electricity.inrushcurrent").withStyle(TextFormatting.BOLD))).setSeparateStart().setIndentions(1));
		...
		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.topic.gridtools").withStyle(TextFormatting.BOLD, TextFormatting.UNDERLINE)).setNewPage());
		...
		pageData.add(new TextWrapperObject(ElectrodynamicsItems.getItem(SubtypeMachine.multimeterblock).getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
		...
		pageData.add(new TextWrapperObject(ElectrodynamicsItems.getItem(SubtypeMachine.circuitbreaker).getDescription().copy().withStyle(TextFormatting.BOLD)).setCentered().setNewPage());
		...
		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.topic.onfe").withStyle(TextFormatting.BOLD, TextFormatting.UNDERLINE)).setNewPage());

		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.l20")).setSeparateStart().setIndentions(1));

		/* Summary */

		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.topic.summary").withStyle(TextFormatting.BOLD, TextFormatting.UNDERLINE)).setNewPage());

		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.l21")).setSeparateStart().setIndentions(1));

		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.symbols").withStyle(TextFormatting.BOLD)).setNewPage());
		...
		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.equations").withStyle(TextFormatting.BOLD)).setSeparateStart());
