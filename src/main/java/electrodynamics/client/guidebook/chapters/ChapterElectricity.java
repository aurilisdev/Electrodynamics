...
public class ChapterElectricity extends Chapter {
	...
	public void addData() {
		...
		pageData.add(new TextWrapperObject(ElectroTextUtils.guidebook("chapter.electricity.l19.circuitmonitor.2", ElectroTextUtils.gui("networkwattage").withStyle(TextFormatting.BOLD), ElectroTextUtils.gui("networkvoltage").withStyle(TextFormatting.BOLD), ElectroTextUtils.gui("networkampacity").withStyle(TextFormatting.BOLD), ElectroTextUtils.gui("networkminimumvoltage").withStyle(TextFormatting.BOLD), ElectroTextUtils.gui("networkresistance").withStyle(TextFormatting.BOLD), ElectroTextUtils.gui("networkload").withStyle(TextFormatting.BOLD), ElectroTextUtils.gui("networkwattage"))).setSeparateStart().setIndentions(1));
