...
/**
 * A simple wrapper class that contains render data for an image on the Guidebook screen. The class is capable of displaying
 * images as well as text descriptors for said image.
 * 
 * @author skip999
 *
 */
