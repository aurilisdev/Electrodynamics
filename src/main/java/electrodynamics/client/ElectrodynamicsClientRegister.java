...
public class ElectrodynamicsClientRegister {
    ...
    public static final ResourceLocation MODEL_HYDROELECTRICGENERATORBLADES = Electrodynamics
	    .rl("block/hydroelectricgeneratorblades");
    ...
    public static final ResourceLocation MODEL_MINERALCRUSHERDOUBLEHANDLE = Electrodynamics
	    .rl("block/mineralcrusherdoublehandle");
    public static final ResourceLocation MODEL_MINERALCRUSHERTRIPLEHANDLE = Electrodynamics
	    .rl("block/mineralcrushertriplehandle");
	...
	MenuScreens.register(ElectrodynamicsMenuTypes.CONTAINER_THERMOELECTRICMANIPULATOR.get(),
	...
	MenuScreens.register(ElectrodynamicsMenuTypes.CONTAINER_ADVANCEDDOWNGRADETRANSFORMER.get(),
		ScreenAdvancedDowngradeTransformer::new);
	MenuScreens.register(ElectrodynamicsMenuTypes.CONTAINER_ADVANCEDUPGRADETRANSFORMER.get(),
	...
	MenuScreens.register(ElectrodynamicsMenuTypes.CONTAINER_ADVANCEDCOMPRESSOR.get(),
		ScreenAdvancedCompressor::new);
	MenuScreens.register(ElectrodynamicsMenuTypes.CONTAINER_ADVANCEDDECOMPRESSOR.get(),
		ScreenAdvancedDecompressor::new);
