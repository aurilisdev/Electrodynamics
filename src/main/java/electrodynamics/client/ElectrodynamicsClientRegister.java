...
public class ElectrodynamicsClientRegister {
	...
	public static void setup() {
		...
		for (BlockCustomGlass glass : ElectrodynamicsBlocks.BLOCKS_CUSTOMGLASS.getAllValues()) {
			ItemBlockRenderTypes.setRenderLayer(glass, RenderType.cutout());
		}
		
		for(BlockWire wire : ElectrodynamicsBlocks.BLOCKS_WIRE.getAllValues()) {
			ItemBlockRenderTypes.setRenderLayer(wire, RenderType.cutout());
		}
		
		ItemBlockRenderTypes.setRenderLayer(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.circuitbreaker), ElectrodynamicsClientRegister::shouldMultilayerRender);
		ItemBlockRenderTypes.setRenderLayer(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.chemicalcrystallizer), ElectrodynamicsClientRegister::shouldMultilayerRender);
		//ItemBlockRenderTypes.setRenderLayer(ElectrodynamicsBlocks.getBlock(SubtypeMachine.coalgeneratorrunning), RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.combustionchamber), ElectrodynamicsClientRegister::shouldMultilayerRender);
		ItemBlockRenderTypes.setRenderLayer(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.coolantresavoir), ElectrodynamicsClientRegister::shouldMultilayerRender);
		ItemBlockRenderTypes.setRenderLayer(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.fermentationplant), ElectrodynamicsClientRegister::shouldMultilayerRender);
		ItemBlockRenderTypes.setRenderLayer(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.mineralwasher), ElectrodynamicsClientRegister::shouldMultilayerRender);
		//ItemBlockRenderTypes.setRenderLayer(ElectrodynamicsBlocks.getBlock(SubtypeMachine.wiremill), RenderType.cutout());
		ItemBlockRenderTypes.setRenderLayer(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.tanksteel), ElectrodynamicsClientRegister::shouldMultilayerRender);
		ItemBlockRenderTypes.setRenderLayer(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.tankhsla), ElectrodynamicsClientRegister::shouldMultilayerRender);
		ItemBlockRenderTypes.setRenderLayer(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.tankreinforced), ElectrodynamicsClientRegister::shouldMultilayerRender);
		
		ItemBlockRenderTypes.setRenderLayer(ElectrodynamicsBlocks.BLOCK_STEELSCAFFOLDING.get(), RenderType.cutout());
