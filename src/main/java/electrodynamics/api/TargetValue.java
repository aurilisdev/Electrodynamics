...
public class TargetValue {
	...
	double val = this.val * this.acceleration;
	this.val = aimsUp ? val > target ? target : val : val < target ? target : val;
	return this;
    }

    public TargetValue rangeParameterize(double starttarget, double endtarget, double currentTarget, double value,
	    int ticks) {
	val = value;
