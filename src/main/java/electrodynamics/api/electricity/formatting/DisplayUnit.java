...
public enum DisplayUnit implements IDisplayUnit {
	...
	private DisplayUnit(IFormattableTextComponent name, IFormattableTextComponent namePlural, IFormattableTextComponent symbol) {
		this(name, namePlural, symbol, new StringTextComponent(" "));
	}

	private DisplayUnit(IFormattableTextComponent name, IFormattableTextComponent namePlural, IFormattableTextComponent symbol, IFormattableTextComponent distanceFromValue) {
		this.name = name;
