...
//	    supplier(new ItemCompositeArmor(CompositeArmor.COMPOSITE_ARMOR, EquipmentSlotType.HEAD)));
//    public static final RegistryObject<Item> COMPOSITE_CHESTPLATE = ITEMS.register("compositearmorchestplate",
//	    supplier(new ItemCompositeArmor(CompositeArmor.COMPOSITE_ARMOR, EquipmentSlotType.CHEST)));
//    public static final RegistryObject<Item> COMPOSITE_LEGGINGS = ITEMS.register("compositearmorleggings",
//	    supplier(new ItemCompositeArmor(CompositeArmor.COMPOSITE_ARMOR, EquipmentSlotType.LEGS)));
//    public static final RegistryObject<Item> COMPOSITE_BOOTS = ITEMS.register("compositearmorboots",
//	    supplier(new ItemCompositeArmor(CompositeArmor.COMPOSITE_ARMOR, EquipmentSlotType.FEET)));
//
