...
public class DataGenerators {
	...
	if (event.includeServer()) {
		    ...
		    .addProvider(true,
			    new LootTableProvider(output, Collections.emptySet(),
				    List.of(new LootTableProvider.SubProviderEntry(
					    ElectrodynamicsLootTablesProvider::new, LootContextParamSets.BLOCK)),
				    lookupProvider));
	    ...
	    generator.addProvider(true,
		    new ElectrodynamicsAdvancementProvider(output, datapacks.getRegistryProvider()));
	    generator.addProvider(true,
		    new ElectrodynamicsMultiblockProvider(output, datapacks.getRegistryProvider(), helper));
	}
