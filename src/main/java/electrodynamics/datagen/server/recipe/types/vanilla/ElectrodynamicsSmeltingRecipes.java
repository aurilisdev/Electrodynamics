...
public class ElectrodynamicsSmeltingRecipes extends AbstractRecipeGenerator {
	...
	CustomCookingRecipe
		.blastingRecipe(ElectrodynamicsItems.ITEMS_CERAMIC.getValue(SubtypeCeramic.cooked), 0.1F, 300)
		//
	...
	CustomCookingRecipe
		.smeltingRecipe(ElectrodynamicsItems.ITEMS_CUSTOMGLASS.getValue(SubtypeGlass.clear), 0.1F, 200)
		//
	...
	CustomCookingRecipe
		.blastingRecipe(ElectrodynamicsItems.ITEMS_CUSTOMGLASS.getValue(SubtypeGlass.clear), 0.1F, 100)
		//
		.input(VoltaicTags.Items.DUST_SILICA)
		//
