...
public class ElectrodynamicsOxidationFurnaceRecipes extends AbstractRecipeGenerator {
	...
	return FinishedRecipeItemOutput
		.of(ElectrodynamicsRecipies.OXIDATION_FURNACE_SERIALIZER.get(), stack, xp, ticks, usagePerTick)
		.name(RecipeCategory.ITEM_2_ITEM, modID, "oxidation_furnace/" + name);
    }
