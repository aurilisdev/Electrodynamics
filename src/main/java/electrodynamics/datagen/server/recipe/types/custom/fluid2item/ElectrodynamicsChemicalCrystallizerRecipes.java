...
public class ElectrodynamicsChemicalCrystallizerRecipes extends AbstractRecipeGenerator {
    ...
    public Fluid2ItemBuilder<ChemicalCrystalizerRecipe> newRecipe(ItemStack stack, float xp, int ticks,
	    double usagePerTick, String name, String group) {
	return new Fluid2ItemBuilder<>(ChemicalCrystalizerRecipe::new, stack,
		BaseRecipeBuilder.RecipeCategory.FLUID_2_ITEM, modID, "chemical_crystallizer/" + name, group, xp, ticks,
		usagePerTick);
    }
