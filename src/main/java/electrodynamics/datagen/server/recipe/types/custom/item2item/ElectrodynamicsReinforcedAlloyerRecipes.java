...
public class ElectrodynamicsReinforcedAlloyerRecipes extends AbstractRecipeGenerator {
	...
	newRecipe(new ItemStack(ElectrodynamicsItems.ITEMS_INGOT.getValue(SubtypeIngot.superconductive), 4), 0.3F, 50,
		50.0, "ingot_superconductive_endereye")
		//
	...
	newRecipe(new ItemStack(ElectrodynamicsItems.ITEMS_INGOT.getValue(SubtypeIngot.superconductive), 4), 0.3F, 50,
		50.0, "ingot_superconductive_netherite")
		//
		.addItemTagInput(VoltaicTags.Items.INGOT_SILVER, 5)
		//
	...
	return FinishedRecipeItemOutput
		.of(ElectrodynamicsRecipies.REINFORCED_ALLOYER_SERIALIZER.get(), stack, xp, ticks, usagePerTick)
		.name(RecipeCategory.ITEM_2_ITEM, modID, "reinforced_alloyer/" + name);
    }
