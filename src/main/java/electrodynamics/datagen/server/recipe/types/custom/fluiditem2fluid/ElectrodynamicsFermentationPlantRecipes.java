...
public class ElectrodynamicsFermentationPlantRecipes extends AbstractRecipeGenerator {
	...
	newRecipe(new FluidStack(ElectrodynamicsFluids.FLUID_ETHANOL, 100), 0, 2000, 20.0, "ethanol_from_carrots",
		modID)
		//
	...
	newRecipe(new FluidStack(ElectrodynamicsFluids.FLUID_ETHANOL, 100), 0, 2000, 20.0, "ethanol_from_melon_slices",
		modID)
		//
		.addFluidTagInput(FluidTags.WATER, 1000)
		//
	...
	newRecipe(new FluidStack(ElectrodynamicsFluids.FLUID_ETHANOL, 100), 0, 2000, 20.0, "ethanol_from_mushrooms",
		modID)
		//
		.addFluidTagInput(FluidTags.WATER, 1000)
		//
	...
	newRecipe(new FluidStack(ElectrodynamicsFluids.FLUID_ETHANOL, 100), 0, 2000, 20.0, "ethanol_from_potatos",
		modID)
		//
		.addFluidTagInput(FluidTags.WATER, 1000)
		//
	...
	newRecipe(new FluidStack(ElectrodynamicsFluids.FLUID_ETHANOL, 100), 0, 2000, 20.0, "ethanol_from_pumpkins",
		modID)
		//
		.addFluidTagInput(FluidTags.WATER, 1000)
		//
	...
	newRecipe(new FluidStack(ElectrodynamicsFluids.FLUID_ETHANOL, 100), 0, 2000, 20.0, "ethanol_from_sugar_cane",
		modID)
		//
		.addFluidTagInput(FluidTags.WATER, 1000)
		//
    ...
    public FluidItem2FluidBuilder<FermentationPlantRecipe> newRecipe(FluidStack stack, float xp, int ticks,
	    double usagePerTick, String name, String group) {
	return new FluidItem2FluidBuilder<>(FermentationPlantRecipe::new, stack,
		BaseRecipeBuilder.RecipeCategory.FLUID_ITEM_2_FLUID, modID, "fermentation_plant/" + name, group, xp,
		ticks, usagePerTick);
    }
