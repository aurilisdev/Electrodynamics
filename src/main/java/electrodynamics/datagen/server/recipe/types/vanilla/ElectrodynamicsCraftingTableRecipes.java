...
public class ElectrodynamicsCraftingTableRecipes extends AbstractRecipeGenerator {
	...
	public void addRecipes(Consumer<IFinishedRecipe> consumer) {
		...
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_PIPE.getValue(SubtypeFluidPipe.copper), 10)
				...
				.addPattern("III")
				//
				.addKey('I', VoltaicTags.Items.INGOT_COPPER)
				//
		...
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEM_SEISMICMARKER.get(), 1)
				...
				.addKey('P', VoltaicTags.Items.PLATE_STEEL)
				//
				.addKey('A', Tags.Items.GEMS_EMERALD)
				//
		...
		EnchantedBookItem.addEnchantment(fortuneBook, new EnchantmentData(Enchantments.BLOCK_FORTUNE, 1));
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.fortune), 1)
				...
				.addKey('C', VoltaicTags.Items.CIRCUITS_ELITE)
				//
				.addKey('B', NBTIngredient.of(fortuneBook))
				//
		...
		EnchantedBookItem.addEnchantment(silkTouchBook, new EnchantmentData(Enchantments.SILK_TOUCH, 1));
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.silktouch), 1)
				...
				//
				.addKey('B', NBTIngredient.of(silkTouchBook))
				//
		...
		EnchantedBookItem.addEnchantment(unbreakingBook, new EnchantmentData(Enchantments.UNBREAKING, 1));
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.unbreaking), 1)
				...
				.addKey('C', VoltaicTags.Items.CIRCUITS_ADVANCED)
				//
				.addKey('B', NBTIngredient.of(unbreakingBook))
				//
		...
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEM_CONCRETEMIX.get(), 4)
				//
				.addPattern("SGS")
				//
				.addPattern("GMG")
				...
				//
				.complete(Electrodynamics.ID, "concretemix_slag", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEM_CONCRETEMIX.get(), 10)
				//
				.addPattern("SGS")
				//
				.addPattern("GMG")
				...
				//
				.complete(Electrodynamics.ID, "concretemix_netherite", consumer);

// CONCRETE

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_CONCRETE.getValue(SubtypeConcrete.bricks), 4)
				//
				.addPattern("CC")
				//
				.addPattern("CC")
				//
				.addKey('C', ElectrodynamicsItems.ITEMS_CONCRETE.getValue(SubtypeConcrete.regular).asItem())
				//
				.complete(Electrodynamics.ID, "concrete_bricks", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_CONCRETE.getValue(SubtypeConcrete.tile), 4)
				//
				.addPattern("CC")
				//
				.addPattern("CC")
				//
				.addKey('C', ElectrodynamicsItems.ITEMS_CONCRETE.getValue(SubtypeConcrete.bricks).asItem())
				//
				.complete(Electrodynamics.ID, "concrete_tile", consumer);

		CustomShapelessCraftingRecipe.start(ElectrodynamicsItems.ITEMS_CONCRETE.getValue(SubtypeConcrete.regular), 1)
				//
				.addIngredient(VoltaicTags.Items.CONCRETES)
				//
				.complete(Electrodynamics.ID, "concrete_regular", consumer);
	}
	...
	private void addMachine(Consumer<IFinishedRecipe> consumer) {
		...
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.cobblestonegenerator), 1)
				//
				.addPattern("PWP")
				//
				.addPattern("LCW")
				...
				.addKey('C', VoltaicTags.Items.CIRCUITS_BASIC)
				//
				.complete(Electrodynamics.ID, "machine_cobblestone_generator", consumer);
	...
	private void addWires(Consumer<IFinishedRecipe> consumer) {
