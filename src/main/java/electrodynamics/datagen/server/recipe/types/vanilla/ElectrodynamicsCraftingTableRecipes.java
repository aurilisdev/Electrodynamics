...
public class ElectrodynamicsCraftingTableRecipes extends AbstractRecipeGenerator {
	...
	public void addRecipes(Consumer<FinishedRecipe> consumer) {
		...
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_GASPIPE.getValue(SubtypeGasPipe.UNINSULATEDCOPPER), 10)
				//
				.addPattern("PPP")
				//
				.addPattern("   ")
				...
				//
				.complete(Electrodynamics.ID, "gaspipe_copper_horizontal", consumer);
		...
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_GASPIPE.getValue(SubtypeGasPipe.UNINSULATEDCOPPER), 10)
				...
				.addKey('P', VoltaicTags.Items.PLATE_COPPER)
				//
				.complete(Electrodynamics.ID, "gaspipe_copper_vertical", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_GASPIPE.getValue(SubtypeGasPipe.UNINSULATEDSTEEL), 3)
				//
				.addPattern("PPP")
				//
				.addPattern("   ")
				...
				.addKey('P', VoltaicTags.Items.PLATE_STEEL)
				//
				.complete(Electrodynamics.ID, "gaspipe_steel_horizontal", consumer);
		...
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_GASPIPE.getValue(SubtypeGasPipe.UNINSULATEDSTEEL), 3)
				...
				.addKey('P', VoltaicTags.Items.PLATE_STEEL)
				//
				.complete(Electrodynamics.ID, "gaspipe_steel_vertical", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_GASPIPE.getValue(SubtypeGasPipe.UNINSULATEDPLASTIC), 6)
				//
				.addPattern("PPP")
				//
				.addPattern("   ")
				...
				.addKey('P', VoltaicTags.Items.PLASTIC)
				//
				.complete(Electrodynamics.ID, "gaspipe_plastic_horizontal", consumer);
		...
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_GASPIPE.getValue(SubtypeGasPipe.UNINSULATEDPLASTIC), 6)
				...
				.addKey('P', VoltaicTags.Items.PLASTIC)
				//
				.complete(Electrodynamics.ID, "gaspipe_plastic_vertical", consumer);
		...
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.advancedcapacity), 1)
				//
				.addPattern("PBP")
				//
				.addPattern("BWB")
				...
				.addKey('C', VoltaicTags.Items.CIRCUITS_ADVANCED)
				//
				.complete(Electrodynamics.ID, "upgrade_advanced_capacity", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.advancedspeed), 1)
				//
				.addPattern("PGP")
				//
				.addPattern("BWB")
				...
				.addKey('C', VoltaicTags.Items.CIRCUITS_ADVANCED)
				//
				.complete(Electrodynamics.ID, "upgrade_advanced_speed", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.basiccapacity), 1)
				//
				.addPattern("PBP")
				//
				.addPattern("BWB")
				...
				.addKey('C', VoltaicTags.Items.CIRCUITS_BASIC)
				//
				.complete(Electrodynamics.ID, "upgrade_basic_capacity", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.basicspeed), 1)
				//
				.addPattern("PGP")
				//
				.addPattern("WWW")
				...
				.addKey('C', VoltaicTags.Items.CIRCUITS_BASIC)
				//
				.complete(Electrodynamics.ID, "upgrade_basic_speed", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.experience), 1)
				//
				.addPattern("PBP")
				//
				.addPattern("BWB")
				...
				.addKey('W', VoltaicTags.Items.INSULATED_COPPER_WIRES)
				//
				.complete(Electrodynamics.ID, "upgrade_experience", consumer);
		...
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.fortune), 1)
				//
				.addPattern("PCP")
				//
				.addPattern("CBC")
				...
				//
				.complete(Electrodynamics.ID, "upgrade_fortune", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.improvedsolarcell), 1)
				//
				.addPattern("PPP")
				//
				.addPattern("BCB")
				...
				.addKey('S', VoltaicTags.Items.PLATE_STEEL)
				//
				.complete(Electrodynamics.ID, "upgrade_improved_solar_cell", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.iteminput), 1)
				//
				.addPattern("C")
				//
				.addPattern("P")
				...
				//
				.complete(Electrodynamics.ID, "upgrade_item_input", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.itemoutput), 1)
				//
				.addPattern("C")
				//
				.addPattern("P")
				...
				//
				.complete(Electrodynamics.ID, "upgrade_item_output", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.itemvoid), 1)
				//
				.addPattern("C")
				//
				.addPattern("B")
				...
				//
				.complete(Electrodynamics.ID, "upgrade_item_void", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.range), 1)
				//
				.addPattern("PWP")
				//
				.addPattern("WBW")
				...
				.addKey('B', VoltaicTags.Items.CIRCUITS_BASIC)
				//
				.complete(Electrodynamics.ID, "upgrade_range", consumer);
		...
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.silktouch), 1)
				//
				.addPattern("PCP")
				//
				.addPattern("CBC")
				...
				//
				.complete(Electrodynamics.ID, "upgrade_silk_touch", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.stator), 1)
				//
				.addPattern("PCP")
				//
				.addPattern("CRC")
				...
				.addKey('R', Tags.Items.DUSTS_REDSTONE)
				//
				.complete(Electrodynamics.ID, "upgrade_stator", consumer);
		...
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.unbreaking), 1)
				//
				.addPattern("PCP")
				//
				.addPattern("CBC")
				...
				//
				.complete(Electrodynamics.ID, "upgrade_unbreaking", consumer);

		CustomShapelessCraftingRecipe.start(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.itemoutput), 1)
				//
				.addIngredient(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.itemoutput))
				//
				.complete(Electrodynamics.ID, "upgrade_item_output_reset", consumer);

		CustomShapelessCraftingRecipe.start(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.iteminput), 1)
				//
				.addIngredient(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.iteminput))
				//
				.complete(Electrodynamics.ID, "upgrade_item_input_reset", consumer);
		...
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEM_MECHANICALVALVE.get(), 1)
				//
				.addPattern("SLS")
				//
				.addPattern("BIB")
				...
				//
				.complete(Electrodynamics.ID, "mechanical_valve", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEM_PRESSUREGAGE.get(), 1)
				//
				.addPattern("IPI")
				//
				.addPattern("CRD")
	...
	private static void addMachine(Consumer<FinishedRecipe> consumer) {
		...
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.gasvent), 1)
				//
				.addPattern("SBS")
				//
				.addPattern("BCB")
				...
				.addKey('C', Items.CACTUS)
				//
				.complete(Electrodynamics.ID, "machine_gas_vent", consumer);
		...
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEM_COMPRESSOR_ADDONTANK.get(), 1)
				//
				.addPattern("SSS")
				//
				.addPattern("SCS")
				...
				.addKey('C', Items.CAULDRON)
				//
				.complete(Electrodynamics.ID, "pressurized_tank", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.gastanksteel), 1)
				//
				.addPattern(" V ")
				//
				.addPattern("SPS")
				...
				//
				.complete(Electrodynamics.ID, "machine_gastank_steel", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.gastankreinforced), 1)
				//
				.addPattern("SSS")
				//
				.addPattern("STS")
				...
				.addKey('T', ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.gastanksteel))
				//
				.complete(Electrodynamics.ID, "machine_gastank_reinforced", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.gastankhsla), 1)
				//
				.addPattern("SSS")
				//
				.addPattern("STS")
				...
				//
				.complete(Electrodynamics.ID, "machine_gastank_hsla", consumer);
		...
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEM_COMPRESSOR.get(), 1)
				//
				.addPattern("PPP")
				//
				.addPattern("TVT")
				...
				//
				.complete(Electrodynamics.ID, "machine_compressor", consumer);

		CustomShapelessCraftingRecipe.start(ElectrodynamicsItems.ITEM_DECOMPRESSOR.get(), 1)
				//
				.addIngredient(ElectrodynamicsItems.ITEM_COMPRESSOR.get())
				//
				.addIngredient(ElectrodynamicsItems.ITEM_MECHANICALVALVE.get())
				//
				.complete(Electrodynamics.ID, "machine_decompressor", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEM_THERMOELECTRIC_MANIPULATOR.get(), 1)
				//
				.addPattern("PGP")
				//
				.addPattern("TVT")
				...
				//
				.complete(Electrodynamics.ID, "machine_thermoelectric_manipulator", consumer);
		...
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.gasvalve), 1)
				//
				.addPattern("VPR")
				//
				.addKey('V', ElectrodynamicsItems.ITEM_MECHANICALVALVE.get())
				...
				.addKey('R', Tags.Items.DUSTS_REDSTONE)
				//
				.complete(Electrodynamics.ID, "pipe_gasvalve", consumer);
		...
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.gaspipepump), 1)
				//
				.addPattern(" C ")
				//
				.addPattern("VPV")
				...
				.addKey('M', ElectrodynamicsItems.ITEM_MOTOR.get())
				//
				.complete(Electrodynamics.ID, "pipe_gaspump", consumer);
		...
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.gaspipefilter), 1)
				//
				.addPattern(" C ")
				//
				.addPattern("VPV")
				...
				.addKey('#', Items.PAPER)
				//
				.complete(Electrodynamics.ID, "pipe_gasfilter", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEM_ADVANCEDCOMPRESSOR.get(), 1)
				//
				.addPattern("PCP")
				//
				.addPattern("VMV")
				...
				//
				.complete(Electrodynamics.ID, "machine_advancedcompressor", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEM_ADVANCEDDECOMPRESSOR.get(), 1)
				//
				.addPattern("PCP")
				//
				.addPattern("VMV")
				...
				.addKey('O', ElectrodynamicsItems.ITEM_MOTOR.get())
				//
				.complete(Electrodynamics.ID, "machine_advanceddecompressor", consumer);

		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEM_ADVANCED_THERMOELECTRIC_MANIPULATOR.get(), 1)
				//
				.addPattern("PCP")
				//
				.addPattern("VMV")
				...
				//
				.complete(Electrodynamics.ID, "machine_advancedthermoelectricmanipulator", consumer);
	...
	private static void addGear(Consumer<FinishedRecipe> consumer) {
		...
		CustomShapedCraftingRecipe.start(ElectrodynamicsItems.ITEM_PORTABLECYLINDER.get(), 1)
				//
				.addPattern("V")
				//
				.addPattern("S")
				...
				.addKey('V', ElectrodynamicsItems.ITEM_MECHANICALVALVE.get())
				//
				.complete(Electrodynamics.ID, "portable_cylinder", consumer);
