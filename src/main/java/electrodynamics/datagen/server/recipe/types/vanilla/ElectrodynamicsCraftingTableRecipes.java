...
public class ElectrodynamicsCraftingTableRecipes extends AbstractRecipeGenerator {
	...
	ShapedCraftingRecipeBuilder
		.start(ElectrodynamicsItems.ITEMS_CHROMOTOGRAPHYCARD.getValue(SubtypeChromotographyCard.oxygen), 1)
		//
		.addPattern(" G ")
		//
		.addPattern("WPW")
	...
	ShapedCraftingRecipeBuilder
		.start(ElectrodynamicsItems.ITEMS_CHROMOTOGRAPHYCARD.getValue(SubtypeChromotographyCard.carbondioxide),
			1)
		//
		.addPattern(" G ")
		//
		...
		.addKey('C', VoltaicTags.Items.CIRCUITS_ADVANCED)
		//
		.complete(Electrodynamics.ID, "chromotographycard_" + SubtypeChromotographyCard.carbondioxide.name(),
			output);

	ShapedCraftingRecipeBuilder
		.start(ElectrodynamicsItems.ITEMS_CHROMOTOGRAPHYCARD.getValue(SubtypeChromotographyCard.nitrogen), 1)
		//
		.addPattern(" G ")
		//
		.addPattern("WPW")
		...
		.addKey('C', VoltaicTags.Items.CIRCUITS_BASIC)
		//
		.complete(Electrodynamics.ID, "chromotographycard_" + SubtypeChromotographyCard.nitrogen.name(),
			output);

	ShapedCraftingRecipeBuilder
		.start(ElectrodynamicsItems.ITEMS_CHROMOTOGRAPHYCARD.getValue(SubtypeChromotographyCard.argon), 1)
		//
		.addPattern(" G ")
		//
		.addPattern("WPW")
	...
	ShapedCraftingRecipeBuilder
		.start(ElectrodynamicsItems.ITEMS_CHROMOTOGRAPHYCARD.getValue(SubtypeChromotographyCard.sulfurdioxide),
			1)
		//
		.addPattern(" G ")
		//
		...
		.addKey('C', VoltaicTags.Items.CIRCUITS_BASIC)
		//
		.complete(Electrodynamics.ID, "chromotographycard_" + SubtypeChromotographyCard.sulfurdioxide.name(),
			output);
	...
	ShapedCraftingRecipeBuilder.start(VoltaicItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.fortune), 1)
		...
		//
		.addKey('B',
			new EnchantmentIngredient(Ingredient.of(Items.ENCHANTED_BOOK),
				Lists.newArrayList(Tags.Enchantments.INCREASE_BLOCK_DROPS), false))
		//
	...
	ShapedCraftingRecipeBuilder.start(VoltaicItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.silktouch), 1)
		...
		.addKey('B',
			new EnchantmentIngredient(Ingredient.of(Items.ENCHANTED_BOOK),
				Lists.newArrayList(VoltaicTags.Enchantments.SILK_TOUCH), false))
		//
	...
	ShapedCraftingRecipeBuilder.start(VoltaicItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.unbreaking), 1)
		...
		.addKey('B',
			new EnchantmentIngredient(Ingredient.of(Items.ENCHANTED_BOOK),
				Lists.newArrayList(VoltaicTags.Enchantments.UNBREAKING), false))
		//
	...
	ShapedCraftingRecipeBuilder
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.coolantresavoir), 1)
		//
		.addPattern("SSS")
		//
		.addPattern("STS")
	...
	ShapedCraftingRecipeBuilder
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.electricfurnace), 1)
		//
		.addPattern("SSS")
		//
		.addPattern("SCS")
	...
	ShapedCraftingRecipeBuilder
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.multimeterblock), 1)
		//
		.addPattern(" S ")
		//
		.addPattern("SMS")
	...
	ShapedCraftingRecipeBuilder
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.fluidpipefilter), 1)
		//
		.addPattern(" C ")
		//
		.addPattern("VPV")
	...
	ShapedCraftingRecipeBuilder
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.electrolosischamber), 1)
		//
		.addPattern("ITI")
		//
		.addPattern("TET")
