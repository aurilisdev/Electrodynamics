...
public class ElectrodynamicsCraftingTableRecipes extends AbstractRecipeGenerator {
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_DRILLHEAD.getValue(SubtypeDrillHead.stainlesssteel), 1)
		//
		.addPattern(" I ")
		//
		.addPattern("IPI")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_DRILLHEAD.getValue(SubtypeDrillHead.titaniumcarbide), 1)
		//
		.addPattern(" I ")
		//
		.addPattern("IPI")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_GASPIPE.getValue(SubtypeGasPipe.UNINSULATEDCOPPER), 10)
		//
		.addPattern("PPP")
		//
		.addPattern("   ")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_GASPIPE.getValue(SubtypeGasPipe.UNINSULATEDSTEEL), 3)
		//
		.addPattern("PPP")
		//
		.addPattern("   ")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_GASPIPE.getValue(SubtypeGasPipe.UNINSULATEDPLASTIC), 6)
		//
		.addPattern("PPP")
		//
		.addPattern("   ")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.advanceddowngradetransformer), 1)
		//
		.addPattern("PPP")
		//
		.addPattern("OTO")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.advancedupgradetransformer), 1)
		//
		.addPattern("PPP")
		//
		.addPattern("OTO")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.advancedsolarpanel), 1)
		//
		.addPattern(" S ")
		//
		.addPattern("SPS")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.carbynebatterybox), 1)
		//
		.addPattern("BBB")
		//
		.addPattern("PWP")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.chemicalcrystallizer), 1)
		//
		.addPattern("SCS")
		//
		.addPattern("GMG")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.combustionchamber), 1)
		//
		.addPattern("PMP")
		//
		.addPattern("GWG")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.creativefluidsource), 1)
		//
		.addPattern("CCC")
		//
		.addPattern("CBC")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.creativepowersource), 1)
		//
		.addPattern("BBB")
		//
		.addPattern("BNB")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.currentregulator), 1)
		//
		.addPattern("SAS")
		//
		.addPattern("DCU")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.downgradetransformer), 1)
		//
		.addPattern("ISI")
		//
		.addPattern("W C")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.electricfurnacedouble), 1)
		//
		.addPattern("CSC")
		//
		.addPattern("GFG")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.electricfurnacetriple), 1)
		//
		.addPattern("COC")
		//
		.addPattern("DFD")
	...
	CustomShapelessCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.electricarcfurnace), 1)
		//
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.electricarcfurnacedouble), 1)
		//
		.addPattern("CSC")
		//
		.addPattern("GEG")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.electricarcfurnacetriple), 1)
		//
		.addPattern("COC")
		//
		.addPattern("DED")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.electrolyticseparator), 1)
		//
		.addPattern("PTP")
		//
		.addPattern("TXT")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.energizedalloyer), 1)
		//
		.addPattern("ACA")
		//
		.addPattern("CTC")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.fermentationplant), 1)
		//
		.addPattern("IMI")
		//
		.addPattern("BCB")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.lithiumbatterybox), 1)
		//
		.addPattern("BBB")
		//
		.addPattern("SWS")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.hydroelectricgenerator), 1)
		//
		.addPattern(" M ")
		//
		.addPattern("WSW")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.mineralcrusherdouble), 1)
		//
		.addPattern("EDE")
		//
		.addPattern("MCM")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.mineralcrushertriple), 1)
		//
		.addPattern("UVU")
		//
		.addPattern("MCM")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.mineralgrinderdouble), 1)
		//
		.addPattern("CGC")
		//
		.addPattern("BMB")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.mineralgrindertriple), 1)
		//
		.addPattern("CDC")
		//
		.addPattern("GMG")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.oxidationfurnace), 1)
		//
		.addPattern("PGP")
		//
		.addPattern("CFC")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.reinforcedalloyer), 1)
		//
		.addPattern("CSC")
		//
		.addPattern("SAS")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.gastankreinforced), 1)
		//
		.addPattern("SSS")
		//
		.addPattern("STS")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.thermoelectricgenerator), 1)
		//
		.addPattern("ISI")
		//
		.addPattern("SPS")
	...
	CustomShapedCraftingRecipe
		.start(ElectrodynamicsItems.ITEMS_MACHINE.getValue(SubtypeMachine.upgradetransformer), 1)
		//
		.addPattern("ISI")
		//
		.addPattern("C W")
