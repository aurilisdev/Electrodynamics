...
public class ElectrodynamicsCraftingTableRecipes extends AbstractRecipeGenerator {
	...
	public void addRecipes(Consumer<FinishedRecipe> consumer) {
		...
		ElectrodynamicsShapedCraftingRecipe.start(ElectrodynamicsItems.ITEM_CONCRETEMIX.get(), 10)
				//
				.addPattern("SGS")
				//
				.addPattern("GMG")
		...
		ElectrodynamicsShapedCraftingRecipe.start(ElectrodynamicsBlocks.getBlock(SubtypeConcrete.bricks).asItem(), 4)
				//
				.addPattern("CC")
				//
				.addPattern("CC")
				//
				.addKey('C', ElectrodynamicsBlocks.getBlock(SubtypeConcrete.regular).asItem())
				//
				.complete(References.ID, "concrete_bricks", consumer);

		ElectrodynamicsShapedCraftingRecipe.start(ElectrodynamicsBlocks.getBlock(SubtypeConcrete.tile).asItem(), 4)
				//
				.addPattern("CC")
				//
				.addPattern("CC")
				//
				.addKey('C', ElectrodynamicsBlocks.getBlock(SubtypeConcrete.bricks).asItem())
				//
				.complete(References.ID, "concrete_tile", consumer);

		ElectrodynamicsShapelessCraftingRecipe.start(ElectrodynamicsBlocks.getBlock(SubtypeConcrete.regular).asItem(), 1)
				//
				.addIngredient(ElectrodynamicsTags.Items.CONCRETES)
				//
