...
public class ElectrodynamicsWireMillRecipes extends AbstractRecipeGenerator {
	...
	newRecipe(new ItemStack(ElectrodynamicsItems.ITEMS_WIRE.getValue(SubtypeWire.superconductive)), 0.1F, 200,
		125.0, "superconductive_wire_from_ingot")
		//
	...
	return FinishedRecipeItemOutput
		.of(ElectrodynamicsRecipies.WIRE_MILL_SERIALIZER.get(), stack, xp, ticks, usagePerTick)
		.name(RecipeCategory.ITEM_2_ITEM, modID, "wire_mill/" + name);
    }
