...
public class ElectrodynamicsEnergizedAlloyerRecipes extends AbstractRecipeGenerator {
	...
	public void addRecipes(Consumer<IFinishedRecipe> consumer) {
		...
		newRecipe(new ItemStack(ElectrodynamicsItems.ITEMS_CUSTOMGLASS.getValue(SubtypeGlass.aluminum), 4), 0.5F, 50, 50.0, "aluminum_glass")
				//
		...
		newRecipe(new ItemStack(ElectrodynamicsItems.ITEMS_INGOT.getValue(SubtypeIngot.bronze), 5), 0.35F, 50, 50.0, "ingot_bronze")
				//
				.addItemTagInput(VoltaicTags.Items.INGOT_TIN, 1)
				//
				.addItemTagInput(VoltaicTags.Items.INGOT_COPPER, 4)
				//
		...
		newRecipe(new ItemStack(ElectrodynamicsItems.ITEMS_INGOT.getValue(SubtypeIngot.stainlesssteel), 32), 0.4F, 50, 50.0, "ingot_stainless_steel")
				//
		...
		newRecipe(new ItemStack(ElectrodynamicsItems.ITEMS_INGOT.getValue(SubtypeIngot.steel), 3), 0.3F, 50, 50.0, "ingot_steel")
				//
		...
		newRecipe(new ItemStack(ElectrodynamicsItems.ITEMS_INGOT.getValue(SubtypeIngot.vanadiumsteel), 8), 0.3F, 50, 50.0, "ingot_vanadium_steel")
				//
	...
	public FinishedRecipeItemOutput newRecipe(ItemStack stack, float xp, int ticks, double usagePerTick, String name) {
		return FinishedRecipeItemOutput.of(ElectrodynamicsRecipies.ENERGIZED_ALLOYER_SERIALIZER.get(), stack, xp, ticks, usagePerTick).name(RecipeCategory.ITEM_2_ITEM, modID, "energized_alloyer/" + name);
	}
