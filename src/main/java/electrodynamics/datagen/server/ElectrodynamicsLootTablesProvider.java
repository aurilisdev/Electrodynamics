...
public class ElectrodynamicsLootTablesProvider extends BaseLootTablesProvider {
	...
	protected void addTables() {
        ...
        for (SubtypeConcrete concrete : SubtypeConcrete.values()) {
			addSimpleBlock(ElectrodynamicsBlocks.BLOCKS_CONCRETE.getValue(concrete));
		}
        ...
        addMachineTable(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.cobblestonegenerator), ElectrodynamicsTiles.TILE_COBBLESTONEGENERATOR, true, false, false, true, false);
