...
public class ElectrodynamicsLootTablesProvider extends AbstractLootTableProvider {
	...
	public <T extends GenericTile> void addITable(Block block, RegistryObject<TileEntityType<T>> tilereg) {
		lootTables.put(block, itemTable(name(block), block, tilereg.get()));
	}

	public <T extends GenericTile> void addETable(Block block, RegistryObject<TileEntityType<T>> tilereg) {

		lootTables.put(block, energyTable(name(block), block, tilereg.get()));
	}

	public <T extends GenericTile> void addFTable(Block block, RegistryObject<TileEntityType<T>> tilereg) {

		lootTables.put(block, fluidTable(name(block), block, tilereg.get()));
	}

	public <T extends GenericTile> void addIETable(Block block, RegistryObject<TileEntityType<T>> tilereg) {

		lootTables.put(block, itemEnergyTable(name(block), block, tilereg.get()));
	}

	public <T extends GenericTile> void addIFTable(Block block, RegistryObject<TileEntityType<T>> tilereg) {

		lootTables.put(block, itemFluidTable(name(block), block, tilereg.get()));
	}

	public <T extends GenericTile> void addIEFTable(Block block, RegistryObject<TileEntityType<T>> tilereg) {
