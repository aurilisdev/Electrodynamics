...
public class ElectrodynamicsBlockTagsProvider extends BlockTagsProvider {
    ...
    public ElectrodynamicsBlockTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider,
	...
	tag(Tags.Blocks.NEEDS_WOOD_TOOL)
		...
		.add(ElectrodynamicsBlocks.BLOCKS_CUSTOMGLASS.getAllValuesArray(new BlockCustomGlass[0]))
		//
		.add(ElectrodynamicsBlocks.BLOCKS_ORE.getSpecificValuesArray(new BlockOre[0],
			SubtypeOre.getOreForMiningLevel(0)))
		//
		.add(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getSpecificValuesArray(new BlockOre[0],
			SubtypeOreDeepslate.getOreForMiningLevel(0)))
		//
		.add(ElectrodynamicsBlocks.BLOCKS_RAWORE.getSpecificValuesArray(new BlockRawOre[0],
			SubtypeRawOreBlock.getForMiningLevel(0)))
		//
		.add(ElectrodynamicsBlocks.BLOCKS_RESOURCE.getSpecificValuesArray(new Block[0],
			SubtypeResourceBlock.getForMiningLevel(0)))
		//
		.add(ElectrodynamicsBlocks.BLOCKS_WIRE.getAllValuesArray(new BlockWire[0]))
		//
		.add(ElectrodynamicsBlocks.BLOCK_FRAME.get())
	...
	tag(BlockTags.NEEDS_STONE_TOOL)
		...
		//
		.add(ElectrodynamicsBlocks.BLOCKS_ORE.getSpecificValuesArray(new BlockOre[0],
			SubtypeOre.getOreForMiningLevel(1)))
		//
		.add(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getSpecificValuesArray(new BlockOre[0],
			SubtypeOreDeepslate.getOreForMiningLevel(1)))
		//
		.add(ElectrodynamicsBlocks.BLOCKS_RAWORE.getSpecificValuesArray(new BlockRawOre[0],
			SubtypeRawOreBlock.getForMiningLevel(1)))
		//
		.add(ElectrodynamicsBlocks.BLOCKS_RESOURCE.getSpecificValuesArray(new Block[0],
			SubtypeResourceBlock.getForMiningLevel(1)))
		//
		.add(ElectrodynamicsBlocks.BLOCK_SEISMICMARKER.get())
		//
		.add(ElectrodynamicsBlocks.BLOCK_LOGISTICALMANAGER.get())
	...
	tag(BlockTags.NEEDS_IRON_TOOL)
		//
		.add(ElectrodynamicsBlocks.BLOCKS_ORE.getSpecificValuesArray(new BlockOre[0],
			SubtypeOre.getOreForMiningLevel(2)))
		//
		.add(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getSpecificValuesArray(new BlockOre[0],
			SubtypeOreDeepslate.getOreForMiningLevel(2)))
		//
		.add(ElectrodynamicsBlocks.BLOCKS_RAWORE.getSpecificValuesArray(new BlockRawOre[0],
			SubtypeRawOreBlock.getForMiningLevel(2)))
		//
		.add(ElectrodynamicsBlocks.BLOCKS_RESOURCE.getSpecificValuesArray(new Block[0],
			SubtypeResourceBlock.getForMiningLevel(2)));

	tag(BlockTags.NEEDS_DIAMOND_TOOL)
		//
		.add(ElectrodynamicsBlocks.BLOCKS_ORE.getSpecificValuesArray(new BlockOre[0],
			SubtypeOre.getOreForMiningLevel(3)))
		//
		.add(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getSpecificValuesArray(new BlockOre[0],
			SubtypeOreDeepslate.getOreForMiningLevel(3)))
		//
		.add(ElectrodynamicsBlocks.BLOCKS_RAWORE.getSpecificValuesArray(new BlockRawOre[0],
			SubtypeRawOreBlock.getForMiningLevel(3)))
		//
		.add(ElectrodynamicsBlocks.BLOCKS_RESOURCE.getSpecificValuesArray(new Block[0],
			SubtypeResourceBlock.getForMiningLevel(3)));
	...
	tag(VoltaicTags.Blocks.ELECTRIC_DRILL_BLOCKS).addTags(BlockTags.MINEABLE_WITH_PICKAXE,
