...
public class ElectrodynamicsAdvancementProvider extends BaseAdvancementProvider {
    ...
    public void generate(HolderLookup.Provider registries) {
        ...
        AdvancementHolder insulation = advancement("insulation")
                //
                .display(ElectrodynamicsItems.ITEMS_WIRE.getValue(SubtypeWire.insulatedcopperblack), ElectroTextUtils.advancement("insulatedwiring.title").withStyle(ChatFormatting.GRAY), ElectroTextUtils.advancement("insulation.desc"), AdvancementBuilder.AdvancementBackgrounds.NONE, AdvancementType.TASK, true, true, false)
                //
