...
public class ElectrodynamicsBlockStateProvider extends BlockStateProvider {
	...
	protected void registerStatesAndModels() {
		...
		for (SubtypeConcrete concrete : SubtypeConcrete.values()) {
			simpleBlock(ElectrodynamicsBlocks.getBlock(concrete), blockLoc("concrete/" + concrete.tag()), true);
		}
		...
		horrRotatedBlock(ElectrodynamicsBlocks.getBlock(SubtypeMachine.cobblestonegenerator), existingBlock(ElectrodynamicsBlocks.getBlock(SubtypeMachine.cobblestonegenerator)), true);
		...
		horrRotatedBlock(ElectrodynamicsBlocks.getBlock(SubtypeMachine.electricarcfurnacerunning), existingBlock(blockLoc("electricarcfurnacerunning")), true);
		horrRotatedBlock(ElectrodynamicsBlocks.getBlock(SubtypeMachine.electricarcfurnacedoublerunning), existingBlock(blockLoc("electricarcfurnacedoublerunning")), true);
		horrRotatedBlock(ElectrodynamicsBlocks.getBlock(SubtypeMachine.electricarcfurnacetriplerunning),  existingBlock(blockLoc("electricarcfurnacetriplerunning")), true);
