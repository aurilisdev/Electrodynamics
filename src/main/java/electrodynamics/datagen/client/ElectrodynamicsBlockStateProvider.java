...
public class ElectrodynamicsBlockStateProvider extends BaseBlockstateProvider {
	...
	protected void registerStatesAndModels() {
        ...
        horrRotatedBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.combustionchamber), existingBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.combustionchamber)), true).transforms().transform(Perspective.GUI).rotation(35, 40, 0).scale(0.665F).end();
