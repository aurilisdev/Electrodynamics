...
public class ElectrodynamicsLangKeyProvider extends LanguageProvider {
	...
	protected void addTranslations() {
		...
		addBlock(ElectrodynamicsBlocks.getBlock(SubtypeMachine.electricarcfurnacerunning), "Electric Arc Furnace");
		addBlock(ElectrodynamicsBlocks.getBlock(SubtypeMachine.electricarcfurnacedoublerunning), "Double Electric Arc Furnace");
		addBlock(ElectrodynamicsBlocks.getBlock(SubtypeMachine.electricarcfurnacetriplerunning), "Triple Electric Arc Furnace");
		...
		addBlock(ElectrodynamicsBlocks.getBlock(SubtypeConcrete.tile), "Concrete Tiles");
		...
		addFluid(ElectrodynamicsFluids.fluidCement, "Liquid Concrete");
