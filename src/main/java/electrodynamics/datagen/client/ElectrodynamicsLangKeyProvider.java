...
public class ElectrodynamicsLangKeyProvider extends BaseLangKeyProvider {
	...
	default:
	    ...
	    addItem(ElectrodynamicsItems.ITEMS_DRILLHEAD.getValue(SubtypeDrillHead.stainlesssteel),
		    "Stainless Drill Head");
	    ...
	    addItem(ElectrodynamicsItems.ITEMS_DRILLHEAD.getValue(SubtypeDrillHead.titaniumcarbide),
		    "Carbide Drill Head");
	    ...
	    addItem(ElectrodynamicsItems.ITEMS_IMPUREDUST.getValue(SubtypeImpureDust.molybdenum),
		    "Impure Molybdenum Dust");
	    ...
	    /*
	     * addItem(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.
	     * advancedcapacity), "Advanced Capacity Upgrade");
	     * addItem(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.
	     * advancedspeed), "Advanced Speed Upgrade");
	     * addItem(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.
	     * basiccapacity), "Basic Capacity Upgrade");
	     * addItem(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.
	     * basicspeed), "Basic Speed Upgrade");
	     * addItem(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.
	     * experience), "Experience Upgrade");
	     * addItem(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.
	     * fortune), "Fortune Upgrade");
	     * addItem(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.
	     * improvedsolarcell), "Solar Cell Upgrade");
	     * addItem(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.
	     * iteminput), "Auto-Injector Upgrade");
	     * addItem(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.
	     * itemoutput), "Auto-Ejector Upgrade");
	     * addItem(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.
	     * itemvoid), "Void Upgrade");
	     * addItem(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.range)
	     * , "Range Upgrade");
	     * addItem(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.
	     * silktouch), "Silk Touch Upgrade");
	     * addItem(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.stator
	     * ), "Stator Upgrade");
	     * addItem(ElectrodynamicsItems.ITEMS_UPGRADE.getValue(SubtypeItemUpgrade.
	     * unbreaking), "Unbreaking Upgrade");
	     */
	    ...
	    addItem(ElectrodynamicsItems.ITEMS_NUGGET.getValue(SubtypeNugget.superconductive),
		    "Superconductive Nugget");
	    addItem(ElectrodynamicsItems.ITEMS_NUGGET.getValue(SubtypeNugget.tin), "Tin Nugget");
	    addItem(ElectrodynamicsItems.ITEMS_NUGGET.getValue(SubtypeNugget.titaniumcarbide),
		    "Titanium Carbide Nugget");
	    ...
	    addItem(ElectrodynamicsItems.ITEMS_CHROMOTOGRAPHYCARD.getValue(SubtypeChromotographyCard.argon),
		    "Argon Chromotography Card");
	    addItem(ElectrodynamicsItems.ITEMS_CHROMOTOGRAPHYCARD.getValue(SubtypeChromotographyCard.carbondioxide),
		    "Carbon Chromotography Card");
	    addItem(ElectrodynamicsItems.ITEMS_CHROMOTOGRAPHYCARD.getValue(SubtypeChromotographyCard.nitrogen),
		    "Nitrogen Chromotography Card");
	    addItem(ElectrodynamicsItems.ITEMS_CHROMOTOGRAPHYCARD.getValue(SubtypeChromotographyCard.oxygen),
		    "Oxygen Chromotography Card");
	    addItem(ElectrodynamicsItems.ITEMS_CHROMOTOGRAPHYCARD.getValue(SubtypeChromotographyCard.sulfurdioxide),
		    "Sulfur Chromotography Card");
	    ...
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.advancedsolarpanel),
		    "Advanced Solar Panel");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.batterybox), "Battery Box");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.carbynebatterybox),
		    "Carbyne Battery Box");
	    ...
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.chemicalcrystallizer),
	    ...
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.combustionchamber),
		    "Combustion Chamber");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.coolantresavoir), "Coolant Resavoir");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.creativefluidsource),
		    "Creative Fluid Source");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.creativegassource),
		    "Creative Gas Source");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.creativepowersource),
		    "Creative Power Source");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.downgradetransformer),
		    "Downgrade Transformer");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.electricarcfurnace),
		    "Electric Arc Furnace");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.electricarcfurnacedouble),
		    "Double Electric Arc Furnace");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.electricarcfurnacetriple),
	    ...
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.electricfurnacedouble),
		    "Double Electric Furnace");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.electricfurnacetriple),
		    "Triple Electric Furnace");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.electricpump), "Electric Pump");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.electrolosischamber),
		    "Electrolysis Chamber");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.electrolyticseparator),
		    "Electrolytic Separator");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.energizedalloyer),
		    "Energized Alloyer");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.fermentationplant),
		    "Fermentation Plant");
	    ...
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.hydroelectricgenerator),
		    "Hydroelectric Generator");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.lathe), "Lathe");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.lithiumbatterybox),
		    "Lithium Battery Box");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.mineralcrusher), "Mineral Crusher");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.mineralcrusherdouble),
		    "Double Mineral Crusher");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.mineralcrushertriple),
		    "Triple Mineral Crusher");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.mineralgrinder), "Mineral Grinder");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.mineralgrinderdouble),
		    "Double Mineral Grinder");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.mineralgrindertriple),
		    "Triple Mineral Grinder");
	    ...
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.oxidationfurnace),
		    "Chemical Furnace");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.quarry), "Quarry");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.reinforcedalloyer),
		    "Reinforced Alloyer");
	    ...
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.thermoelectricgenerator),
		    "Thermoelectric Generator");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.upgradetransformer),
		    "Upgrade Transformer");
	    ...
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.fluidpipefilter),
		    "Fluid Pipe Filter");
	    ...
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.currentregulator),
		    "Current Regulator");

	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.advanceddowngradetransformer),
		    "Downgrade Transformer Mk 2");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.advancedupgradetransformer),
		    "Upgrade Transformer Mk 2");
	    ...
	    addBlock(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getValue(SubtypeOreDeepslate.aluminum),
		    "Deep Bauxite Ore");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getValue(SubtypeOreDeepslate.chromium),
		    "Deep Chromite Ore");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getValue(SubtypeOreDeepslate.fluorite),
		    "Deep Fluorite Ore");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getValue(SubtypeOreDeepslate.lead), "Deep Galena Ore");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getValue(SubtypeOreDeepslate.lithium),
		    "Deep Lepidolite Ore");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getValue(SubtypeOreDeepslate.molybdenum),
		    "Deep Molybdenite Ore");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getValue(SubtypeOreDeepslate.monazite),
		    "Deep Monazite Ore");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getValue(SubtypeOreDeepslate.niter),
		    "Deep Saltpeter Ore");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getValue(SubtypeOreDeepslate.salt), "Deep Halite Ore");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getValue(SubtypeOreDeepslate.silver),
		    "Deep Argentite Ore");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getValue(SubtypeOreDeepslate.sulfur), "Deep Sulfur Ore");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getValue(SubtypeOreDeepslate.sylvite),
		    "Deep Sylvite Ore");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getValue(SubtypeOreDeepslate.tin),
		    "Deep Cassiterite Ore");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getValue(SubtypeOreDeepslate.titanium),
		    "Deep Rutile Ore");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getValue(SubtypeOreDeepslate.thorium),
		    "Deep Thorianite Ore");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getValue(SubtypeOreDeepslate.uranium),
		    "Deep Uraninite Ore");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getValue(SubtypeOreDeepslate.vanadium),
		    "Deep Vanadinite Ore");
	    ...
	    addBlock(ElectrodynamicsBlocks.BLOCKS_RAWORE.getValue(SubtypeRawOreBlock.chromium),
		    "Block of Raw Chromite");
	    ...
	    addBlock(ElectrodynamicsBlocks.BLOCKS_RAWORE.getValue(SubtypeRawOreBlock.thorium),
		    "Block of Raw Thorianite");
	    ...
	    addBlock(ElectrodynamicsBlocks.BLOCKS_RAWORE.getValue(SubtypeRawOreBlock.uranium),
		    "Block of Raw Uraninite");

	    addBlock(ElectrodynamicsBlocks.BLOCKS_RESOURCE.getValue(SubtypeResourceBlock.aluminum),
		    "Block of Aluminum");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_RESOURCE.getValue(SubtypeResourceBlock.bronze), "Block of Bronze");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_RESOURCE.getValue(SubtypeResourceBlock.chromium),
		    "Block of Chromium");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_RESOURCE.getValue(SubtypeResourceBlock.hslasteel),
		    "Block of HSLA Steel");
	    ...
	    addBlock(ElectrodynamicsBlocks.BLOCKS_RESOURCE.getValue(SubtypeResourceBlock.stainlesssteel),
	    ...
	    addBlock(ElectrodynamicsBlocks.BLOCKS_RESOURCE.getValue(SubtypeResourceBlock.titanium),
		    "Block of Titanium");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_RESOURCE.getValue(SubtypeResourceBlock.titaniumcarbide),
		    "Block of Titanium Carbide");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_RESOURCE.getValue(SubtypeResourceBlock.vanadiumsteel),
		    "Block of Vanadium Steel");
	    ...
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedcopperblack),
		    "Insulated Copper Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedgoldblack),
		    "Insulated Gold Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedironblack),
		    "Insulated Iron Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedsilverblack),
		    "Insulated Silver Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedsuperconductiveblack),
		    "Insulated Superconductive Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedtinblack),
		    "Insulated Tin Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedcopperred),
		    "Insulated Copper Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedgoldred),
		    "Insulated Gold Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedironred),
		    "Insulated Iron Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedsilverred),
		    "Insulated Silver Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedsuperconductivered),
		    "Insulated Superconductive Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedtinred),
		    "Insulated Tin Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedcoppergreen),
		    "Insulated Copper Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedgoldgreen),
		    "Insulated Gold Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedirongreen),
		    "Insulated Iron Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedsilvergreen),
		    "Insulated Silver Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedsuperconductivegreen),
		    "Insulated Superconductive Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedtingreen),
		    "Insulated Tin Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedcopperblue),
		    "Insulated Copper Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedgoldblue),
		    "Insulated Gold Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedironblue),
		    "Insulated Iron Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedsilverblue),
		    "Insulated Silver Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedsuperconductiveblue),
		    "Insulated Superconductive Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedtinblue),
		    "Insulated Tin Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedcopperwhite),
		    "Insulated Copper Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedgoldwhite),
		    "Insulated Gold Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedironwhite),
		    "Insulated Iron Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedsilverwhite),
		    "Insulated Silver Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedsuperconductivewhite),
		    "Insulated Superconductive Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedtinwhite),
		    "Insulated Tin Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedcopperyellow),
		    "Insulated Copper Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedgoldyellow),
		    "Insulated Gold Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedironyellow),
		    "Insulated Iron Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedsilveryellow),
		    "Insulated Silver Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedsuperconductiveyellow),
		    "Insulated Superconductive Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedtinyellow),
		    "Insulated Tin Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedcopperbrown),
		    "Insulated Copper Wire (Brown)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedgoldbrown),
		    "Insulated Gold Wire (Brown)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedironbrown),
		    "Insulated Iron Wire (Brown)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedsilverbrown),
		    "Insulated Silver Wire (Brown)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedsuperconductivebrown),
		    "Insulated Superconductive Wire (Brown)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.insulatedtinbrown),
		    "Insulated Tin Wire (Brown)");

	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedcopperblack),
		    "Ceramic Copper Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedgoldblack),
		    "Ceramic Gold Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedironblack),
		    "Ceramic Iron Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedsilverblack),
		    "Ceramic Silver Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedsuperconductiveblack),
		    "Ceramic Superconductive Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedtinblack),
		    "Ceramic Tin Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedcopperred),
		    "Ceramic Copper Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedgoldred),
		    "Ceramic Gold Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedironred),
		    "Ceramic Iron Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedsilverred),
		    "Ceramic Silver Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedsuperconductivered),
		    "Ceramic Superconductive Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedtinred),
		    "Ceramic Tin Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedcopperwhite),
		    "Ceramic Copper Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedgoldwhite),
		    "Ceramic Gold Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedironwhite),
		    "Ceramic Iron Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedsilverwhite),
		    "Ceramic Silver Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedsuperconductivewhite),
		    "Ceramic Superconductive Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedtinwhite),
		    "Ceramic Tin Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedcoppergreen),
		    "Ceramic Copper Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedgoldgreen),
		    "Ceramic Gold Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedirongreen),
		    "Ceramic Iron Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedsilvergreen),
		    "Ceramic Silver Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedsuperconductivegreen),
		    "Ceramic Superconductive Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedtingreen),
		    "Ceramic Tin Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedcopperblue),
		    "Ceramic Copper Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedgoldblue),
		    "Ceramic Gold Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedironblue),
		    "Ceramic Iron Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedsilverblue),
		    "Ceramic Silver Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedsuperconductiveblue),
		    "Ceramic Superconductive Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedtinblue),
		    "Ceramic Tin Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedcopperyellow),
		    "Ceramic Copper Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedgoldyellow),
		    "Ceramic Gold Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedironyellow),
		    "Ceramic Iron Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedsilveryellow),
		    "Ceramic Silver Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedsuperconductiveyellow),
		    "Ceramic Superconductive Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedtinyellow),
		    "Ceramic Tin Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedcopperbrown),
		    "Ceramic Copper Wire (Brown)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedgoldbrown),
		    "Ceramic Gold Wire (Brown)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedironbrown),
		    "Ceramic Iron Wire (Brown)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedsilverbrown),
		    "Ceramic Silver Wire (Brown)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedsuperconductivebrown),
		    "Ceramic Superconductive Wire (Brown)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.ceramicinsulatedtinbrown),
		    "Ceramic Tin Wire (Brown)");

	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticscopperblack),
		    "Logistical Copper Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticsgoldblack),
		    "Logistical Gold Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticsironblack),
		    "Logistical Iron Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticssilverblack),
		    "Logistical Silver Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticssuperconductiveblack),
		    "Logistical Superconductive Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticstinblack),
		    "Logistical Tin Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticscopperred),
		    "Logistical Copper Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticsgoldred),
		    "Logistical Gold Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticsironred),
		    "Logistical Iron Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticssilverred),
		    "Logistical Silver Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticssuperconductivered),
		    "Logistical Superconductive Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticstinred),
		    "Logistical Tin Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticscopperwhite),
		    "Logistical Copper Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticsgoldwhite),
		    "Logistical Gold Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticsironwhite),
		    "Logistical Iron Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticssilverwhite),
		    "Logistical Silver Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticssuperconductivewhite),
		    "Logistical Superconductive Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticstinwhite),
		    "Logistical Tin Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticscoppergreen),
		    "Logistical Copper Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticsgoldgreen),
		    "Logistical Gold Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticsirongreen),
		    "Logistical Iron Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticssilvergreen),
		    "Logistical Silver Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticssuperconductivegreen),
		    "Logistical Superconductive Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticstingreen),
		    "Logistical Tin Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticscopperblue),
		    "Logistical Copper Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticsgoldblue),
		    "Logistical Gold Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticsironblue),
		    "Logistical Iron Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticssilverblue),
		    "Logistical Silver Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticssuperconductiveblue),
		    "Logistical Superconductive Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticstinblue),
		    "Logistical Tin Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticscopperyellow),
		    "Logistical Copper Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticsgoldyellow),
		    "Logistical Gold Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticsironyellow),
		    "Logistical Iron Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticssilveryellow),
		    "Logistical Silver Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticssuperconductiveyellow),
		    "Logistical Superconductive Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticstinyellow),
		    "Logistical Tin Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticscopperbrown),
		    "Logistical Copper Wire (Brown)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticsgoldbrown),
		    "Logistical Gold Wire (Brown)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticsironbrown),
		    "Logistical Iron Wire (Brown)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticssilverbrown),
		    "Logistical Silver Wire (Brown)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticssuperconductivebrown),
		    "Logistical Superconductive Wire (Brown)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.logisticstinbrown),
		    "Logistical Tin Wire (Brown)");

	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedcopperblack),
		    "Thick Copper Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedgoldblack),
		    "Thick Gold Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedironblack),
		    "Thick Iron Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedsilverblack),
		    "Thick Silver Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedsuperconductiveblack),
		    "Thick Superconductive Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedtinblack),
		    "Thick Tin Wire (Black)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedcopperred),
		    "Thick Copper Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedgoldred),
		    "Thick Gold Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedironred),
		    "Thick Iron Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedsilverred),
		    "Thick Silver Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedsuperconductivered),
		    "Thick Superconductive Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedtinred),
		    "Thick Tin Wire (Red)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedcoppergreen),
		    "Thick Copper Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedgoldgreen),
		    "Thick Gold Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedirongreen),
		    "Thick Iron Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedsilvergreen),
		    "Thick Silver Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedsuperconductivegreen),
		    "Thick Superconductive Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedtingreen),
		    "Thick Tin Wire (Green)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedcopperblue),
		    "Thick Copper Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedgoldblue),
		    "Thick Gold Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedironblue),
		    "Thick Iron Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedsilverblue),
		    "Thick Silver Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedsuperconductiveblue),
		    "Thick Superconductive Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedtinblue),
		    "Thick Tin Wire (Blue)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedcopperwhite),
		    "Thick Copper Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedgoldwhite),
		    "Thick Gold Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedironwhite),
		    "Thick Iron Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedsilverwhite),
		    "Thick Silver Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedsuperconductivewhite),
		    "Thick Superconductive Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedtinwhite),
		    "Thick Tin Wire (White)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedcopperyellow),
		    "Thick Copper Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedgoldyellow),
		    "Thick Gold Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedironyellow),
		    "Thick Iron Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedsilveryellow),
		    "Thick Silver Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedsuperconductiveyellow),
		    "Thick Superconductive Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedtinyellow),
		    "Thick Tin Wire (Yellow)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedcopperbrown),
		    "Thick Copper Wire (Brown)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedgoldbrown),
		    "Thick Gold Wire (Brown)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedironbrown),
		    "Thick Iron Wire (Brown)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedsilverbrown),
		    "Thick Silver Wire (Brown)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedsuperconductivebrown),
		    "Thick Superconductive Wire (Brown)");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeWire.highlyinsulatedtinbrown),
		    "Thick Tin Wire (Brown)");

	    addBlock(ElectrodynamicsBlocks.BLOCKS_GASPIPE.getValue(SubtypeGasPipe.UNINSULATEDCOPPER),
		    "Copper Gas Pipe");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_GASPIPE.getValue(SubtypeGasPipe.UNINSULATEDSTEEL), "Steel Gas Pipe");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_GASPIPE.getValue(SubtypeGasPipe.UNINSULATEDPLASTIC),
		    "Plastic Gas Pipe");
	    // addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeGasPipe.WOOLINSULATEDCOPPER),
	    // "Woolen Copper Gas Pipe");
	    // addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeGasPipe.WOOLINSULATEDSTEEL),
	    // "Woolen Steel Gas Pipe");
	    // addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeGasPipe.WOOLINSULATEDPLASTIC),
	    // "Woolen Plastic Gas Pipe");
	    // addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeGasPipe.CERAMICINSULATEDCOPPER),
	    // "Ceramic Copper Gas Pipe");
	    // addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeGasPipe.CERAMICINSULATEDSTEEL),
	    // "Ceramic Steel Gas Pipe");
	    // addBlock(ElectrodynamicsBlocks.BLOCKS_WIRE.getValue(SubtypeGasPipe.CERAMICINSULATEDPLASTIC),
	    // "Ceramic Plastic Gas Pipe");

	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.gastanksteel), "Steel Gas Cylinder");
	    addBlock(ElectrodynamicsBlocks.BLOCKS_MACHINE.getValue(SubtypeMachine.gastankreinforced),
		    "Reinforced Gas Cylinder");
	    ...
	    addFluid(ElectrodynamicsFluids.FLUIDS_SULFATE.getValue(SubtypeSulfateFluid.copper),
	    ...
	    addFluid(ElectrodynamicsFluids.FLUIDS_SULFATE.getValue(SubtypeSulfateFluid.lithium),
		    "Lithium Sulfate Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_SULFATE.getValue(SubtypeSulfateFluid.molybdenum),
		    "Molybdenum Sulfate Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_SULFATE.getValue(SubtypeSulfateFluid.netherite),
		    "Carbyne Sulfate Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_SULFATE.getValue(SubtypeSulfateFluid.silver),
	    ...
	    addFluid(ElectrodynamicsFluids.FLUIDS_SULFATE.getValue(SubtypeSulfateFluid.vanadium),
		    "Vanadium Sulfate Solution");

	    addFluid(ElectrodynamicsFluids.FLUIDS_PUREMINERAL.getValue(SubtypePureMineralFluid.aluminum),
		    "Pure Aluminum Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_PUREMINERAL.getValue(SubtypePureMineralFluid.copper),
		    "Pure Copper Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_PUREMINERAL.getValue(SubtypePureMineralFluid.chromium),
		    "Pure Chromium Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_PUREMINERAL.getValue(SubtypePureMineralFluid.gold),
		    "Pure Gold Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_PUREMINERAL.getValue(SubtypePureMineralFluid.iron),
		    "Pure Iron Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_PUREMINERAL.getValue(SubtypePureMineralFluid.lead),
		    "Pure Lead Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_PUREMINERAL.getValue(SubtypePureMineralFluid.lithium),
		    "Pure Lithium Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_PUREMINERAL.getValue(SubtypePureMineralFluid.molybdenum),
		    "Pure Molybdenum Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_PUREMINERAL.getValue(SubtypePureMineralFluid.netherite),
		    "Pure Carbyne Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_PUREMINERAL.getValue(SubtypePureMineralFluid.silver),
		    "Pure Silver Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_PUREMINERAL.getValue(SubtypePureMineralFluid.tin),
		    "Pure Tin Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_PUREMINERAL.getValue(SubtypePureMineralFluid.titanium),
		    "Pure Titanium Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_PUREMINERAL.getValue(SubtypePureMineralFluid.vanadium),
		    "Pure Vanadium Solution");

	    addFluid(ElectrodynamicsFluids.FLUIDS_IMPUREMINERAL.getValue(SubtypeImpureMineralFluid.aluminum),
		    "Impure Aluminum Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_IMPUREMINERAL.getValue(SubtypeImpureMineralFluid.copper),
		    "Impure Copper Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_IMPUREMINERAL.getValue(SubtypeImpureMineralFluid.chromium),
		    "Impure Chromium Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_IMPUREMINERAL.getValue(SubtypeImpureMineralFluid.gold),
		    "Impure Gold Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_IMPUREMINERAL.getValue(SubtypeImpureMineralFluid.iron),
		    "Impure Iron Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_IMPUREMINERAL.getValue(SubtypeImpureMineralFluid.lead),
		    "Impure Lead Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_IMPUREMINERAL.getValue(SubtypeImpureMineralFluid.lithium),
		    "Impure Lithium Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_IMPUREMINERAL.getValue(SubtypeImpureMineralFluid.molybdenum),
		    "Impure Molybdenum Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_IMPUREMINERAL.getValue(SubtypeImpureMineralFluid.netherite),
		    "Impure Carbyne Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_IMPUREMINERAL.getValue(SubtypeImpureMineralFluid.silver),
		    "Impure Silver Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_IMPUREMINERAL.getValue(SubtypeImpureMineralFluid.tin),
		    "Impure Tin Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_IMPUREMINERAL.getValue(SubtypeImpureMineralFluid.titanium),
		    "Impure Titanium Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_IMPUREMINERAL.getValue(SubtypeImpureMineralFluid.vanadium),
		    "Impure Vanadium Solution");

	    addFluid(ElectrodynamicsFluids.FLUIDS_DIRTYMINERAL.getValue(SubtypeDirtyMineralFluid.aluminum),
		    "Dirty Aluminum Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_DIRTYMINERAL.getValue(SubtypeDirtyMineralFluid.copper),
		    "Dirty Copper Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_DIRTYMINERAL.getValue(SubtypeDirtyMineralFluid.chromium),
		    "Dirty Chromium Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_DIRTYMINERAL.getValue(SubtypeDirtyMineralFluid.gold),
		    "Dirty Gold Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_DIRTYMINERAL.getValue(SubtypeDirtyMineralFluid.iron),
		    "Dirty Iron Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_DIRTYMINERAL.getValue(SubtypeDirtyMineralFluid.lead),
		    "Dirty Lead Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_DIRTYMINERAL.getValue(SubtypeDirtyMineralFluid.lithium),
		    "Dirty Lithium Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_DIRTYMINERAL.getValue(SubtypeDirtyMineralFluid.molybdenum),
		    "Dirty Molybdenum Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_DIRTYMINERAL.getValue(SubtypeDirtyMineralFluid.netherite),
		    "Dirty Carbyne Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_DIRTYMINERAL.getValue(SubtypeDirtyMineralFluid.silver),
		    "Dirty Silver Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_DIRTYMINERAL.getValue(SubtypeDirtyMineralFluid.tin),
		    "Dirty Tin Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_DIRTYMINERAL.getValue(SubtypeDirtyMineralFluid.titanium),
		    "Dirty Titanium Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_DIRTYMINERAL.getValue(SubtypeDirtyMineralFluid.vanadium),
		    "Dirty Vanadium Solution");

	    addFluid(ElectrodynamicsFluids.FLUIDS_CRUDEMINERAL.getValue(SubtypeCrudeMineralFluid.aluminum),
		    "Crude Aluminum Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_CRUDEMINERAL.getValue(SubtypeCrudeMineralFluid.copper),
		    "Crude Copper Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_CRUDEMINERAL.getValue(SubtypeCrudeMineralFluid.chromium),
		    "Crude Chromium Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_CRUDEMINERAL.getValue(SubtypeCrudeMineralFluid.gold),
		    "Crude Gold Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_CRUDEMINERAL.getValue(SubtypeCrudeMineralFluid.iron),
		    "Crude Iron Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_CRUDEMINERAL.getValue(SubtypeCrudeMineralFluid.lead),
		    "Crude Lead Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_CRUDEMINERAL.getValue(SubtypeCrudeMineralFluid.lithium),
		    "Crude Lithium Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_CRUDEMINERAL.getValue(SubtypeCrudeMineralFluid.molybdenum),
		    "Crude Molybdenum Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_CRUDEMINERAL.getValue(SubtypeCrudeMineralFluid.netherite),
		    "Crude Carbyne Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_CRUDEMINERAL.getValue(SubtypeCrudeMineralFluid.silver),
		    "Crude Silver Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_CRUDEMINERAL.getValue(SubtypeCrudeMineralFluid.tin),
		    "Crude Tin Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_CRUDEMINERAL.getValue(SubtypeCrudeMineralFluid.titanium),
		    "Crude Titanium Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_CRUDEMINERAL.getValue(SubtypeCrudeMineralFluid.vanadium),
		    "Crude Vanadium Solution");

	    addFluid(ElectrodynamicsFluids.FLUIDS_ROYALMINERAL.getValue(SubtypeRoyalMineralFluid.aluminum),
		    "Royal Aluminum Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_ROYALMINERAL.getValue(SubtypeRoyalMineralFluid.copper),
		    "Royal Copper Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_ROYALMINERAL.getValue(SubtypeRoyalMineralFluid.chromium),
		    "Royal Chromium Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_ROYALMINERAL.getValue(SubtypeRoyalMineralFluid.gold),
		    "Royal Gold Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_ROYALMINERAL.getValue(SubtypeRoyalMineralFluid.iron),
		    "Royal Iron Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_ROYALMINERAL.getValue(SubtypeRoyalMineralFluid.lead),
		    "Royal Lead Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_ROYALMINERAL.getValue(SubtypeRoyalMineralFluid.lithium),
		    "Royal Lithium Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_ROYALMINERAL.getValue(SubtypeRoyalMineralFluid.molybdenum),
		    "Royal Molybdenum Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_ROYALMINERAL.getValue(SubtypeRoyalMineralFluid.netherite),
		    "Royal Carbyne Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_ROYALMINERAL.getValue(SubtypeRoyalMineralFluid.silver),
		    "Royal Silver Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_ROYALMINERAL.getValue(SubtypeRoyalMineralFluid.tin),
		    "Royal Tin Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_ROYALMINERAL.getValue(SubtypeRoyalMineralFluid.titanium),
		    "Royal Titanium Solution");
	    addFluid(ElectrodynamicsFluids.FLUIDS_ROYALMINERAL.getValue(SubtypeRoyalMineralFluid.vanadium),
		    "Royal Vanadium Solution");
	    ...
	    addGuidebook("chapter.metricprefixes.l1",
		    "Electrodynamics makes use of several Metric System unit prefixes when displaying units. Prefixes are used to help condense values into a more concise and readable format. While you are possibly familiar with some or all of them, below is a list of prefixes and their numerical "
			    + "meanings:");
	    ...
	    addGuidebook("chapter.metricprefixes.l2",
		    "This prefixes will be used extensively throughout the mod, so it is important to at least familiarize yourself with the existance of this list in case you need to reference it again.");

	    addGuidebook("chapter.electricity", "Electricity");

	    addGuidebook("chapter.electricity.l1",
		    "Understanding how energy and electricity work is key if you want to do well in Electrodynamics. This chapter will cover the following topics:");
	    ...
	    addGuidebook("chapter.electricity.l2.1",
		    "Machines require energy to do work, and this energy is measured in units of Joules, denoted with a capital J. However, the energy needs to be \"flowing\" in order for it to actually do work. The speed of the flow is measured in units of Volts, which are denoted with a capital V. The volume of "
	    ...
	    addGuidebook("chapter.electricity.l3.1",
		    "Now that we understand the basics of electricity, it is time to cover how electricity will actually be interacted with in the mod. As covered previously, machines require flowing energy to do work. However, not all machines are the same, and different machines will require "
	    ...
	    addGuidebook("chapter.electricity.l3.2",
		    "However, if the tooltip does not provide this information, or if you do not have a spare machine to mouse over, there are a couple of methods of checking.");

	    addGuidebook("chapter.electricity.l4",
		    "The first method is to look at the machine in question when placed in the world. Most machines have a set of colored diagonal lines, with the color being directly related to the voltage. The following voltages are represented by the following colors:");
	    ...
	    addGuidebook("chapter.electricity.l5",
		    "The following pages contain examples of machines with these markings:");
	    ...
	    addGuidebook("chapter.electricity.l6",
		    "The second method for checking a machine's voltage is to look at the voltage displayed by the energy tooltip in it's GUI. While the previous methods do not always provide the needed information, the tooltip in the GUI will always provide the correct voltage for a machine. This "
	    ...
	    addGuidebook("chapter.electricity.l7",
		    "However, not every machine has markings such as the Quarry or has a GUI like the Pump, so it's important to keep track of the voltages you are working with before engergizing a machine. Too low of a voltage, and a machine will consume energy but won't run. Too high of a "
			    + "voltage, and the machine will explode!");

	    addGuidebook("chapter.electricity.l8",
		    "Now that we have a basic understanding of how voltage will be interacted with, it's time to understand how to get energy into the machine. All machines that use energy will have an I/O port to interface with for energy transfer. However, unlike the voltage indicators discussed "
	    ...
	    addGuidebook("chapter.electricity.l10",
		    "However, what is connected to these ports? Now it's time to discuss how electricity is transfered to and from machines: %s. Wires in this mod function a little differently than what you're used to. For starters, wires do not store energy. Furthermore, if you hover over a wire "
	    ...
	    addGuidebook("chapter.electricity.l11.1",
		    "%1$s is a measure of how opposed a material is to the flow of electricity, and is measured in units of Ohms, denoted by a capital Omega ("
			    + '\u03A9'
			    + "). The Resistance of a wire will determine how much energy is lost when a current is developed over it. You can use the "
	    ...
	    addGuidebook("chapter.electricity.l11.2",
		    "The %s of a wire describes how high a current the wire can experience before it fails. If the current in a wire exceeds its ampacity, the wire runs the risk of permanent damage and/or destruction!");
	    addGuidebook("chapter.electricity.ampacity", "Ampacity");
	    addGuidebook("chapter.electricity.l11.3",
		    "However, not all hope is completely lost for the wire if you introduce a higher current than it is rated for. Wires can withstand a current higher than their rated ampacity for %s ticks. While not a very long period of time, it gives you the chance to save the wire!");

	    addGuidebook("chapter.electricity.l11.4",
		    "The %s of a wire determines how high a voltage the insulation of a conductor can handle before breakdown occurs, and the energy is able to short through the insulation. Uninsulated wires can shock you amongst other items that will be covered here shortly.");
	    addGuidebook("chapter.electricity.insulation", "Insulation Rating");

	    addGuidebook("chapter.electricity.l12.1",
		    "The topic of insulation is deceptively simple and is worth an in-depth look at this point. Insulation has more factors to consider than just a voltage rating when selecting an insulation type to use. These factors will now be discussed at length.");
	    addGuidebook("chapter.electricity.l12.2",
		    "As discussed, an under or uninsulated wire can shock you. However, this is not the be-all end-all factor for a wire's insulation. You can mitigate the danger of being shocked by wearing %s. You will still take some damage if you are shocked while wearing them, however you will "
	    ...
	    addGuidebook("chapter.electricity.l13.1",
		    "Different insulation types also come with pros and cons. Wool-based insulation is cheap, easy to come by, and highly effective:");
	    addGuidebook("chapter.electricity.l13.2",
		    "A specialzed variant of a wool-insulated wire is the Logistical Wire:");
	    addGuidebook("chapter.electricity.l13.3",
		    "It will emit a redstone signal when power is flowing through it.");
	    addGuidebook("chapter.electricity.l13.4",
		    "Ceramic insulation on the other hand is more expensive than wool, but gains the advantage of being fire-proof:");
	    addGuidebook("chapter.electricity.l13.5",
		    "This makes ceramicly insulated wires especially useful when working around fluids like lava. It should be noted though that ceramic insulation is not as effective as "
	    ...
	    addGuidebook("chapter.electricity.l14.2",
		    "Being able to color-coat wires has several advantages, the largest of which being the ability to run multiple wires in parallel right next to each other without having them connect. This can be very helpful if you are dealing with machine setups where multiple voltages are involved in tight quarters. ");

	    addGuidebook("chapter.electricity.l15",
		    "While on the topic of insulation ratings, It is critical to understand that a wire not having sufficiant insulation has greater ramifications than just shocking you. Wires transmitting voltages higher than what they are rated for will have a random chance to set the blocks "
	    ...
	    addGuidebook("chapter.electricity.l17.2",
	    ...
	    addGuidebook("chapter.electricity.l18.1",
		    "Now that we understand the basics of electricity, how it will be interacted with, and how it can be manipulated, we can start to piece the different aspects together. This combination of aspects will be referred to as a %1$s moving forward. Operating machines in a grid introduces "
	    ...
	    addGuidebook("chapter.electricity.l18.2",
		    "To construct a grid, we must first understand how Electrodynamics' electrical model functions. Electrodynamics assumes that all power sources are agregated into one large power source. It then assumes all loads are in series. This can be modeled with the following circuit diagram:");

	    addGuidebook("chapter.electricity.l18.3",
		    "This model is not perfect, however it gets the job done, and is about as acurate as you can get without a complex system model using software such as SPICE. Knowing how wire networks are modeled will prove valuable moving forward.");

	    addGuidebook("chapter.electricity.l18.4",
		    "The first of the more complex concepts that will be introduced is known as Return Current or %1$s. In short, the neutral current means you will lose twice the amount of energy to wire resistance you will think you will lose. While this may sound strange, a detailed examination of how current works "
	    ...
	    addGuidebook("chapter.electricity.neutralwirenote",
		    "A Single Phase Power Line. Primary Conductor (top), Neutral Conductor (middle), Communication Cable (bottom)");

	    addGuidebook("chapter.electricity.l18.5",
		    "The Primary Conductor provides the path for the current to the load, and the Neutral Conductor provides the return path for the current to its source. Electrodynamics does not render a Neutral Conductor, however it assumes that Neutral Conductor is the same length as the "
	    ...
	    addGuidebook("chapter.electricity.l19.1",
		    "By now, you are feeling overwhelmed most likely. How are you supposed to keep track of what voltage your grid is operating at? How are you supposed to keep track of the overall resistance? Fear not, for Electrodynamics offers several tools and blocks to assist with this, "
			    + "along with other tools you may find useful. These will be covered on the following pages.");

	    addGuidebook("chapter.electricity.l19.handheldmultimeter.1",
		    "The Handheld Multimeter allows you to view multiple data points for a wire grid. Right-clicking any wire conneted to a grid will display several imporant data points about that grid:");
	    addGuidebook("chapter.electricity.l19.handheldmultimeter.2",
		    "The first data point is the current power being transmitted in Amps in proportion to the Ampacity of the wire network. The second data point shows the current operating voltage of the wire network. The third data point shows the current power transfer in watts. "
	    ...
	    addGuidebook("chapter.electricity.l19.multimeterblock.1",
		    "The Multimeter Block offers the same functionality as the hand-held variant, but will display the relevant data constantly.");

	    addGuidebook("chapter.electricity.l19.relay.1",
		    "The Relay will stop the flow of electricity when powered with a redstone signal:");
	    addGuidebook("chapter.electricity.l19.relay.2",
		    "This is particularly useful, as it means that you can turn machines off and on without having to break a wire or waiting for them to fill up. The Relay also does not impose a power loss when power flows across it. This comes at a price however, as it is also a dumb switch, "
	    ...
	    addGuidebook("chapter.electricity.l19.circuitbreaker.1",
		    "The Circuit Breaker is an improved version of the Relay. Not only is able to be manually opened with a redstone signal, but it will also open automatically if it senses that the transmitting voltage will damage a machine or if the transmitting current will damage "
			    + "a wire or machine:");
	    addGuidebook("chapter.electricity.l19.circuitbreaker.2",
		    "However, this protective nature comes at a price, as the Circuit Breaker has a small power loss. This means you will need to be somewhat more thoughtful with your use of them!");

	    addGuidebook("chapter.electricity.l19.currentregulator.1",
		    "The Current Regulator is another protective device offered by Electrodynamics. Unlike the Circuit Breaker which is focused on interrupting power, the Current Regulator will ensure that current does not exceed the maximum rated ampacity of the downstream line "
	    ...
	    addGuidebook("chapter.electricity.l19.potentiometer.1",
		    "The Potentiometer is, as the tooltip suggests, a programmable energy sink. If the entered value is less than 0, then the Potentiometer will accept as much energy as the power source it is connected to can produce. If the entered value is greater than 0, then the "
	    ...
	    addGuidebook("chapter.fluids.l1",
	    ...
	    addGuidebook("chapter.fluids.l3.1",
	    ...
	    addGuidebook("chapter.fluids.l5.1",
	    ...
	    addGuidebook("chapter.fluids.l5.reinforcedcanister.1",
		    "Most Electrodynamics fluids cannot be carried by a Vanilla bucket. For example, it simply doesn't make sense to transfer Sulfuric Acid in a bucket made out of Iron. If you need to manually move fluids such as Sulfuric Acid, you will need to use a Reinforced "
			    + "Canister.");

	    addGuidebook("chapter.fluids.l5.fluidvalve.1",
	    ...
	    addGuidebook("chapter.fluids.l5.fluidvalve.2",
	    ...
	    addGuidebook("chapter.fluids.l5.fluidpipepump.1",
	    ...
	    addGuidebook("chapter.fluids.l5.fluidpipepump.2",
		    "The active ability requires the pump to be powered, and has the downside of only working with Electrodynamics fluid pipes due to the limitations of the game. When powered and connected to an Electrodynamics pipe network, "
			    + "the pump has the ability to take priority on the transmitted fluids. The priority can be programmed in its GUI:");
	    addGuidebook("chapter.fluids.l5.fluidpipepump.3",
	    ...
	    addGuidebook("chapter.fluids.l5.fluidfilterpipe.1",
	    ...
	    addGuidebook("chapter.fluids.l5.fluidfilterpipe.3",
		    "The Fluid Filter Pipe is capable of filtering up to 4 fluids at a time. You will also note there is a \"Whitelist\" and \"Blacklist\" toggle button. In %1$s, the fluids in the filter list will be blocked from flowing through the pipe. Having no fluids selected "
	    ...
	    addGuidebook("chapter.fluids.l5.fluidvoid.1",
	    ...
	    addGuidebook("chapter.fluids.l5.fluidtank.1",
	    ...
	    addGuidebook("chapter.fluids.l6",
		    "Should you ever find yourself having input fluid into a machine that you didn't mean to, all hope is not lost. You can click on the input fluid gauge(s) with a bucket or reinforced canister, and the fluid will be extracted from the tank and into the fluid container. Note this does not work "
	    ...
	    addGuidebook("chapter.gases.l3",
		    "Gases in Electrodyanmics also have a pressure and temperature. We will first cover the mechanics of pressure. %1$s is measured in units of Atmospheres (ATM). The minimum pressure a gas can have is 1 ATM. A gas's pressure however will only be a whole number. In other words, you will "
	    ...
	    addGuidebook("chapter.gases.l4.1",
	    ...
	    addGuidebook("chapter.gases.l4.2",
		    "Machines on the other hand will have a dedicated GUI data tab displaying the maximum pressure for input and output tanks:");
	    addGuidebook("chapter.gases.l4.3",
		    "It should be noted that gas pipes will display their maximum pressure rating in their noraml tooltip.");
	    addGuidebook("chapter.gases.l5",
		    "Another crucial aspect to keep in mind is that gases will seek equilibrium and equalize pressures when two amounts of the same gas at different pressures are mixed. As pressure is always a whole value, the gas with the lowest pressure will become the ruling pressure, and the higher "
			    + "pressure amount will have its pressure lowered in kind.");

	    addGuidebook("chapter.gases.l6",
		    "Now we will cover the mechanics of %1$s. Temperature is measured in units of Kelvin (K), and the minimum temperature a gas can achieve is 1 degree Kelvin. Like pressure, temperature cannot take a non-whole value, meaning a gas cannot have a temperature of 273.163K. As a gas's temperatrure "
	    ...
	    addGuidebook("chapter.gases.l7.1",
	    ...
	    addGuidebook("chapter.gases.l7.2",
	    ...
	    addGuidebook("chapter.gases.l7.3",
		    "It should be noted that gas pipes do not have a maximum rated temperature as of yet.");
	    addGuidebook("chapter.gases.l8",
		    "Another crucial aspect to keep in mind is that gases will seek equilibrium and equalize temperature when two amounts of the same gas at different temperatures are mixed. As temperature is a non-whole value, the combined gases will take on the average temperature of the two combined "
			    + "gases.");

	    addGuidebook("chapter.gases.l9",
	    ...
	    addGuidebook("chapter.gases.l10.1",
	    ...
	    addGuidebook("chapter.gases.l10.2",
		    "This represents the machine's runoff catch. When a gas condenses in one of these machines, the dropplet will light up indicating a gas has condensed into a fluid and has been caught. To extract this caught gas, simply click on the droplet with a bucket or similar item. It is "
	    ...
	    addGuidebook("chapter.gases.l11",
	    ...
	    addGuidebook("chapter.gases.l12",
		    "As with other ports, these colors are universal to all gas ports. An example of each can be seen on the next page:");

	    addGuidebook("chapter.gases.l13.1",
		    "Like with fluids, gases are transfered between places through the use of pipes. Gas pipes do not store gases, and Electrodynamics machines will only accept gases that they can process with. Pipes have a maximum rated pressure and throughput capacity. If this pressure is exceded, "
	    ...
	    addGuidebook("chapter.gases.l13.2",
	    ...
	    addGuidebook("chapter.gases.l13.3",
		    "Pay attention to this list, as it will save you valuable time and resources!");

	    addGuidebook("chapter.gases.l14",
		    "Up until this point, there has been mention of gases at different temperatures and pressures, but no talk of how those values are actually achieved. Sure, some machines might produce a gas at a certain temperature and pressure, but what if another process calls for it to be "
	    ...
	    addGuidebook("chapter.gases.l18.1",
	    ...
	    addGuidebook("chapter.gases.l18.portablecylinder.1",
	    ...
	    addGuidebook("chapter.gases.l18.gasvalve.1",
	    ...
	    addGuidebook("chapter.gases.l18.gasvalve.2",
	    ...
	    addGuidebook("chapter.gases.l18.gasfilterpipe.1",
	    ...
	    addGuidebook("chapter.gases.l18.gasfilterpipe.3",
		    "The Gas Filter Pipe is capable of filtering up to 4 gases at a time. You will also note there is a \"Whitelist\" and \"Blacklist\" toggle button. In %1$s, the gases in the filter list will be blocked from flowing through the pipe. Having no gases selected "
	    ...
	    addGuidebook("chapter.gases.l18.gasfilterpipe.4",
	    ...
	    addGuidebook("chapter.gases.l18.gasfilterpipe.5",
	    ...
	    addGuidebook("chapter.gases.l18.gasvent.1",
	    ...
	    addGuidebook("chapter.gases.l19",
		    "Should you ever find yourself having input gas into a machine that you didn't mean to, all hope is not lost. You can click on the input gas gauge(s) with a portable gas cylinder, and the gas will be extracted from the tank and into the cylinder. Note this does not work "
	    ...
	    addGuidebook("chapter.generators.l1",
		    "Electrodynamics offers several power sources for you to consider. Each has its pros and cons, so pick and choose the ones that suit you. It should be notes that all fuel-burning generators can be turned off with a redstone signal.");
	    ...
	    addGuidebook("chapter.generators.thermoelectricgeneratoruse",
		    "The heat source is placed at the back of the machine");
	    ...
	    addGuidebook("chapter.machines.inventoryio.1",
		    "Machines in Electrodynamics that process with items have dedicated sides of the machine that will either accept or output said items. Machines that fall into this category will have the following data tab:");
	    addGuidebook("chapter.machines.inventoryio.2",
		    "Hovering over the tab will display the following prompt suggesting that you click the tab:");
	    addGuidebook("chapter.machines.inventoryio.3",
		    "Clicking the tab will cause the machine's GUI to display the slots that are mapped to the different sides of said machine. You can hover over the individual sides as well to see which side is represented:");
	    addGuidebook("chapter.machines.inventoryio.4",
		    "If you are finished, you can either press the data tab again to toggle the display, or exit out of the GUI and re-open it:");
	    addGuidebook("chapter.machines.inventoryio.5",
		    "It should be noted that you are as of now unable to modify which slots are mapped to which sides of the machine.");

	    addGuidebook("chapter.machines.charger.header", "Understanding the Charger:");
	    addGuidebook("chapter.machines.charger.1",
		    "The Charger does what the name suggests and charges items. When charging an item, it's crucial to select a Charger with the correct voltage. If the charger's voltage is less than the item's, the item will only be charged to a percentage of it's full charge. This can be "
			    + "calculated by the formula:");
	    addGuidebook("chapter.machines.chargeformula", "V(charger) / V(item)");

	    addGuidebook("chapter.machines.charger.2",
		    "If the charger's voltage is greater than the item's, it will explode!");
	    addGuidebook("chapter.machines.charger.3",
		    "It is possible to operate a charger with battery power using the 3 battery slots:");

	    addGuidebook("chapter.machines.charger.4",
		    "The charge of the item placed in one of these slots will be transfered to the item in the charging slot. Along with actual batteries, any item with a charge can be used! However, be mindful of the item's voltage. If it is less than the voltage of the charger, it "
	    ...
	    addGuidebook("chapter.quarry.l1",
		    "The Quarry is Electrodynamics' way of providing auto-mining. It takes inspiration from Buildcraft's Quarry and expands upon what it can do. This short walkthrough will provide you the steps on how to set up and operate one yourself.");

	    addGuidebook("chapter.quarry.step", "Step %s:");

	    addGuidebook("chapter.quarry.step1l1",
		    "Set up a ring of 4 Seismic Markers with one Marker at each corner. The ring must be a minimum of 3x3 and has a default maximum size of 66x66. Placing a redstone signal next to a marker will display guide lines.");

	    addGuidebook("chapter.quarry.step2l1",
		    "Place a Seismic Relay down at the outside of one of the corners next to a Seismic Marker. If done correctly, you will hear the sound of an Anvil. The Seismic Markers will also then be collected by the Relay and placed in its inventory.");

	    addGuidebook("chapter.quarry.step3l1",
		    "Place a Quarry on either the left or the right side of the Relay. The Quarry must be facing the same direction as the Relay.");

	    addGuidebook("chapter.quarry.step4l1",
		    "Place a Coolant Resavoir on top of the Quarry. The Quarry needs a constant supply of Water to remain cool. The faster it runs, the more water it will use!");

	    addGuidebook("chapter.quarry.step5l1",
		    "Place a Motor Complex on the side of the Quarry opposite the Seismic Relay. The green port of the Relay must be facing the green port of the Quarry. The Motor Complex controls the speed of the Quarry. It accepts either Basic or Advanced Speed Upgrades, "
	    ...
	    addGuidebook("chapter.quarry.step6l1",
		    "Power the Quarry and the Motor Complex; both use 240V. The Quarry itself uses power to perform tasks such as clearing amd maintaining the mining ring. The upgrades placed in the Quarry also have a direct impact on its power usage. Note that if blocks are in the way when "
	    ...
	    addGuidebook("chapter.quarry.step7l1",
		    "Open the Quarry GUI. In order to begin mining blocks, the Quarry will need a Drill Head. There are multiple types with varying durabilities:");
	    ...
	    addGuidebook("chapter.quarry.step7l2",
		    "Take the Drill Head of your choice and place it in the bottom left slot of the Quarry GUI. Now direct your attention to the 3 upgrade slots in the GUI. The Quarry itself will not passively use power after setup. However, if you add upgrades, it will begin to, and depending on the "
			    + "upgrade, this can be a substantial amount! Your 4 upgrade options are:");

	    addGuidebook("chapter.quarry.step7unbreaking",
		    "The %s reduces the durability used from the Drill Head when a block is mined. A maximum of 3 can be used for an effect of Unbreaking III, and it will cause the Quarry to draw a large amount of power when installed.");
	    addGuidebook("chapter.quarry.step7fortune",
		    "The %s applies the Fortune enchantment to the blocks mined by the Quarry. A maximum of 3 can be used for an effect of Fortune III and it cannot be used in tandem with the Silk Touch Upgrade. The upgrade draws a large amount of power.");
	    addGuidebook("chapter.quarry.step7silktouch",
		    "The %s will apply the Silk Touch enchantment to the blocks mined by the Quarry. A maximum of 1 can be used and it cannot be used in tandem with the Fortune Upgrade. The upgrade will cause the Quarry to draw a huge amount of power.");
	    addGuidebook("chapter.quarry.step7void",
		    "The %s will activate 6 otherwise hidden slots in the GUI. Any items placed in these slots will be voided by the Quarry when mined. The upgrade will cause the Quarry to start drawing its base usage.");

	    addGuidebook("chapter.quarry.step8l1",
		    "This step is optional, but highly recommended. Place a Logistical Manager in front of the Quarry, then place a chest on any remaining side of the Manager. The Logistical Manager will automatically transfer items from the Quarry's inventory into an attached chest. "
	    ...
	    addGuidebook("chapter.upgrades.l1",
		    "The Auto-Injector Upgrade gives machines the ability to intake items from surrounding inventories. The upgrade has two modes: Default and Smart. ");
	    addGuidebook("chapter.upgrades.default", "Default");
	    addGuidebook("chapter.upgrades.l2",
		    " mode will attempt to fill every input slot in order of the directions on the card. ");
	    addGuidebook("chapter.upgrades.smart", "Smart");
	    addGuidebook("chapter.upgrades.l3",
		    " mode will map each input slot to each direction on the card. If there are more slots than directions, the remaining slots will be mapped to the final direction. To add a direction, Shift + Right-Click the card while facing the desired direction. To clear all "
			    + "directions, Shift + Left-Click. To toggle Smart mode, Right-Click the card.");

	    addGuidebook("chapter.upgrades.ejectorheader", "Using the Ejector Upgrade:");

	    addGuidebook("chapter.upgrades.l4",
		    "The Auto-Ejector Upgrade gives machines the ability to output items to surrounding inventories. The upgrade has two modes: Default and Smart. ");
	    addGuidebook("chapter.upgrades.l5",
		    " mode will attempt to output every slot in order of the directions on the card. ");
	    addGuidebook("chapter.upgrades.l6",
		    " mode will map each output slot to each direction on the card. If there are more slots than directions, the remaining slots will be mapped to the final direction. To add a direction, Shift + Right-Click the card while facing the desired direction. To clear all "
			    + "directions, Shift + Left-Click. To toggle Smart mode, Right-Click the card.");
	    addGuidebook("chapter.upgrades.l7",
		    "It is important to note that indexes for Electrodynamics output slots come before biproduct slots in the inventory. For example, if there are 3 output slots and 2 biproduct slots, the card would empty all 3 output slots before it empties the 2 biproduct slots.");
	    ...
	    addGuidebook("chapter.tools.kineticl1",
		    "To use the Kinetic Railgun, hold the gun in one hand and the ammo type of your choice in the other. The Kinetic Railgun generates %1$s Joules of heat per shot. This can be mitigated by filling it with Liquid Ammonia. The Railgun will attempt to use %2$s mB per shot, and can store up to %3$s mB. If the gun runs out of coolant to use, it will still work!");
	    ...
	    addGuidebook("chapter.tools.plasmal1",
		    "The Plasma Railgun generates %1$s Joules of heat per shot. This can be mitigated by filling it with Liquid Ammonia. The Railgun will attempt to use %2$s mB per shot, and can store up to %3$s mB. If the gun runs out of coolant to use, it will still work!");

	    addGuidebook("chapter.tools.seismicl1",
		    "The Seismic Scanner is a very useful item. It is able to scan for a selected block within a 16 block radius from the player. To use the Scanner, Right-Click to access it's GUI and insert the desired block into the scanning slot. Next, Shift + Right-Click to start a "
	    ...
	    addGuidebook("chapter.tools.electricdrilll1",
		    "The Electric Drill is a useful mining tool indeed. Not only does it remove the need to constantly craft pickaxes, but it can also be upgraded to suit your needs. Firstly, the drill can have it's current head swapped out with another drill head. Steel is the default head. "
			    + "The following heads provide the following speed boosts:");
	    addGuidebook("chapter.tools.electricdrilll2",
		    "It should be noted this speed boost is passive and does not impact power consumption. To swap out a drill head, hover over the drill in your inventory with the drill head of choice, and Left-Click the drill. The new head will be installed, and you will be left holding "
			    + "the previous drill head.");
	    addGuidebook("chapter.tools.electricdrilll3",
		    "The drill also accepts various upgrades like a machine. Right-Click to open the drill's upgrade GUI to install upgrades. It should be noted that upgrades will increase power usage, so be wise with your usage of them!");

	    addGuidebook("chapter.armor", "Armor");

	    addGuidebook("chapter.armor.jetpack",
		    "The Jetpack uses Hydrogen Gas at 1ATM as fuel. It can be filled in either a Gas Cylinder or directly in the Electrolyzer. The Jetpack has 4 modes: Regular, Hover, Elytra, and Off. Elytra mode allows you to glide as if you had an Elytra on, and gives you the ability to slowly "
	    ...
	    addGuidebook("chapter.armor.hydraulicboots",
		    "Hydraulic Boots use Hydraulic Fluid as their \"fuel\". They can be filled either in a tank or directly in a Chemical Mixer. Hydraulic Boots will heavily reduce fall damage, but not completely eliminate it.");
	    addGuidebook("chapter.armor.combathelmet",
		    "The Combat Helmet has an internal air tank that can be filled with Oxygen gas. This will allow you to breathe under water for a time.");
	    addGuidebook("chapter.armor.combatchestplate",
		    "The Jetpack uses Hydrogen Gas at 1ATM as fuel. It can be filled in either a Gas Cylinder or directly in the Electrolyzer. The Jetpack has 4 modes: Regular, Hover, Elytra, and Off. Elytra mode allows you to glide as if you had an Elytra on, and gives you the ability to "
	    ...
	    addGuidebook("chapter.armor.combatleggings",
		    "The Combat Leggings have an internal air tank that can be filled with Argon gas. If wearing a full suit, this will allow you to avoid taking fire damage at the cost of Argon gas.");
	    addGuidebook("chapter.armor.combatboots",
		    "Combat Boots use Hydraulic Fluid as their \"fuel\". They can be filled either in a tank or directly in a Chemical Mixer. Combat Boots will heavily reduce fall damage, but not completely eliminate it.");

	    addGuidebook("chapter.armor.ceramicheader", "Ceramic Plate Protection:");
	    addGuidebook("chapter.armor.ceramicl1",
		    "Composite and Combat armor have a unique ability: Ceramic Protection. To use this ability, you must first add Ceramic Plates to the chestplate. This is accomplished by Right-Clicking a Ceramic Plate while wearing one of the two chestplates. If sucessfull, you will hear "
			    + "the sound of a velcro strap. A maximum of two plates can be be held by both chestplates.");

	    addGuidebook("chapter.armor.ceramicl2",
		    "For the ability to trigger, you must be wearing a full set of the armor type, and it must be a complete set. You must then take more than 16 damage. If these conditions are met, you will hear the plate break and a Ceramic Plate will be removed "
			    + "from the chestplate. The damage dealt will then be reduced to its square root.");

	    addGuidebook("chapter.misc", "Misc");
	    addGuidebook("chapter.misc.l1",
		    "Electrodynamics pipes and wires can be camouflaged to look like other blocks. This can be especially usefully if you have to run a wire through a wall but don't want to have an awkward hole in it. To hide the cable in question, you will first need to enhance it's structure. This can be accomplished "
			    + "by right-clicking the cable with Scaffolding (not the vanilla kind):");

	    addGuidebook("chapter.misc.l2",
		    "Once the Scaffolding has been applied, you can then place the block of your choice. Note that placing the Scaffolding and camouflage block will consume it, but you will also get it back when you break the cable:");

	    addGuidebook("chapter.misc.l3",
		    "You can also easily swap the disguising block by simply right-clicking again with a different block:");

	    addGuidebook("chapter.misc.l4",
		    "Note that while the cable might glow like the light source it is disguised as, it very much is still a cable. This is particularly important in the case of Wires, which not only can still shock you while hidden, but can also be upgraded still:");

	    addGuidebook("chapter.misc.l5",
		    "As mentioned earlier, the cable will drop the scaffolding and disguising block when broken with a pickaxe. However, there are a couple other methods to do this. You can remove the disguising block by right-clicking the cable with a wrench:");

	    addGuidebook("chapter.misc.l6",
		    "This will leave the scaffolding in place. To remove the Scaffolding with the wrench as well, right-click again:");

	    addGuidebook("chapter.tips", "Tips");
	    addGuidebook("chapter.tips.tip", "Tip %s:");
	    addGuidebook("chapter.tips.tip1",
		    "Use Energy Storage frequently. Electrodynamics has several tiers of energy storage. You should invest in using them in all stages of progression. Note, the Capacity Upgrade not only increases the capacity of a Battery Box, but also the output voltage!");

	    addGuidebook("chapter.tips.tip2",
		    "Transmit at High Voltage. This is mentioned in the Electricity chapter, but you should transmit large amounts of power at high voltage and then step it down for distribution. This will help reduce the need for heavy-duty cables as well as the "
	    ...
	    addGuidebook("chapter.electrolosischamber.l1",
	    ...
	    addGuidebook("chapter.electrolosischamber.l2",
	    ...
	    addGuidebook("chapter.electrolosischamber.l3",
		    "The Impure Mineral Fluid is what is actually processed by the Electrolosis Chamber. The machine itself is a 5 x 5 x 3 multiblock. To build it, you will need %1$s, %2$s, %3$s, %4$s, %5$s, and the %6$s itself. Below is how to assemble the multiblock:");
	    addGuidebook("chapter.electrolosischamber.count", "%1$s %2$s");
	    addGuidebook("chapter.electrolosischamber.step", "Step %s:");
	    addGuidebook("chapter.electrolosischamber.seperatororient",
		    "Note the orientation of the Electrolytic Seperator doesn't matter");
	    ...
	    addGuidebook("chapter.electrolosischamber.l6",
	    ...
	    addGuidebook("chapter.electrolosischamber.l7",
	    ...
	    addGuidebook("chapter.electrolosischamber.l8",
	    ...
	    addConfiguration("transformer_efficiency", "Transformer Efficiency");
	    addConfiguration("circuitbreaker_efficiency", "Circuitbreaker Efficiency");
	    addConfiguration("relay_efficiency", "Relay Efficiency");
	    addConfiguration("currentregulator_efficiency", "Current Regulator Efficiency");
	    addConfiguration("coalgenerator_amperage", "Coal Generator Amperage");
	    addConfiguration("thermoelectricgenerator_amperage", "Thermoelectric Generator Amperage");
	    addConfiguration("hydroelectricgenerator_amperage", "Hydroelectric Generator Amperage");
	    addConfiguration("windmill_max_amperage", "Windmill Max AMperage");
	    addConfiguration("solarpanel_amperage", "Solar Panel Amperage");
	    addConfiguration("electricpump_usage", "Electric Pump Usage");
	    addConfiguration("adv_solarpanel_amperage", "Advanced Solar Panel Amperage");
	    addConfiguration("electricfurnace_usage", "Electric Furnace Usage");
	    addConfiguration("electricfurnace_ticks", "Electric Furnace Ticks");
	    addConfiguration("electricarcfurnace_usage", "Electric Arc Furnace Usage");
	    addConfiguration("electricarcfurnace_ticks", "Electric Arc Furnace Ticks");
	    addConfiguration("wiremill_usage", "Wiremill Usage");
	    addConfiguration("rotaryunifier_usage", "Rotary Unifier Usage");
	    addConfiguration("rotaryunifier_conversion", "Rotary Unifier Conversion");
	    addConfiguration("wiremill_ticks", "Wiremill Ticks");
	    addConfiguration("combustionchamber_usage", "Combustion Chamber Usage");
	    addConfiguration("charger_usage", "Charger Usage");
	    addConfiguration("gascollector_usage", "Gas Collector Usage");
	    addConfiguration("compressor_usage", "Compressor Usage");
	    addConfiguration("compressor_conversion", "Compressor Conversion Rate");
	    addConfiguration("decompressor_usage", "Decmpressor Usage");
	    addConfiguration("decompressor_conversion", "Decompressor Conversion Rate");
	    addConfiguration("adv_compressor_usage", "Advanced Compressor Usage");
	    addConfiguration("adv_compressor_conversion", "Advanced Compressor Conversion Rate");
	    addConfiguration("adv_decompressor_usage", "Advanced Decompressor Usage");
	    addConfiguration("adv_decompressor_conversion", "Advanced Decompressor Conversion Rate");
	    addConfiguration("thermomanipulator_usage", "Thermoelectric Manipulator Usage");
	    addConfiguration("thermomanipulator_heat_transfer", "Thermoelectric Manipulator Heat Transfer");
	    addConfiguration("thermomanipulator_conversion", "Thermoelectric Manipulator Conversion Rate");
	    addConfiguration("adv_thermomanipulator_usage", "Advanced Thermoelectric Manipulator Usage");
	    addConfiguration("adv_thermomanipulator_heat_transfer",
		    "Advanced Thermoelectric Manipulator Conversion Rate");
	    addConfiguration("adv_thermomanipulator_conversion", "Advanced Thermoelectric Manipulator Usage");
	    addConfiguration("gastransformer_input_pressure_cap", "Gas Transformer Input Pressure Cap");
	    addConfiguration("gastransformer_input_temp_cap", "Gas Transformer Input Temperature Cap");
	    addConfiguration("gastransformer_base_input_capacity", "Gas Transformer Base Input Capacity");
	    addConfiguration("gastransformer_output_pressure_cap", "Gas Transformer Output Pressure Cap");
	    addConfiguration("gastransformer_output_temp_cap", "Gas Transformer Output Temperature Cap");
	    addConfiguration("gastransformer_base_output_capacity", "Gas Transformer Base Output Capacity");
	    addConfiguration("gastransformer_addon_tank_capacity", "Gas Transformer Addon Tank Capacity");
	    addConfiguration("gastransformer_addon_tank_limit", "Gas Transformer Addon Tank Limit");
	    addConfiguration("motorcomplex_usage", "Motor Complex Usage");
	    addConfiguration("pipepump_usage", "Pipe Pump Usage");
	    addConfiguration("electrolosischamber_target", "Electrolosis Chamber Target");
	    addConfiguration("should_transformer_hum", "Should transformer Hum");
	    addConfiguration("transformer_sound_load_target", "Transformer Sound Load Target");
	    addConfiguration("conductors_burn_surroundings", "Do conductors burn their surrounding?");
	    addConfiguration("block_vaporisation_hardness", "Block Vaporisation Hardness");
	    addConfiguration("render_combat_armor_status", "Render Combat Armor Status");
	    addConfiguration("quarry", "Quarry");
	    addConfiguration("quarry_usage", "Quarry Usage");
	    addConfiguration("quarry_waterusage", "Quarry Water Usage");
	    addConfiguration("marker_radius", "Marker Radius");
	    addConfiguration("min_ticks_per_quarryblock", "Min Ticks Per Quarryblock");
	    addConfiguration("max_ticks_per_quarryblock", "Max Ticks Per Quarryblock");
	    addConfiguration("clearing_air_skip", "Air Blocks Skipped When Clearing");
	    addConfiguration("maintain_mining_area", "Maintain Mining Area");
	    addConfiguration("bypass_claims", "Bypass Claims");
	    addConfiguration("ores", "Ores");
	    addConfiguration("disable_all_ores", "Disable All Ores");
	    addConfiguration("disable_stone_ores", "Disable Stone Ores");
	    addConfiguration("spawn_aluminum_ore", "Spawn Aluminum Ore");
	    addConfiguration("spawn_chromium_ore", "Spawn Chromium Ore");
	    addConfiguration("spawn_fluorite_ore", "Spawn Fluorite Ore");
	    addConfiguration("spawn_lead_ore", "Spawn Lead Ore");
	    addConfiguration("spawn_lithium_ore", "Spawn Lithium Ore");
	    addConfiguration("spawn_molybdenum_ore", "Spawn Molybdenum Ore");
	    addConfiguration("spawn_monazite_ore", "Spawn Monazite Ore");
	    addConfiguration("spawn_niter_ore", "Spawn Niter Ore");
	    addConfiguration("spawn_salt_ore", "Spawn Salt Ore");
	    addConfiguration("spawn_silver_ore", "Spawn Silver Ore");
	    addConfiguration("spawn_sulfur_ore", "Spawn Sulfur Ore");
	    addConfiguration("spawn_sylvite_ore", "Spawn Sylvite Ore");
	    addConfiguration("spawn_tin_ore", "Spawn Tin Ore");
	    addConfiguration("spawn_titanium_ore", "Spawn Titanium Ore");
	    addConfiguration("spawn_thorium_ore", "Spawn Thorium Ore");
	    addConfiguration("spawn_uranium_ore", "Spawn Uranium Ore");
	    addConfiguration("spawn_vanadium_ore", "Spawn Vanadium Ore");
	    addConfiguration("disable_deepslate_ores", "Disable Deepslate Ores");
	    addConfiguration("spawn_deep_aluminum_ore", "Spawn Aluminum Ore");
	    addConfiguration("spawn_deep_chromium_ore", "Spawn Chromium Ore");
	    addConfiguration("spawn_deep_fluorite_ore", "Spawn Fluorite Ore");
	    addConfiguration("spawn_deep_lead_ore", "Spawn Lead Ore");
	    addConfiguration("spawn_deep_lithium_ore", "Spawn Lithium Ore");
	    addConfiguration("spawn_deep_molybdenum_ore", "Spawn Molybdenum Ore");
	    addConfiguration("spawn_deep_monazite_ore", "Spawn Monazite Ore");
	    addConfiguration("spawn_deep_niter_ore", "Spawn Niter Ore");
	    addConfiguration("spawn_deep_salt_ore", "Spawn Salt Ore");
	    addConfiguration("spawn_deep_silver_ore", "Spawn Silver Ore");
	    addConfiguration("spawn_deep_sulfur_ore", "Spawn Sulfur Ore");
	    addConfiguration("spawn_deep_sylvite_ore", "Spawn Sylvite Ore");
	    addConfiguration("spawn_deep_tin_ore", "Spawn Tin Ore");
	    addConfiguration("spawn_deep_titanium_ore", "Spawn Titanium Ore");
	    addConfiguration("spawn_deep_thorium_ore", "Spawn Thorium Ore");
	    addConfiguration("spawn_deep_uranium_ore", "Spawn Uranium Ore");
	    addConfiguration("spawn_deep_vanadium_ore", "Spawn Vanadium Ore");
	    addConfiguration("ore_generation_multiplier", "Ore Generation Multiplier");
	}
