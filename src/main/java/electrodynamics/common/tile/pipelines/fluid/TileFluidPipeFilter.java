...
public class TileFluidPipeFilter extends GenericTile {
	...
	public TileFluidPipeFilter() {
		super(ElectrodynamicsTiles.TILE_FLUIDPIPEFILTER.get());
	...
	public <T> LazyOptional<T> getCapability(@Nonnull Capability<T> cap, Direction side) {
        ...
        if (side == BlockEntityUtils.getRelativeSide(facing, INPUT_DIR.mappedDir)) {
            ...
            TileEntity output = level.getBlockEntity(getBlockPos().relative(side.getOpposite()));
            ...
            return fluid == CapabilityUtils.EMPTY_FLUID ? LazyOptional.of(() -> CapabilityUtils.EMPTY_FLUID).cast() : LazyOptional.of(() -> new FilteredFluidCap(fluid, getFilteredFluids(), isWhitelist.getValue())).cast();
