...
public class TileFluidVoid extends GenericMaterialTile {
	...
	public TileFluidVoid(BlockPos worldPos, BlockState blockState) {
		...
		addComponent(new ComponentInventory(this, ComponentInventory.InventoryBuilder.newInv().bucketInputs(1)).valid((slot, stack, i) -> stack.getCapability(ForgeCapabilities.FLUID_HANDLER_ITEM).orElse(CapabilityUtils.EMPTY_FLUID_ITEM) != CapabilityUtils.EMPTY_FLUID_ITEM));
