...
public class TileCircuitMonitor extends GenericTile {
	...
	public TileCircuitMonitor(BlockPos worldPos, BlockState blockState) {
		...
		addComponent(new ComponentElectrodynamic(this).voltage(-1).receivePower((transfer, debug) -> TransferPack.EMPTY).getConnectedLoad((profile, dir) -> TransferPack.EMPTY).relativeInput(Direction.SOUTH));
