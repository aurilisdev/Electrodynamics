...
public class TileCombustionChamber extends GenericMaterialTile implements IElectricGenerator, ITickableSound {
	...
	addComponent(new ComponentInventory(this, ComponentInventory.InventoryBuilder.newInv().bucketInputs(1))
		.valid((slot, stack, i) -> stack.getCapability(ForgeCapabilities.FLUID_HANDLER_ITEM) != null));
	...
	return TransferPack.joulesVoltage(
		ElectroConstants.COMBUSTIONCHAMBER_JOULES_PER_TICK * fuelMultiplier * multiplier.getValue(),
		electro.getVoltage());
    }
