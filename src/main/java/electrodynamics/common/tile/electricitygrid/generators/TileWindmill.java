...
public class TileWindmill extends GenericGeneratorTile implements IMultiblockParentTile, ITickableSound {
	...
	public TileWindmill() {
		super(ElectrodynamicsTiles.TILE_WINDMILL.get(), 2.25, SubtypeItemUpgrade.stator);
	...
	protected void tickServer(ComponentTickable tickable) {
		...
		if (tickable.getTicks() % 40 == 0) {
			...
			generating.setValue(ElectroConstants.WINDMILL_MAX_AMPERAGE * MathHelper.clamp(f, 0, 1));
		}
		if (output == null) {
