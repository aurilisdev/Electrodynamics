...
public class TileFluidVoid extends GenericMaterialTile {
	...
	public TileFluidVoid(BlockPos worldPos, BlockState blockState) {
		...
		addComponent(new ComponentContainerProvider(SubtypeMachine.fluidvoid, this).createMenu((id, player) -> new ContainerFluidVoid(id, player, getComponent(ComponentType.Inventory), getCoordsArray())));
	}
