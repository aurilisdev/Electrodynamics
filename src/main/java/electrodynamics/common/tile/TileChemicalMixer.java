...
public class TileChemicalMixer extends GenericTileTicking {
    ...
    /**
     * Currently, there is no way to tell if the fluid is part of the input tank
     * or the output tank, so for now you cannot have fluids that are outputs
     * as inputs as well and vis a versa
     * 
