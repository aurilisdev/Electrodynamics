...
public class TileOxidationFurnace extends GenericTile implements ITickableSoundTile {
	...
	public TileOxidationFurnace(BlockPos worldPosition, BlockState blockState) {
		...
		addComponent(new ComponentProcessor(this).setProcessorNumber(0).canProcess(this::canProcessOxideFurn).process(component -> component.processItem2ItemRecipe(component)));
	}
