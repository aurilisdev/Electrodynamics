...
public class TileLithiumBatteryBox extends GenericTileTicking implements IEnergyStorage {
    public static final double DEFAULT_OUTPUT_JOULES_PER_TICK = 359.0 * (2 * CapabilityElectrodynamic.DEFAULT_VOLTAGE) / 20.0;
    public static final double DEFAULT_MAX_JOULES = 40000000;
    public double clientMaxJoulesStored = DEFAULT_MAX_JOULES;
    public double currentCapacityMultiplier = 1;
    public double clientVoltage = 240.0;
	...
	super(DeferredRegisters.TILE_LITHIUMBATTERYBOX.get());
	...
	addComponent(new ComponentContainerProvider("container.lithiumbatterybox")
