...
public class TileCarbyneBatteryBox extends TileBatteryBox {
	...
	public TileCarbyneBatteryBox(BlockPos worldPosition, BlockState blockState) {
		super(ElectrodynamicsBlockTypes.TILE_CARBYNEBATTERYBOX.get(), SubtypeMachine.carbynebatterybox, 359.0 * (4 * ElectrodynamicsCapabilities.DEFAULT_VOLTAGE) / 20.0, 80000000, worldPosition, blockState);
	...
	protected void tickServer(ComponentTickable tickable) {
		...
		electro.voltage(480.0 * currentVoltageMultiplier.get());
