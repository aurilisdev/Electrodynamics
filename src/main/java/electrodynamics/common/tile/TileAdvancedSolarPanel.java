...
public class TileAdvancedSolarPanel extends GenericTileBase implements ITickableTileBase, IElectrodynamic, IMultiblockTileNode {
	...
	public TransferPack getOutput() {
		...
		return TransferPack.ampsVoltage(Constants.ADVANCEDSOLARPANEL_AMPERAGE * (1 + humidityEff + tempEff) * getSunBrightness() * (world.isRaining() || world.isThundering() ? 0.7f : 1), getVoltage());
	}
