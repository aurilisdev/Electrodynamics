...
public class TileCreativePowerSource extends GenericTile {
	...
	public TileCreativePowerSource(BlockPos worldPos, BlockState blockState) {
		...
		addComponent(new ComponentElectrodynamic(this).output(Direction.DOWN).output(Direction.UP).output(Direction.NORTH)
			.output(Direction.SOUTH).output(Direction.EAST).output(Direction.WEST));
