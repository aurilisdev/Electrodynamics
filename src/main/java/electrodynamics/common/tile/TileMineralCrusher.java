    ...
    public TileMineralCrusher(int extra) {
		...
		if (extra == 0) {
			...
			ComponentProcessor pr = new ComponentProcessor(this).upgradeSlots(2, 3, 4)
				.canProcess(component -> component.canProcessO2ORecipe(component, MineralCrusherRecipe.class, ElectrodynamicsRecipeInit.MINERAL_CRUSHER_TYPE))
				.process(component -> component.processO2ORecipe(component, MineralCrusherRecipe.class))
				.requiredTicks(Constants.MINERALCRUSHER_REQUIRED_TICKS)
