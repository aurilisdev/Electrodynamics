...
public class TileEnergizedAlloyer extends GenericTile implements ITickableSound {
	...
	public TileEnergizedAlloyer() {
		super(ElectrodynamicsTiles.TILE_ENERGIZEDALLOYER.get());
	...
	protected boolean canProcessEnergAlloy(ComponentProcessor component, int procNumber) {
		boolean canProcess = component.canProcessItem2ItemRecipe(procNumber, ElectrodynamicsRecipies.ENERGIZED_ALLOYER_TYPE);
