...
public class FluidRoyalMineral extends FluidNonPlaceable {
    ...
    public FluidRoyalMineral(SubtypeRoyalMineralFluid subtype) {
        super(ElectrodynamicsItems.ITEM_CANISTERREINFORCED, new SimpleWaterBasedFluidType(Electrodynamics.ID, "fluidroyalmineral" + subtype.name(), "royal/royalmineralfluid", subtype.color));
