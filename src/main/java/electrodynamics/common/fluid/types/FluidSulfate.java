...
public class FluidSulfate extends FluidNonPlaceable {
    ...
    public FluidSulfate(SubtypeSulfateFluid subtype) {
        super(ElectrodynamicsItems.ITEM_CANISTERREINFORCED, new SimpleWaterBasedFluidType(Electrodynamics.ID, "fluidsulfate" + subtype.name(), "sulfate/" + subtype.name(), subtype.color));
