...
public class FluidHydrogenFluoride extends Fluid {
	...
	return FluidAttributes
		.builder(new ResourceLocation(References.ID + ":fluid/hydrogenfluoride"), new ResourceLocation(References.ID + ":fluid/hydrogenfluoride"))
		.translationKey("fluid.electrodynamics.hydrogenfluoride").color(-375879936).build(this);
    }
