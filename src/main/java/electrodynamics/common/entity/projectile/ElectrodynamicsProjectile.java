...
public abstract class ElectrodynamicsProjectile extends ProjectileItemEntity{
	...
	public ElectrodynamicsProjectile(EntityType<? extends ProjectileItemEntity> type, World world, Item item,
	...
	public ElectrodynamicsProjectile(EntityType<? extends ProjectileItemEntity> type, double x, double y, double z, 
