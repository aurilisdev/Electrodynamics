...
public class EntityMetalRod extends EntityCustomProjectile {
	...
	if (!state.isAir()) {
		...
		level().playSound(null, hit.getBlockPos(), ElectrodynamicsSounds.SOUND_RODIMPACTINGGROUND.get(),
	...
	case 1:
	    ...
	    break;
	case 2:
	    entity.hurt(entity.damageSources().source(ElectrodynamicsDamageTypes.ACCELERATED_BOLT_IGNOREARMOR, this,
		    entity), 4f);
	    break;
	default:
	}
