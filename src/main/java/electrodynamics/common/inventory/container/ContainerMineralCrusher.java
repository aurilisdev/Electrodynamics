...
public class ContainerMineralCrusher extends GenericContainerInventory {

	public ContainerMineralCrusher(int id, PlayerInventory playerinv) {
		this(id, playerinv, new Inventory(5));
	}

	public ContainerMineralCrusher(int id, PlayerInventory playerinv, IInventory inventory) {
		this(id, playerinv, inventory, new IntArray(1));
	}

	public ContainerMineralCrusher(int id, PlayerInventory playerinv, IInventory inventory, IIntArray inventorydata) {
		super(DeferredRegisters.CONTAINER_MINERALCRUSHER.get(), id, playerinv, inventory, inventorydata);
	}
	...
	public int getBurnLeftScaled() {
		return inventorydata.get(0) * 24 / TileMineralCrusher.REQUIRED_TICKS;
	}
