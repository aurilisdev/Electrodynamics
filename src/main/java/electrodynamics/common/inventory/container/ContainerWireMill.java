...
public class ContainerWireMill extends GenericContainerInventory {

	public ContainerWireMill(int id, PlayerInventory playerinv) {
		this(id, playerinv, new Inventory(5));
	}

	public ContainerWireMill(int id, PlayerInventory playerinv, IInventory inventory) {
		this(id, playerinv, inventory, new IntArray(1));
	}

	public ContainerWireMill(int id, PlayerInventory playerinv, IInventory inventory, IIntArray inventorydata) {
		super(DeferredRegisters.CONTAINER_WIREMILL.get(), id, playerinv, inventory, inventorydata);
	}
	...
	public int getBurnLeftScaled() {
		return inventorydata.get(0) * 24 / TileWireMill.REQUIRED_TICKS;
	}
