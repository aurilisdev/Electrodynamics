...
public class ContainerDoubleElectricFurnace extends GenericContainer<TileElectricFurnace> {

    public ContainerDoubleElectricFurnace(int id, PlayerInventory playerinv) {
	this(id, playerinv, new Inventory(5));
    }

    public ContainerDoubleElectricFurnace(int id, PlayerInventory playerinv, IInventory inventory) {
	this(id, playerinv, inventory, new IntArray(3));
    }

    public ContainerDoubleElectricFurnace(int id, PlayerInventory playerinv, IInventory inventory, IIntArray inventorydata) {
