...
public class ContainerAdvancedDowngradeTransformer
	extends GenericContainerBlockEntity<TileAdvancedDowngradeTransformer> {

    public ContainerAdvancedDowngradeTransformer(int id, Inventory playerinv, ContainerData inventorydata) {
	super(ElectrodynamicsMenuTypes.CONTAINER_ADVANCEDDOWNGRADETRANSFORMER.get(), id, playerinv, EMPTY,
		inventorydata);
    }
