...
public class ContainerElectricArcFurnaceTriple extends GenericContainerBlockEntity<TileElectricArcFurnaceTriple> {
	...
	public ContainerElectricArcFurnaceTriple(int id, PlayerInventory playerinv) {
		this(id, playerinv, new Inventory(9), new IntArray(3));
	}

	public ContainerElectricArcFurnaceTriple(int id, PlayerInventory playerinv, IInventory inventory, IIntArray inventorydata) {
