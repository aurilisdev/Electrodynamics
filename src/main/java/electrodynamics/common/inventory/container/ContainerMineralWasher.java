...
public class ContainerMineralWasher extends GenericContainer<TileMineralWasher> {
    ...
    public ContainerMineralWasher(ContainerType<?> type, int id, PlayerInventory playerinv, IInventory inventory, IIntArray inventorydata) {
	...
	addSlot(new GenericSlot(inv, nextIndex(), 82, 51));
