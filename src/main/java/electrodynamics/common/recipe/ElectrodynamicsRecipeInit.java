...
public class ElectrodynamicsRecipeInit {
	...
	public static DeferredRegister<IRecipeSerializer<?>> RECIPE_SERIALIZER = 
			DeferredRegister.create(ForgeRegistries.RECIPE_SERIALIZERS,electrodynamics.api.References.ID);
	...
	public static final RegistryObject<IRecipeSerializer<?>> WIRE_MILL_SERIALIZER =
			RECIPE_SERIALIZER.register(WireMillRecipe.RECIPE_GROUP,() -> O2ORecipeTypes.WIRE_MILL_JSON_SERIALIZER);
	public static final RegistryObject<IRecipeSerializer<?>> MINERAL_GRINDER_SERIALIZER =
			RECIPE_SERIALIZER.register(MineralGrinderRecipe.RECIPE_GROUP,() -> O2ORecipeTypes.MINERAL_CRUSHER_JSON_SERIALIZER);
	public static final RegistryObject<IRecipeSerializer<?>> MINERAL_CRUSHER_SERIALIZER =
			RECIPE_SERIALIZER.register(MineralCrusherRecipe.RECIPE_GROUP,() -> O2ORecipeTypes.MINERAL_GRINDER_JSON_SERIALIZER);
	
	//DO2O
	public static final RegistryObject<IRecipeSerializer<?>> OXIDATION_FURNACE_SERIALIZER =
			RECIPE_SERIALIZER.register(OxidationFurnaceRecipe.RECIPE_GROUP,() -> DO2ORecipeTypes.OXIDATION_FURNACE_JSON_SERIALIZER);
	
	//FluidItem2Fluid
	public static final RegistryObject<IRecipeSerializer<?>> CHEMICAL_MIXER_SERIALIZER =
			RECIPE_SERIALIZER.register(ChemicalMixerRecipe.RECIPE_GROUP,() -> FluidItem2FluidRecipeTypes.CHEMICAL_MIXER_JSON_SERIALIZER);
	public static final RegistryObject<IRecipeSerializer<?>> FERMENTATION_PLANT_SERIALIZER = 
			RECIPE_SERIALIZER.register(FermentationPlantRecipe.RECIPE_GROUP,() -> FluidItem2FluidRecipeTypes.FERMENTATION_PLANT_JSON_SERIALIZER);
