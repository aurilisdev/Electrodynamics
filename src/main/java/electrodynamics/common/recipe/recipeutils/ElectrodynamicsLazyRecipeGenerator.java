...
public class ElectrodynamicsLazyRecipeGenerator {
	...
	/**
	 * Ingots -> Plates Ores -> Impure Dust Crystals -> Impure Dust Obsidian ->
	 * Obsidian Dust Gravel -> Flint
	 */
	...
	/**
	 * Ingots -> Dust Ores -> Dust Impure Dust -> Dust Vanilla Gem Ores -> Gems
	 * Stone -> Cobblestone Cobblestone -> Gravel Gravel -> Sand
	 */
	...
	/**
	 * Sulfur + Coal/Charcoal -> Sufur Dioxide Vanadium Dust + Coal/Charcoal ->
	 * Vanadium Dioxide Vanadium Dioxide + Sulfur Dioxide -> Sulfur Trioxide
	 */
	...
	/**
	 * Any Seeds + Water -> Ethanol Carrots + Water -> Ethanol Any Mushroom + Water
	 * -> Ethanol Potatos + Water -> Ethanol Wheat + Water -> Ethanol Pumpkin(Block)
	 * + Water -> Ethanol Melon Slice + Water -> Ethanol Sugar Cane + Water ->
	 * Ethanol
	 */
