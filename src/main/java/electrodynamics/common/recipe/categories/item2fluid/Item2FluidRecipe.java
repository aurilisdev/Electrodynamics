...
public abstract class Item2FluidRecipe extends AbstractFluidRecipe {
    ...
    public Item2FluidRecipe(ResourceLocation recipeID, CountableIngredient[] itemInputs, FluidStack fluidOutput) {
		super(recipeID);
		ITEM_INPUTS = itemInputs;
		FLUID_OUTPUT = fluidOutput;
    }
    
	public Item2FluidRecipe(ResourceLocation recipeID, CountableIngredient[] inputs, FluidStack fluidOutput,
	...
	public Item2FluidRecipe(CountableIngredient[] inputs, FluidStack fluidOutput, ProbableFluid[] fluidBiproducts,
