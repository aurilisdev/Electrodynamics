...
public class Item2ItemRecipeTypes {
    ...
    public static final RecipeSerializer<MineralGrinderRecipe> MINERAL_CRUSHER_JSON_SERIALIZER = new Item2ItemRecipeSerializer<>(
	    MineralGrinderRecipe.class);
    public static final RecipeSerializer<MineralCrusherRecipe> MINERAL_GRINDER_JSON_SERIALIZER = new Item2ItemRecipeSerializer<>(
    ...
    public static final RecipeSerializer<OxidationFurnaceRecipe> OXIDATION_FURNACE_JSON_SERIALIZER = new Item2ItemRecipeSerializer<>(
	    OxidationFurnaceRecipe.class);
    public static final RecipeSerializer<EnergizedAlloyerRecipe> ENERGIZED_ALLOYER_JSON_SERIALIZER = new Item2ItemRecipeSerializer<>(
	    EnergizedAlloyerRecipe.class);
    public static final RecipeSerializer<ReinforcedAlloyerRecipe> REINFORCED_ALLOYER_JSON_SERIALIZER = new Item2ItemRecipeSerializer<>(
