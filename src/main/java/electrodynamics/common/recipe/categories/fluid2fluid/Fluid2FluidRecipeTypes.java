...
public class Fluid2FluidRecipeTypes {
	...
	public static final RecipeSerializer<ElectrolyticSeparatorRecipe> ELECTROLYTIC_SEPARATOR_RECIPE_SERIALIZER = new Fluid2FluidRecipeSerializer<>(
			ElectrolyticSeparatorRecipe.class);
}
