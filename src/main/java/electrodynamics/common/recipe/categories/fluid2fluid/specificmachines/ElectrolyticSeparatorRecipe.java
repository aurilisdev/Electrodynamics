...
public class ElectrolyticSeparatorRecipe extends Fluid2FluidRecipe {
	...
	public ElectrolyticSeparatorRecipe(ResourceLocation recipeID, FluidIngredient[] inputFluids, FluidStack outputFluid, double experience, int ticks, double usagePerTick, ProbableItem[] itemBiproducts, ProbableFluid[] fluidbiproducts, ProbableGas[] gasBiproducts) {
		super(recipeID, inputFluids, outputFluid, experience, ticks, usagePerTick, itemBiproducts, fluidbiproducts, gasBiproducts);
