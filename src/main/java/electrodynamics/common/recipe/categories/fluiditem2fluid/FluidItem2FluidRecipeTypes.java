...
public class FluidItem2FluidRecipeTypes {
    ...
    public static final RecipeSerializer<ChemicalMixerRecipe> CHEMICAL_MIXER_JSON_SERIALIZER = new FluidItem2FluidRecipeSerializer<>(
	    ChemicalMixerRecipe.class);
    public static final RecipeSerializer<FermentationPlantRecipe> FERMENTATION_PLANT_JSON_SERIALIZER = new FluidItem2FluidRecipeSerializer<>(
	    FermentationPlantRecipe.class);
    public static final RecipeSerializer<MineralWasherRecipe> MINERAL_WASHER_JSON_SERIALIZER = new FluidItem2FluidRecipeSerializer<>(
