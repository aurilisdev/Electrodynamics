...
public class MineralWasherRecipe extends FluidItem2FluidRecipe {
	...
	public MineralWasherRecipe(ResourceLocation recipeID, CountableIngredient[] inputItem, FluidIngredient[] inputFluid, FluidStack outputFluid, double experience, int ticks, double usagePerTick) {
