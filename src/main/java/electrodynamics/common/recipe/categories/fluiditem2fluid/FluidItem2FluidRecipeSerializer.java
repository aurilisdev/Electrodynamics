...
public class FluidItem2FluidRecipeSerializer<T extends FluidItem2FluidRecipe> extends ElectrodynamicsRecipeSerializer<T>{ 
	...
	public T read(ResourceLocation recipeId, JsonObject json) {
		...
		try {
			Constructor<T> recipeConstructor = getRecipeClass().getDeclaredConstructor(new Class[] {ResourceLocation.class,CountableIngredient.class,FluidIngredient.class,FluidStack.class});
