...
public class DO2ORecipeSerializer<T extends DO2ORecipe> extends ElectrodynamicsRecipeSerializer<T>{
	...
	public T read(ResourceLocation recipeId, JsonObject json) {
		...
		try {
			Constructor<T> recipeConstructor = getRecipeClass().getDeclaredConstructor(new Class[] {ResourceLocation.class,CountableIngredient.class,CountableIngredient.class,ItemStack.class});
