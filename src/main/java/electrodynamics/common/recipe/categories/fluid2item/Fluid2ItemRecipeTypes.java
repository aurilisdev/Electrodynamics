...
public class Fluid2ItemRecipeTypes {
    ...
    public static final RecipeSerializer<ChemicalCrystalizerRecipe> CHEMICAL_CRYSTALIZER_JSON_SERIALIZER = new Fluid2ItemRecipeSerializer<>(ChemicalCrystalizerRecipe::new);
