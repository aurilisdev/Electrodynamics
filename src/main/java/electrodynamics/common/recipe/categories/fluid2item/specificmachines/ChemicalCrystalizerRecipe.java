...
public class ChemicalCrystalizerRecipe extends Fluid2ItemRecipe {
	...
	public ChemicalCrystalizerRecipe(ResourceLocation group, List<FluidIngredient> fluidInputs, ItemStack itemOutput, double experience, int ticks, double usagePerTick, List<ProbableItem> itemBiproducts, List<ProbableFluid> fluidBiproducts, List<ProbableGas> gasBiproducts) {
