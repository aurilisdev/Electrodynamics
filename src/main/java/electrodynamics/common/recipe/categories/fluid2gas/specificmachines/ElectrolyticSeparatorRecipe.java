...
public class ElectrolyticSeparatorRecipe extends Fluid2GasRecipe {
	...
	public ElectrolyticSeparatorRecipe(ResourceLocation recipeGroup, List<FluidIngredient> inputFluidIngredients, GasStack outputGasStack, double experience, int ticks, double usagePerTick, List<ProbableItem> itemBiproducts, List<ProbableFluid> fluidBiproducts, List<ProbableGas> gasBiproducts) {
