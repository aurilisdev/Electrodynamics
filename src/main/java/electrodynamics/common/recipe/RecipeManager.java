...
public class RecipeManager {
	...
	public static void onLoadEvent(FMLLoadCompleteEvent event) {
		...
		MachineRecipes.registerRecipe(DeferredRegisters.TILE_OXIDATIONFURNACE.get(), new DO2OProcessingRecipe(Items.COAL, SubtypeDust.sulfur, SubtypeOxide.disulfur));
		MachineRecipes.registerRecipe(DeferredRegisters.TILE_OXIDATIONFURNACE.get(), new DO2OProcessingRecipe(Items.CHARCOAL, SubtypeDust.sulfur, SubtypeOxide.disulfur));
		MachineRecipes.registerRecipe(DeferredRegisters.TILE_OXIDATIONFURNACE.get(), new DO2OProcessingRecipe(Items.COAL, SubtypeDust.vanadium, SubtypeOxide.vanadium));
		MachineRecipes.registerRecipe(DeferredRegisters.TILE_OXIDATIONFURNACE.get(), new DO2OProcessingRecipe(Items.CHARCOAL, SubtypeDust.vanadium, SubtypeOxide.vanadium));
		MachineRecipes.registerRecipe(DeferredRegisters.TILE_OXIDATIONFURNACE.get(), new DO2OProcessingRecipe(SubtypeOxide.vanadium, SubtypeOxide.disulfur, SubtypeOxide.trisulfur));
	}
}
