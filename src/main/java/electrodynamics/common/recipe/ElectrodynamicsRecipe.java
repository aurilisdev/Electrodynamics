...
public abstract class ElectrodynamicsRecipe implements Recipe<RecipeWrapper> {
	...
	/* Need to know: 
	 * > does it have fluid and item biproducts ; store as booleans 
	 * > the number of fluid and item biproducts ; store as ints
	 * > the arrangement of the items in the machine's inventory ; store as int list
	 * 
    ...
    //not initialized unless in use; no need to create a bunch of Objects if there never even used!
    ...
    public void setFluidArrangement(List<Integer> arrangement) {
    	this.FLUID_ARRANGEMENT = arrangement;
    }
