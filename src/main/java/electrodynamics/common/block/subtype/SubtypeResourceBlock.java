...
public enum SubtypeResourceBlock implements ISubtype {
    tin(2.0f, 3.0f, Properties.copy(Blocks.IRON_BLOCK), SoundType.METAL, 1, VoltaicTags.Items.STORAGE_BLOCK_TIN,
    ...
    lead(2.0f, 3.0f, Properties.copy(Blocks.IRON_BLOCK), SoundType.METAL, 2, VoltaicTags.Items.STORAGE_BLOCK_LEAD,
    ...
    silver(2.0f, 3.0f, Properties.copy(Blocks.IRON_BLOCK), SoundType.METAL, 2, VoltaicTags.Items.STORAGE_BLOCK_SILVER,
	    VoltaicTags.Blocks.STORAGE_BLOCK_SILVER, VoltaicTags.Items.INGOT_SILVER,
	    () -> ElectrodynamicsItems.ITEMS_INGOT.getValue(SubtypeIngot.silver)),
    bronze(2.0f, 3.0f, Properties.copy(Blocks.IRON_BLOCK), SoundType.METAL, 1, VoltaicTags.Items.STORAGE_BLOCK_BRONZE,
	    VoltaicTags.Blocks.STORAGE_BLOCK_BRONZE, VoltaicTags.Items.INGOT_BRONZE,
	    () -> ElectrodynamicsItems.ITEMS_INGOT.getValue(SubtypeIngot.bronze)),
    steel(2.0f, 3.0f, Properties.copy(Blocks.IRON_BLOCK), SoundType.METAL, 2, VoltaicTags.Items.STORAGE_BLOCK_STEEL,
	    VoltaicTags.Blocks.STORAGE_BLOCK_STEEL, VoltaicTags.Items.INGOT_STEEL,
	    () -> ElectrodynamicsItems.ITEMS_INGOT.getValue(SubtypeIngot.steel)),
    aluminum(2.0f, 3.0f, Properties.copy(Blocks.IRON_BLOCK), SoundType.METAL, 2,
    ...
    chromium(2.0f, 3.0f, Properties.copy(Blocks.IRON_BLOCK), SoundType.METAL, 3,
    ...
    stainlesssteel(2.0f, 3.0f, Properties.copy(Blocks.IRON_BLOCK), SoundType.METAL, 2,
    ...
    vanadiumsteel(2.0f, 3.0f, Properties.copy(Blocks.IRON_BLOCK), SoundType.METAL, 2,
    ...
    hslasteel(2.0f, 3.0f, Properties.copy(Blocks.IRON_BLOCK), SoundType.METAL, 3,
    ...
    titanium(2.0f, 3.0f, Properties.copy(Blocks.IRON_BLOCK), SoundType.METAL, 3,
    ...
    titaniumcarbide(2.0f, 3.0f, Properties.copy(Blocks.IRON_BLOCK), SoundType.METAL, 3,
