...
public enum SubtypeOre implements ISubtype {
	...
	uraninite(3, 2, 8, -64, -32, 10f, 6.5f, 1, 1, () -> ElectrodynamicsItems.getItem(SubtypeRawOre.uranium), null, 0, 0, ElectrodynamicsTags.Items.ORE_URANIUM, ElectrodynamicsTags.Blocks.ORE_URANIUM),
	thorianite(3, 10, 8, -32, 32, 10f, 6.5f, 1, 1, () -> ElectrodynamicsItems.getItem(SubtypeRawOre.thorium), null, 0, 0, ElectrodynamicsTags.Items.ORE_THORIUM, ElectrodynamicsTags.Blocks.ORE_THORIUM),
	...
	vanadinite(2, 8, 8, -32, 32, 6f, 4.5f, 1, 1, () -> ElectrodynamicsItems.getItem(SubtypeRawOre.vanadinite), () -> ElectrodynamicsItems.getItem(SubtypeIngot.vanadium), 0.7, 200, ElectrodynamicsTags.Items.ORE_VANADIUM, ElectrodynamicsTags.Blocks.ORE_VANADIUM),
	...
	chromite(3, 4, 8, -10, 32, 10f, 6.5f, 1, 1, () -> ElectrodynamicsItems.getItem(SubtypeRawOre.chromium), null, 0, 0, ElectrodynamicsTags.Items.ORE_CHROMIUM, ElectrodynamicsTags.Blocks.ORE_CHROMIUM),
