...
public enum SubtypeOre implements ISubtype {
    ...
    SubtypeOre(int harvestLevel, int veinsPerChunk, int veinSize, int minY, int maxY, float hardness, float resistance, int minXP, int maxXP, int minDrop, int maxDrop, @Nullable Supplier<Item> lootItem, @Nullable Supplier<Item> smeltingItem, double smeltingXp, int smeltingTime, TagKey<Item> itemTag, TagKey<Block> blockTag) {
