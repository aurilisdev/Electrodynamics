...
public enum SubtypeOre implements ISubtype {
    ...
    chromium(3, 4, 8, 0, 32, 10f, 6.5f, 1, 1, null, null, 0, 0, VoltaicTags.Items.ORE_CHROMIUM, VoltaicTags.Blocks.ORE_CHROMIUM),
    ...
    fluorite(1, 4, 4, 0, 30, 2f, 2f, 1, 1, null, null, 0, 0, VoltaicTags.Items.ORE_FLUORITE, VoltaicTags.Blocks.ORE_FLUORITE),
    lead(2, 10, 6, 0, 32, 4f, 8f, 1, 1, null, () -> ElectrodynamicsItems.ITEMS_INGOT.getValue(SubtypeIngot.lead), 0.7, 200, VoltaicTags.Items.ORE_LEAD, VoltaicTags.Blocks.ORE_LEAD),
    lithium(2, 3, 9, 0, 32, 4f, 8f, 1, 1, null, null, 0, 0, VoltaicTags.Items.ORE_LITHIUM, VoltaicTags.Blocks.ORE_LITHIUM),
    ...
    silver(2, 6, 9, 0, 48, 4f, 5.5f, 1, 1, null, () -> ElectrodynamicsItems.ITEMS_INGOT.getValue(SubtypeIngot.silver), 1.0, 200, VoltaicTags.Items.ORE_SILVER, VoltaicTags.Blocks.ORE_SILVER),
    sulfur(1, 5, 13, 0, 28, 6f, 4.5f, 1, 2, 3, 5, () -> ElectrodynamicsItems.ITEMS_DUST.getValue(SubtypeDust.sulfur), null, 0, 0, VoltaicTags.Items.ORE_SULFUR, VoltaicTags.Blocks.ORE_SULFUR),
    sylvite(1, 5, 4, 0, 50, 2f, 2f, 3, 7, 1, 3, () -> ElectrodynamicsItems.ITEMS_CRYSTAL.getValue(SubtypeCrystal.potassiumchloride), null, 0, 0, VoltaicTags.Items.ORE_POTASSIUMCHLORIDE, VoltaicTags.Blocks.ORE_POTASSIUMCHLORIDE),
    tin(1, 12, 9, 0, 112, 3f, 5f, 1, 1, null, () -> ElectrodynamicsItems.ITEMS_INGOT.getValue(SubtypeIngot.tin), 0.7, 200, VoltaicTags.Items.ORE_TIN, VoltaicTags.Blocks.ORE_TIN),
    titanium(3, 5, 8, 0, 20, 10f, 6.5f, 1, 1, null, null, 0, 0, VoltaicTags.Items.ORE_TITANIUM, VoltaicTags.Blocks.ORE_TITANIUM),
    thorium(3, 10, 8, 0, 32, 10f, 6.5f, 1, 1, null, null, 0, 0, VoltaicTags.Items.ORE_THORIUM, VoltaicTags.Blocks.ORE_THORIUM),
    uranium(3, 2, 8, 0, 20, 10f, 6.5f, 1, 1, null, null, 0, 0, VoltaicTags.Items.ORE_URANIUM, VoltaicTags.Blocks.ORE_URANIUM),
    vanadium(2, 8, 8, 0, 32, 6f, 4.5f, 1, 1, null, () -> ElectrodynamicsItems.ITEMS_INGOT.getValue(SubtypeIngot.vanadium), 0.7, 200, VoltaicTags.Items.ORE_VANADIUM, VoltaicTags.Blocks.ORE_VANADIUM);
