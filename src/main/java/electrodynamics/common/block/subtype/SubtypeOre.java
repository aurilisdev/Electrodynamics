...
public enum SubtypeOre implements ISubtype {
	...
	//
			...
			null,
			//
			() -> ElectrodynamicsItems.ITEMS_INGOT.getValue(SubtypeIngot.copper),
			//
			0.3,
			//
			200,
			//
			VoltaicTags.Items.ORE_COPPER, VoltaicTags.Blocks.ORE_COPPER
	//
	), fluorite(
			//
			1,
	...
	//
			...
			0,
			//
			VoltaicTags.Items.ORE_SALT, VoltaicTags.Blocks.ORE_SALT
	//
	), silver(
			//
			2,
