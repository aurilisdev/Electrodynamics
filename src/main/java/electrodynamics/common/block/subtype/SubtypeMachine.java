...
public enum SubtypeMachine implements ISubtype {
	...
	circuitbreaker(true, TileCircuitBreaker.class), multimeterblock(true, TileMultimeterBlock.class),
	energizedalloyer(true, TileEnergizedAlloyer.class), energizedalloyerrunning(false, TileEnergizedAlloyer.class),
	lathe(true, TileLathe.class, true), reinforcedalloyer(true, TileReinforcedAlloyer.class),
...
//	seismicscannermachine(true, TileSeismicScanner.class);
	...
	public static boolean shouldBreakOnReplaced(BlockState before, BlockState after) {
		...
		if (bb instanceof BlockMachine tb && ba instanceof BlockMachine ta) {
			...
			return (mb != electricfurnace || ma != electricfurnacerunning) && (mb != electricfurnacerunning || ma != electricfurnace)
					...
					&& (mb != reinforcedalloyer || ma != reinforcedalloyerrunning) && (mb != electricarcfurnace || ma != electricarcfurnacerunning)
					&& (mb != electricarcfurnacerunning || ma != electricarcfurnace)
