...
public enum SubtypeRawOreBlock implements ISubtype {
    ...
    silver(2, VoltaicTags.Items.BLOCK_RAW_ORE_SILVER, VoltaicTags.Blocks.BLOCK_RAW_ORE_SILVER,
	    VoltaicTags.Items.RAW_ORE_SILVER, () -> ElectrodynamicsItems.ITEMS_RAWORE.getValue(SubtypeRawOre.silver)),
    chromium(3, VoltaicTags.Items.BLOCK_RAW_ORE_CHROMIUM, VoltaicTags.Blocks.BLOCK_RAW_ORE_CHROMIUM,
	    VoltaicTags.Items.RAW_ORE_CHROMIUM,
	    () -> ElectrodynamicsItems.ITEMS_RAWORE.getValue(SubtypeRawOre.chromium)),
    titanium(3, VoltaicTags.Items.BLOCK_RAW_ORE_TITANIUM, VoltaicTags.Blocks.BLOCK_RAW_ORE_TITANIUM,
	    VoltaicTags.Items.RAW_ORE_TITANIUM,
	    () -> ElectrodynamicsItems.ITEMS_RAWORE.getValue(SubtypeRawOre.titanium)),
    uranium(3, VoltaicTags.Items.BLOCK_RAW_ORE_URANIUM, VoltaicTags.Blocks.BLOCK_RAW_ORE_URANIUM,
	    VoltaicTags.Items.RAW_ORE_URANIUM, () -> ElectrodynamicsItems.ITEMS_RAWORE.getValue(SubtypeRawOre.uranium)),
    thorium(3, VoltaicTags.Items.BLOCK_RAW_ORE_THORIUM, VoltaicTags.Blocks.BLOCK_RAW_ORE_THORIUM,
	    VoltaicTags.Items.RAW_ORE_THORIUM, () -> ElectrodynamicsItems.ITEMS_RAWORE.getValue(SubtypeRawOre.thorium));
    ...
    SubtypeRawOreBlock(int miningLevel, TagKey<Item> itemTag, TagKey<Block> blockTag, TagKey<Item> sourceRawOre,
	    Supplier<Item> productRawOre) {
