...
public enum SubtypeWire implements ISubtype, IWire {
    ...
    // black
    insulatedtin(WireMaterial.TIN, InsulationMaterial.WOOL, WireClass.INSULATED, WireColor.BLACK, WireColor.BLACK,
	    VoltaicTags.Items.INSULATED_TIN_WIRES),
    insulatediron(WireMaterial.IRON, InsulationMaterial.WOOL, WireClass.INSULATED, WireColor.BLACK,
	    WireColor.BLACK, VoltaicTags.Items.INSULATED_IRON_WIRES),
    insulatedcopper(WireMaterial.COPPER, InsulationMaterial.WOOL, WireClass.INSULATED, WireColor.BLACK,
	    WireColor.BLACK, VoltaicTags.Items.INSULATED_COPPER_WIRES),
    insulatedsilver(WireMaterial.SILVER, InsulationMaterial.WOOL, WireClass.INSULATED, WireColor.BLACK,
	    WireColor.BLACK, VoltaicTags.Items.INSULATED_SILVER_WIRES),
    insulatedgold(WireMaterial.GOLD, InsulationMaterial.WOOL, WireClass.INSULATED, WireColor.BLACK,
	    WireColor.BLACK, VoltaicTags.Items.INSULATED_GOLD_WIRES),
    insulatedsuperconductive(WireMaterial.SUPERCONDUCTIVE, InsulationMaterial.WOOL, WireClass.INSULATED,
    ...
    // black
    highlyinsulatedtin(WireMaterial.TIN, InsulationMaterial.THICK_WOOL, WireClass.THICK, WireColor.BLACK,
	    WireColor.BLACK, 3.0, VoltaicTags.Items.THICK_TIN_WIRES),
    highlyinsulatediron(WireMaterial.IRON, InsulationMaterial.THICK_WOOL, WireClass.THICK, WireColor.BLACK,
	    WireColor.BLACK, 3.0, VoltaicTags.Items.THICK_IRON_WIRES),
    highlyinsulatedcopper(WireMaterial.COPPER, InsulationMaterial.THICK_WOOL, WireClass.THICK, WireColor.BLACK,
	    WireColor.BLACK, 3.0, VoltaicTags.Items.THICK_COPPER_WIRES),
    highlyinsulatedsilver(WireMaterial.SILVER, InsulationMaterial.THICK_WOOL, WireClass.THICK, WireColor.BLACK,
	    WireColor.BLACK, 3.0, VoltaicTags.Items.THICK_SILVER_WIRES),
    highlyinsulatedgold(WireMaterial.GOLD, InsulationMaterial.THICK_WOOL, WireClass.THICK, WireColor.BLACK,
	    WireColor.BLACK, 3.0, VoltaicTags.Items.THICK_GOLD_WIRES),
    highlyinsulatedsuperconductive(WireMaterial.SUPERCONDUCTIVE, InsulationMaterial.THICK_WOOL, WireClass.THICK,
    ...
    // black
    ceramicinsulatedtin(WireMaterial.TIN, InsulationMaterial.CERAMIC, WireClass.CERAMIC, WireColor.BLACK,
	    WireColor.BROWN, VoltaicTags.Items.CERAMIC_TIN_WIRES),
    ceramicinsulatediron(WireMaterial.IRON, InsulationMaterial.CERAMIC, WireClass.CERAMIC, WireColor.BLACK,
	    WireColor.BROWN, VoltaicTags.Items.CERAMIC_IRON_WIRES),
    ceramicinsulatedcopper(WireMaterial.COPPER, InsulationMaterial.CERAMIC, WireClass.CERAMIC, WireColor.BLACK,
	    WireColor.BROWN, VoltaicTags.Items.CERAMIC_COPPER_WIRES),
    ceramicinsulatedsilver(WireMaterial.SILVER, InsulationMaterial.CERAMIC, WireClass.CERAMIC, WireColor.BLACK,
	    WireColor.BROWN, VoltaicTags.Items.CERAMIC_SILVER_WIRES),
    ceramicinsulatedgold(WireMaterial.GOLD, InsulationMaterial.CERAMIC, WireClass.CERAMIC, WireColor.BLACK,
	    WireColor.BROWN, VoltaicTags.Items.CERAMIC_GOLD_WIRES),
    ceramicinsulatedsuperconductive(WireMaterial.SUPERCONDUCTIVE, InsulationMaterial.CERAMIC, WireClass.CERAMIC,
    ...
    // black
    logisticstin(WireMaterial.TIN, InsulationMaterial.WOOL, WireClass.LOGISTICAL, WireColor.BLACK, WireColor.BLACK,
	    VoltaicTags.Items.LOGISTICAL_TIN_WIRES),
    logisticsiron(WireMaterial.IRON, InsulationMaterial.WOOL, WireClass.LOGISTICAL, WireColor.BLACK,
	    WireColor.BLACK, VoltaicTags.Items.LOGISTICAL_IRON_WIRES),
    logisticscopper(WireMaterial.COPPER, InsulationMaterial.WOOL, WireClass.LOGISTICAL, WireColor.BLACK,
	    WireColor.BLACK, VoltaicTags.Items.LOGISTICAL_COPPER_WIRES),
    logisticssilver(WireMaterial.SILVER, InsulationMaterial.WOOL, WireClass.LOGISTICAL, WireColor.BLACK,
	    WireColor.BLACK, VoltaicTags.Items.LOGISTICAL_SILVER_WIRES),
    logisticsgold(WireMaterial.GOLD, InsulationMaterial.WOOL, WireClass.LOGISTICAL, WireColor.BLACK,
	    WireColor.BLACK, VoltaicTags.Items.LOGISTICAL_GOLD_WIRES),
    logisticssuperconductive(WireMaterial.SUPERCONDUCTIVE, InsulationMaterial.WOOL, WireClass.LOGISTICAL,
	...
	BARE(false, true, 0, 1,
		BlockBehaviour.Properties.of(Material.METAL, MaterialColor.METAL).strength(5.0F, 6.0F)
	...
	THICK_WOOL(true, false, 960, 3,
		BlockBehaviour.Properties.of(Material.WOOL, MaterialColor.SNOW).strength(0.8F).sound(SoundType.WOOL),
		SoundType.WOOL),
	CERAMIC(true, true, 480, 3,
		BlockBehaviour.Properties.of(Material.STONE, MaterialColor.STONE).strength(1.5F, 6.0F), SoundType.TUFF);
