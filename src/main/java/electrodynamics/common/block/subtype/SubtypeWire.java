...
public enum SubtypeWire implements ISubtype, IWire {
    ...
    @Nullable
    private final INamedTag<Item> itemTag;

    private SubtypeWire(WireMaterial conductor, InsulationMaterial insulation, WireClass wireClass, WireColor color, WireColor defaultColor, double dividend, INamedTag<Item> tag) {
    ...
    private SubtypeWire(WireMaterial conductor, InsulationMaterial insulation, WireClass wireClass, WireColor color, WireColor defaultColor, INamedTag<Item> tag) {
    ...
    @Nullable
    @Override
    public INamedTag<Item> getItemTag() {
        return itemTag;
    }
    ...
    public static enum WireColor implements IWireColor {
        ...
        @Nullable
        public final INamedTag<Item> dyeTag;

        public static final HashSet<IWireColor> WIRE_COLORS = new HashSet<>();

        private WireColor(int r, int g, int b, int a, INamedTag<Item> dyeTag) {
        ...
        public static IWireColor getColorFromDye(ItemStack item) {
            for (IWireColor color : WIRE_COLORS) {
                if (color.getDyeTag() != null && item.getItem().is(color.getDyeTag())) {
                    return color;
                }
            }
            return null;
        ...
        @Nonnull
        @Override
        public INamedTag<Item> getDyeTag() {
            return dyeTag;
        }
    }
