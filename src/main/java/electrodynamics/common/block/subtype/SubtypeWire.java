...
// To make resistance relevant we use the calculated values * 1000
public enum SubtypeWire implements ISubtype {
    tin(0.02024, 60, false, false), iron(0.017866, 100, false, false), copper(0.0031464, 360, false, false), silver(0.0029256, 600, false, false),
    gold(0.00449, 1000, false, false), superconductive(0.0, Long.MAX_VALUE, false, false), insulatedtin(SubtypeWire.tin.resistance, 60, true, false),
