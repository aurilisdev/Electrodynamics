...
public enum SubtypeWire implements ISubtype {
	...
	/**
	 * A distinction is made between this and WireClass, as there can be multiple different wires with the same insulation but different properties
	 * like the Logistical Wire. It shares the same insulation value as the standard Insulated wire
	 * 
	 * @author skip999
	 *
	 */
