...
public enum SubtypeWire implements ISubtype, IWire {
    ...
    // black
    insulatedtinblack(WireMaterial.TIN, InsulationMaterial.WOOL, WireClass.INSULATED, WireColor.BLACK, WireColor.BLACK, VoltaicTags.Items.INSULATED_TIN_WIRES),
    insulatedironblack(WireMaterial.IRON, InsulationMaterial.WOOL, WireClass.INSULATED, WireColor.BLACK, WireColor.BLACK, VoltaicTags.Items.INSULATED_IRON_WIRES),
    insulatedcopperblack(WireMaterial.COPPER, InsulationMaterial.WOOL, WireClass.INSULATED, WireColor.BLACK, WireColor.BLACK, VoltaicTags.Items.INSULATED_COPPER_WIRES),
    insulatedsilverblack(WireMaterial.SILVER, InsulationMaterial.WOOL, WireClass.INSULATED, WireColor.BLACK, WireColor.BLACK, VoltaicTags.Items.INSULATED_SILVER_WIRES),
    insulatedgoldblack(WireMaterial.GOLD, InsulationMaterial.WOOL, WireClass.INSULATED, WireColor.BLACK, WireColor.BLACK, VoltaicTags.Items.INSULATED_GOLD_WIRES),
    insulatedsuperconductiveblack(WireMaterial.SUPERCONDUCTIVE, InsulationMaterial.WOOL, WireClass.INSULATED, WireColor.BLACK, WireColor.BLACK, VoltaicTags.Items.INSULATED_SUPERCONDUCTIVE_WIRES),
    // red
    ...
    // black
    highlyinsulatedtinblack(WireMaterial.TIN, InsulationMaterial.THICK_WOOL, WireClass.THICK, WireColor.BLACK, WireColor.BLACK, 3.0, VoltaicTags.Items.THICK_TIN_WIRES),
    highlyinsulatedironblack(WireMaterial.IRON, InsulationMaterial.THICK_WOOL, WireClass.THICK, WireColor.BLACK, WireColor.BLACK, 3.0, VoltaicTags.Items.THICK_IRON_WIRES),
    highlyinsulatedcopperblack(WireMaterial.COPPER, InsulationMaterial.THICK_WOOL, WireClass.THICK, WireColor.BLACK, WireColor.BLACK, 3.0, VoltaicTags.Items.THICK_COPPER_WIRES),
    highlyinsulatedsilverblack(WireMaterial.SILVER, InsulationMaterial.THICK_WOOL, WireClass.THICK, WireColor.BLACK, WireColor.BLACK, 3.0, VoltaicTags.Items.THICK_SILVER_WIRES),
    highlyinsulatedgoldblack(WireMaterial.GOLD, InsulationMaterial.THICK_WOOL, WireClass.THICK, WireColor.BLACK, WireColor.BLACK, 3.0, VoltaicTags.Items.THICK_GOLD_WIRES),
    highlyinsulatedsuperconductiveblack(WireMaterial.SUPERCONDUCTIVE, InsulationMaterial.THICK_WOOL, WireClass.THICK, WireColor.BLACK, WireColor.BLACK, 3.0, VoltaicTags.Items.THICK_SUPERCONDUCTIVE_WIRES),
    // red
    ...
    // black
    ceramicinsulatedtinblack(WireMaterial.TIN, InsulationMaterial.CERAMIC, WireClass.CERAMIC, WireColor.BLACK, WireColor.BROWN, VoltaicTags.Items.CERAMIC_TIN_WIRES),
    ceramicinsulatedironblack(WireMaterial.IRON, InsulationMaterial.CERAMIC, WireClass.CERAMIC, WireColor.BLACK, WireColor.BROWN, VoltaicTags.Items.CERAMIC_IRON_WIRES),
    ceramicinsulatedcopperblack(WireMaterial.COPPER, InsulationMaterial.CERAMIC, WireClass.CERAMIC, WireColor.BLACK, WireColor.BROWN, VoltaicTags.Items.CERAMIC_COPPER_WIRES),
    ceramicinsulatedsilverblack(WireMaterial.SILVER, InsulationMaterial.CERAMIC, WireClass.CERAMIC, WireColor.BLACK, WireColor.BROWN, VoltaicTags.Items.CERAMIC_SILVER_WIRES),
    ceramicinsulatedgoldblack(WireMaterial.GOLD, InsulationMaterial.CERAMIC, WireClass.CERAMIC, WireColor.BLACK, WireColor.BROWN, VoltaicTags.Items.CERAMIC_GOLD_WIRES),
    ceramicinsulatedsuperconductiveblack(WireMaterial.SUPERCONDUCTIVE, InsulationMaterial.CERAMIC, WireClass.CERAMIC, WireColor.BLACK, WireColor.BROWN, VoltaicTags.Items.CERAMIC_SUPERCONDUCTIVE_WIRES),
    // red
    ...
    // black
    logisticstinblack(WireMaterial.TIN, InsulationMaterial.WOOL, WireClass.LOGISTICAL, WireColor.BLACK, WireColor.BLACK, VoltaicTags.Items.LOGISTICAL_TIN_WIRES),
    logisticsironblack(WireMaterial.IRON, InsulationMaterial.WOOL, WireClass.LOGISTICAL, WireColor.BLACK, WireColor.BLACK, VoltaicTags.Items.LOGISTICAL_IRON_WIRES),
    logisticscopperblack(WireMaterial.COPPER, InsulationMaterial.WOOL, WireClass.LOGISTICAL, WireColor.BLACK, WireColor.BLACK, VoltaicTags.Items.LOGISTICAL_COPPER_WIRES),
    logisticssilverblack(WireMaterial.SILVER, InsulationMaterial.WOOL, WireClass.LOGISTICAL, WireColor.BLACK, WireColor.BLACK, VoltaicTags.Items.LOGISTICAL_SILVER_WIRES),
    logisticsgoldblack(WireMaterial.GOLD, InsulationMaterial.WOOL, WireClass.LOGISTICAL, WireColor.BLACK, WireColor.BLACK, VoltaicTags.Items.LOGISTICAL_GOLD_WIRES),
    logisticssuperconductiveblack(WireMaterial.SUPERCONDUCTIVE, InsulationMaterial.WOOL, WireClass.LOGISTICAL, WireColor.BLACK, WireColor.BLACK, VoltaicTags.Items.LOGISTICAL_SUPERCONDUCTIVE_WIRES),
    // red
