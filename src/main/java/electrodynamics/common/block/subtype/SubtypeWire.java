...
public enum SubtypeWire implements Subtype {
	...
	superconductive(0.0, Long.MAX_VALUE, false, false), insulatedtin(0.00645, 60, true, false), insulatediron(0.0466, 100, true, false), insulatedcopper(0.00806, 360, true, false),
	insulatedsilver(0.00763, 600, true, false), insulatedgold(0.0117, 1000, true, false), insulatedsuperconductive(0.0, Long.MAX_VALUE, true, false), logisticstin(0.00645, 60, true, true),
	logisticsiron(0.0466, 100, true, true), logisticscopper(0.00806, 360, true, true), logisticssilver(0.00763, 600, true, true), logisticsgold(0.0117, 1000, true, true),
