...
public enum SubtypeOreDeepslate implements ISubtype {
	...
	silver(SubtypeOre.silver.harvestLevel, SubtypeOre.silver.veinsPerChunk, SubtypeOre.silver.veinSize, SubtypeOre.silver.minY,
			SubtypeOre.silver.maxY, SubtypeOre.silver.hardness, SubtypeOre.silver.resistance),
	lead(SubtypeOre.lead.harvestLevel, SubtypeOre.lead.veinsPerChunk, SubtypeOre.lead.veinSize, SubtypeOre.lead.minY, SubtypeOre.lead.maxY,
			SubtypeOre.lead.hardness, SubtypeOre.lead.resistance),
	uraninite(SubtypeOre.uraninite.harvestLevel, SubtypeOre.uraninite.veinsPerChunk, SubtypeOre.uraninite.veinSize, SubtypeOre.uraninite.minY,
			SubtypeOre.uraninite.maxY, SubtypeOre.uraninite.hardness, SubtypeOre.uraninite.resistance),
	thorianite(SubtypeOre.thorianite.harvestLevel, SubtypeOre.thorianite.veinsPerChunk, SubtypeOre.thorianite.veinSize, SubtypeOre.thorianite.minY,
			SubtypeOre.thorianite.maxY, SubtypeOre.thorianite.hardness, SubtypeOre.thorianite.resistance),
	monazite(SubtypeOre.monazite.harvestLevel, SubtypeOre.monazite.veinsPerChunk, SubtypeOre.monazite.veinSize, SubtypeOre.monazite.minY,
			SubtypeOre.monazite.maxY, SubtypeOre.monazite.hardness, SubtypeOre.monazite.resistance),
	...
	chromite(SubtypeOre.chromite.harvestLevel, SubtypeOre.chromite.veinsPerChunk, SubtypeOre.chromite.veinSize, SubtypeOre.chromite.minY,
			SubtypeOre.chromite.maxY, SubtypeOre.chromite.hardness, SubtypeOre.chromite.resistance),
	...
	molybdenum(SubtypeOre.molybdenum.harvestLevel, SubtypeOre.molybdenum.veinsPerChunk, SubtypeOre.molybdenum.veinSize, SubtypeOre.molybdenum.minY,
			SubtypeOre.molybdenum.maxY, SubtypeOre.molybdenum.hardness, SubtypeOre.molybdenum.resistance),
	...
	SubtypeOreDeepslate(int harvestLevel, int veinsPerChunk, int veinSize, int minY, int maxY, float hardness, float resistance, int minXP,
			int maxXP) {
