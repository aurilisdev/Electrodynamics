...
public enum SubtypeOreDeepslate implements ISubtype {
	...
	sulfur(SubtypeOre.sulfur.harvestLevel, SubtypeOre.sulfur.veinsPerChunk, SubtypeOre.sulfur.veinSize, SubtypeOre.sulfur.minY, SubtypeOre.sulfur.maxY, SubtypeOre.sulfur.hardness, SubtypeOre.sulfur.resistance, SubtypeOre.sulfur.minXP, SubtypeOre.sulfur.maxXP),
	niter(SubtypeOre.niter.harvestLevel, SubtypeOre.niter.veinsPerChunk, SubtypeOre.niter.veinSize, SubtypeOre.niter.minY, SubtypeOre.niter.maxY, SubtypeOre.niter.hardness, SubtypeOre.niter.resistance, SubtypeOre.niter.minXP, SubtypeOre.niter.maxXP),
	...
	halite(SubtypeOre.halite.harvestLevel, SubtypeOre.halite.veinsPerChunk, SubtypeOre.halite.veinSize, SubtypeOre.halite.minY, SubtypeOre.halite.maxY, SubtypeOre.halite.hardness, SubtypeOre.halite.resistance, SubtypeOre.halite.minXP, SubtypeOre.halite.maxXP),
	...
	sylvite(SubtypeOre.sylvite.harvestLevel, SubtypeOre.sylvite.veinsPerChunk, SubtypeOre.sylvite.veinSize, SubtypeOre.sylvite.minY, SubtypeOre.sylvite.maxY, SubtypeOre.sylvite.hardness, SubtypeOre.sylvite.resistance, SubtypeOre.sylvite.minXP, SubtypeOre.sylvite.maxXP);
