...
public enum SubtypeOreDeepslate implements ISubtype {
	...
	uraninite(SubtypeOre.uraninite.harvestLevel, SubtypeOre.uraninite.veinsPerChunk, SubtypeOre.uraninite.veinSize, SubtypeOre.uraninite.minY, SubtypeOre.uraninite.maxY, SubtypeOre.uraninite.hardness, SubtypeOre.uraninite.resistance, SubtypeOre.uraninite.minDrop, SubtypeOre.uraninite.maxDrop, SubtypeOre.uraninite.nonSilkLootItem, SubtypeOre.uraninite.smeltingItem, SubtypeOre.uraninite.smeltingXp, SubtypeOre.uraninite.smeltingTime, SubtypeOre.uraninite.itemTag, SubtypeOre.uraninite.blockTag),

	thorianite(SubtypeOre.thorianite.harvestLevel, SubtypeOre.thorianite.veinsPerChunk, SubtypeOre.thorianite.veinSize, SubtypeOre.thorianite.minY, SubtypeOre.thorianite.maxY, SubtypeOre.thorianite.hardness, SubtypeOre.thorianite.resistance, SubtypeOre.thorianite.minDrop, SubtypeOre.thorianite.maxDrop, SubtypeOre.thorianite.nonSilkLootItem, SubtypeOre.thorianite.smeltingItem, SubtypeOre.thorianite.smeltingXp, SubtypeOre.thorianite.smeltingTime, SubtypeOre.thorianite.itemTag, SubtypeOre.thorianite.blockTag),
	...
	vanadinite(SubtypeOre.vanadinite.harvestLevel, SubtypeOre.vanadinite.veinsPerChunk, SubtypeOre.vanadinite.veinSize, SubtypeOre.vanadinite.minY, SubtypeOre.vanadinite.maxY, SubtypeOre.vanadinite.hardness, SubtypeOre.vanadinite.resistance, SubtypeOre.vanadinite.minDrop, SubtypeOre.vanadinite.maxDrop, SubtypeOre.vanadinite.nonSilkLootItem, SubtypeOre.vanadinite.smeltingItem, SubtypeOre.vanadinite.smeltingXp, SubtypeOre.vanadinite.smeltingTime, SubtypeOre.vanadinite.itemTag, SubtypeOre.vanadinite.blockTag),
	...
	chromite(SubtypeOre.chromite.harvestLevel, SubtypeOre.chromite.veinsPerChunk, SubtypeOre.chromite.veinSize, SubtypeOre.chromite.minY, SubtypeOre.chromite.maxY, SubtypeOre.chromite.hardness, SubtypeOre.chromite.resistance, SubtypeOre.chromite.minDrop, SubtypeOre.chromite.maxDrop, SubtypeOre.chromite.nonSilkLootItem, SubtypeOre.chromite.smeltingItem, SubtypeOre.chromite.smeltingXp, SubtypeOre.chromite.smeltingTime, SubtypeOre.chromite.itemTag, SubtypeOre.chromite.blockTag),

	rutile(SubtypeOre.rutile.harvestLevel, SubtypeOre.rutile.veinsPerChunk, SubtypeOre.rutile.veinSize, SubtypeOre.rutile.minY, SubtypeOre.rutile.maxY, SubtypeOre.rutile.hardness, SubtypeOre.rutile.resistance, SubtypeOre.rutile.minDrop, SubtypeOre.rutile.maxDrop, SubtypeOre.rutile.nonSilkLootItem, SubtypeOre.rutile.smeltingItem, SubtypeOre.rutile.smeltingXp, SubtypeOre.rutile.smeltingTime, SubtypeOre.rutile.itemTag, SubtypeOre.rutile.blockTag),

	halite(SubtypeOre.halite.harvestLevel, SubtypeOre.halite.veinsPerChunk, SubtypeOre.halite.veinSize, SubtypeOre.halite.minY, SubtypeOre.halite.maxY, SubtypeOre.halite.hardness, SubtypeOre.halite.resistance, SubtypeOre.halite.minXP, SubtypeOre.halite.maxXP, SubtypeOre.halite.minDrop, SubtypeOre.halite.maxDrop, SubtypeOre.halite.nonSilkLootItem, SubtypeOre.halite.smeltingItem, SubtypeOre.halite.smeltingXp, SubtypeOre.halite.smeltingTime, SubtypeOre.halite.itemTag, SubtypeOre.halite.blockTag),

	lepidolite(SubtypeOre.lepidolite.harvestLevel, SubtypeOre.lepidolite.veinsPerChunk, SubtypeOre.lepidolite.veinSize, SubtypeOre.lepidolite.minY, SubtypeOre.lepidolite.maxY, SubtypeOre.lepidolite.hardness, SubtypeOre.lepidolite.resistance, SubtypeOre.lepidolite.minDrop, SubtypeOre.lepidolite.maxDrop, SubtypeOre.lepidolite.nonSilkLootItem, SubtypeOre.lepidolite.smeltingItem, SubtypeOre.lepidolite.smeltingXp, SubtypeOre.lepidolite.smeltingTime, SubtypeOre.lepidolite.itemTag, SubtypeOre.lepidolite.blockTag),
