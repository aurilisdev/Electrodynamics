...
public class BlockItemGasPipe extends BlockItemVoltaic {
	...
	// tooltips.add(ElectroTextUtils.tooltip("pipematerial",
	// pipe.pipe.getPipeMaterial().getName().copy().withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.DARK_GRAY));
