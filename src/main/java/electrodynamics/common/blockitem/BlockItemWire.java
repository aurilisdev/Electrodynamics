...
public class BlockItemWire extends BlockItem {
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add(new TranslationTextComponent("tooltip.itemwire.resistance", ElectricityChatFormatter.getDisplay(wire.wire.resistance, ElectricUnit.RESISTANCE)).func_240701_a_(TextFormatting.GRAY));
		tooltip.add(new TranslationTextComponent("tooltip.itemwire.maxamps", ElectricityChatFormatter.getDisplay(wire.wire.maxAmps, ElectricUnit.AMPERE)).func_240701_a_(TextFormatting.GRAY));
