...
public class FluidNetwork extends AbstractNetwork<GenericTileFluidPipe, IFluidPipe, FluidStack, FluidNetwork> {
    ...
    @Override
    public FluidStack emit(FluidStack inserted, ArrayList<TileEntity> ignored, boolean debug) {
        ...
        HashSet<TileEntity> availableAcceptors = Sets.newHashSet();
    ...
    private Pair<FluidStack, Set<TileFluidPipePump>> emitToPumps(FluidStack transfer, ArrayList<TileEntity> ignored) {
    ...
    private Pair<FluidStack, Set<TileFluidPipePump>> emitToPumpSet(FluidStack transfer, Set<TileFluidPipePump> recievingTiles, ArrayList<TileEntity> ignored) {
    ...
    @Override
    public boolean isConductor(TileEntity tile, GenericTileFluidPipe requsterCable) {
