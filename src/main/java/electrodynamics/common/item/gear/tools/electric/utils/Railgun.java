...
public class Railgun extends ItemElectric {
    ...
    public Railgun(ElectricItemProperties properties, double overheatTemperature, double tempThreshold, double tempPerTick) {
	super(properties);
	OVERHEAT_TEMPERATURE = overheatTemperature;
	OVERHEAT_WARNING_THRESHOLD = tempThreshold;
	TEMPERATURE_REDUCED_PER_TICK = tempPerTick;
    }
