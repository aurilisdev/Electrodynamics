...
public class ItemRailgunPlasma extends ItemRailgun {
	...
	if (railgun.getJoulesStored(gunStack) < JOULES_PER_SHOT
	    ...
	    worldIn.playSound(null, playerIn.blockPosition(), ElectrodynamicsSounds.SOUND_RAILGUNKINETIC_NOAMMO.get(),
	...
	worldIn.playSound(null, playerIn.blockPosition(), ElectrodynamicsSounds.SOUND_RAILGUNPLASMA_FIRE.get(),
		SoundSource.PLAYERS, 1, 1);
