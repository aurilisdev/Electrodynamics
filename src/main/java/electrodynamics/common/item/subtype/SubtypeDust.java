...
public enum SubtypeDust implements ISubtype {
	...
	copper(VoltaicTags.Items.DUST_COPPER, () -> ElectrodynamicsItems.ITEMS_INGOT.getValue(SubtypeIngot.copper), 200),
	...
	SubtypeDust(INamedTag<Item> tag) {
		this(tag, null, 0);
	}

	SubtypeDust(INamedTag<Item> tag, Supplier<Item> smeltedItem, int smeltTime) {
		this.tag = tag;
