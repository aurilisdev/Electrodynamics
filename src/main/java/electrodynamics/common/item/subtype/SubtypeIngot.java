...
public enum SubtypeIngot implements ISubtype {
    copper(ElectrodynamicsTags.Items.INGOT_COPPER, () -> ElectrodynamicsItems.getItem(SubtypeDust.copper)),
	...
	SubtypeIngot(IOptionalNamedTag<Item> tag) {
		this(tag, null);
	}

	SubtypeIngot(IOptionalNamedTag<Item> tag, Supplier<Item> grindedDust) {
		this.tag = tag;
