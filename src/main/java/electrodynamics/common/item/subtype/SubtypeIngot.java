...
public enum SubtypeIngot implements ISubtype {
	...
	copper(VoltaicTags.Items.INGOT_COPPER, () -> ElectrodynamicsItems.ITEMS_DUST.getValue(SubtypeDust.copper)),
	...
	SubtypeIngot(INamedTag<Item> tag) {
		this(tag, null);
	}

	SubtypeIngot(INamedTag<Item> tag, Supplier<Item> grindedDust) {
		this.tag = tag;
