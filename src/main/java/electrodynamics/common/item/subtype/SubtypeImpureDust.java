...
public enum SubtypeImpureDust implements ISubtype {
    ...
    netherite(VoltaicTags.Items.IMPURE_DUST_NETHERITE,
	    () -> ElectrodynamicsItems.ITEMS_DUST.getValue(SubtypeDust.netherite)),
    aluminum(VoltaicTags.Items.IMPURE_DUST_ALUMINUM,
	    () -> ElectrodynamicsItems.ITEMS_DUST.getValue(SubtypeDust.aluminum)),
    chromium(VoltaicTags.Items.IMPURE_DUST_CHROMIUM,
	    () -> ElectrodynamicsItems.ITEMS_DUST.getValue(SubtypeDust.chromium)),
    titanium(VoltaicTags.Items.IMPURE_DUST_TITANIUM,
	    () -> ElectrodynamicsItems.ITEMS_DUST.getValue(SubtypeDust.titanium));
