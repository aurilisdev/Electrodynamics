...
public class ElectrodynamicsTags {
	...
	public static final Tags.IOptionalNamedTag<Fluid> SILVER_SULF = forgeTag(FluidSulfate.FORGE_TAG + SubtypeMineralFluid.silver.name());
	public static final Tags.IOptionalNamedTag<Fluid> LEAD_SULF = forgeTag(FluidSulfate.FORGE_TAG + SubtypeMineralFluid.lead.name());
	public static final Tags.IOptionalNamedTag<Fluid> VANADIUM_SULF = forgeTag(FluidSulfate.FORGE_TAG + SubtypeMineralFluid.vanadium.name());
	public static final Tags.IOptionalNamedTag<Fluid> IRON_SULF = forgeTag(FluidSulfate.FORGE_TAG + SubtypeMineralFluid.iron.name());
