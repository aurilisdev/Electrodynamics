...
public class ElectrodynamicsConfig {
	...
	GAS_TRANSFORMER_OUTPUT_PRESSURE_CAP = builder.defineInRange("gastransformer_output_pressure_cap", 1048576, 1,
		Integer.MAX_VALUE);// 2^20
	// The thermoelectric manipulator can turn water into steam. With the default
	// advanced manipulator values,
	// very high steam temperatures can become energy-positive in a turbine if
	// conversion-rate scaling is disabled
