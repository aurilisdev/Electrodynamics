...
public class ElectrodynamicsFeatures {
	...
	FeatureUtils.register(context, ORE_ALUMINUM_CONFIGURED, Feature.ORE,
		dualOre(SubtypeOre.aluminum, SubtypeOreDeepslate.aluminum));
	FeatureUtils.register(context, ORE_CHROMIUM_CONFIGURED, Feature.ORE,
		dualOre(SubtypeOre.chromium, SubtypeOreDeepslate.chromium));
	FeatureUtils.register(context, ORE_FLUORITE_CONFIGURED, Feature.ORE,
		dualOre(SubtypeOre.fluorite, SubtypeOreDeepslate.fluorite));
	FeatureUtils.register(context, ORE_LEAD_CONFIGURED, Feature.ORE,
		dualOre(SubtypeOre.lead, SubtypeOreDeepslate.lead));
	FeatureUtils.register(context, ORE_LITHIUM_CONFIGURED, Feature.ORE,
		dualOre(SubtypeOre.lithium, SubtypeOreDeepslate.lithium));
	FeatureUtils.register(context, ORE_MOLYBDENUM_CONFIGURED, Feature.ORE,
		dualOre(SubtypeOre.molybdenum, SubtypeOreDeepslate.molybdenum));
	FeatureUtils.register(context, ORE_MONAZITE_CONFIGURED, Feature.ORE,
		dualOre(SubtypeOre.monazite, SubtypeOreDeepslate.monazite));
	FeatureUtils.register(context, ORE_NITER_CONFIGURED, Feature.ORE,
		dualOre(SubtypeOre.niter, SubtypeOreDeepslate.niter));
	FeatureUtils.register(context, ORE_SALT_CONFIGURED, Feature.ORE,
		dualOre(SubtypeOre.salt, SubtypeOreDeepslate.salt));
	FeatureUtils.register(context, ORE_SILVER_CONFIGURED, Feature.ORE,
		dualOre(SubtypeOre.silver, SubtypeOreDeepslate.silver));
	FeatureUtils.register(context, ORE_SULFUR_CONFIGURED, Feature.ORE,
		dualOre(SubtypeOre.sulfur, SubtypeOreDeepslate.sulfur));
	FeatureUtils.register(context, ORE_SYLVITE_CONFIGURED, Feature.ORE,
		dualOre(SubtypeOre.sylvite, SubtypeOreDeepslate.sylvite));
	FeatureUtils.register(context, ORE_TIN_CONFIGURED, Feature.ORE,
		dualOre(SubtypeOre.tin, SubtypeOreDeepslate.tin));
	FeatureUtils.register(context, ORE_TITANIUM_CONFIGURED, Feature.ORE,
		dualOre(SubtypeOre.titanium, SubtypeOreDeepslate.titanium));
	FeatureUtils.register(context, ORE_THORIUM_CONFIGURED, Feature.ORE,
		dualOre(SubtypeOre.thorium, SubtypeOreDeepslate.thorium));
	FeatureUtils.register(context, ORE_URANIUM_CONFIGURED, Feature.ORE,
		dualOre(SubtypeOre.uranium, SubtypeOreDeepslate.uranium));
	FeatureUtils.register(context, ORE_VANADIUM_CONFIGURED, Feature.ORE,
		dualOre(SubtypeOre.vanadium, SubtypeOreDeepslate.vanadium));
	...
	return new OreConfiguration(
		List.of(OreConfiguration.target(new RuleTestOre(ore, null, BlockTags.STONE_ORE_REPLACEABLES),
			ElectrodynamicsBlocks.BLOCKS_ORE.getValue(ore).defaultBlockState()),
			OreConfiguration.target(new RuleTestOre(null, deepOre, BlockTags.DEEPSLATE_ORE_REPLACEABLES),
				ElectrodynamicsBlocks.BLOCKS_DEEPSLATEORE.getValue(deepOre).defaultBlockState())),
		ore.veinSize);
    }
	...
	PlacementUtils.register(context, ORE_ALUMINUM_PLACED, holderGetter.getOrThrow(ORE_ALUMINUM_CONFIGURED),
		orePlacement((int) (SubtypeOre.aluminum.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER),
			SubtypeOre.aluminum.minY, SubtypeOre.aluminum.maxY));
	PlacementUtils.register(context, ORE_CHROMIUM_PLACED, holderGetter.getOrThrow(ORE_CHROMIUM_CONFIGURED),
		orePlacement((int) (SubtypeOre.chromium.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER),
			SubtypeOre.chromium.minY, SubtypeOre.chromium.maxY));
	PlacementUtils.register(context, ORE_FLUORITE_PLACED, holderGetter.getOrThrow(ORE_FLUORITE_CONFIGURED),
		orePlacement((int) (SubtypeOre.fluorite.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER),
			SubtypeOre.fluorite.minY, SubtypeOre.fluorite.maxY));
	PlacementUtils.register(context, ORE_LEAD_PLACED, holderGetter.getOrThrow(ORE_LEAD_CONFIGURED),
		orePlacement((int) (SubtypeOre.lead.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER),
			SubtypeOre.lead.minY, SubtypeOre.lead.maxY));
	PlacementUtils.register(context, ORE_LITHIUM_PLACED, holderGetter.getOrThrow(ORE_LITHIUM_CONFIGURED),
		orePlacement((int) (SubtypeOre.lithium.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER),
			SubtypeOre.lithium.minY, SubtypeOre.lithium.maxY));
	PlacementUtils.register(context, ORE_MOLYBDENUM_PLACED, holderGetter.getOrThrow(ORE_MOLYBDENUM_CONFIGURED),
		orePlacement((int) (SubtypeOre.molybdenum.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER),
			SubtypeOre.molybdenum.minY, SubtypeOre.molybdenum.maxY));
	PlacementUtils.register(context, ORE_MONAZITE_PLACED, holderGetter.getOrThrow(ORE_MONAZITE_CONFIGURED),
		orePlacement((int) (SubtypeOre.monazite.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER),
			SubtypeOre.monazite.minY, SubtypeOre.monazite.maxY));
	PlacementUtils.register(context, ORE_NITER_PLACED, holderGetter.getOrThrow(ORE_NITER_CONFIGURED),
		orePlacement((int) (SubtypeOre.niter.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER),
			SubtypeOre.niter.minY, SubtypeOre.niter.maxY));
	PlacementUtils.register(context, ORE_SALT_PLACED, holderGetter.getOrThrow(ORE_SALT_CONFIGURED),
		orePlacement((int) (SubtypeOre.salt.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER),
			SubtypeOre.salt.minY, SubtypeOre.salt.maxY));
	PlacementUtils.register(context, ORE_SILVER_PLACED, holderGetter.getOrThrow(ORE_SILVER_CONFIGURED),
		orePlacement((int) (SubtypeOre.silver.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER),
			SubtypeOre.silver.minY, SubtypeOre.silver.maxY));
	PlacementUtils.register(context, ORE_SULFUR_PLACED, holderGetter.getOrThrow(ORE_SULFUR_CONFIGURED),
		orePlacement((int) (SubtypeOre.sulfur.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER),
			SubtypeOre.sulfur.minY, SubtypeOre.sulfur.maxY));
	PlacementUtils.register(context, ORE_SYLVITE_PLACED, holderGetter.getOrThrow(ORE_SYLVITE_CONFIGURED),
		orePlacement((int) (SubtypeOre.sylvite.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER),
			SubtypeOre.sylvite.minY, SubtypeOre.sylvite.maxY));
	PlacementUtils.register(context, ORE_TIN_PLACED, holderGetter.getOrThrow(ORE_TIN_CONFIGURED),
		orePlacement((int) (SubtypeOre.tin.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER),
			SubtypeOre.tin.minY, SubtypeOre.tin.maxY));
	PlacementUtils.register(context, ORE_TITANIUM_PLACED, holderGetter.getOrThrow(ORE_TITANIUM_CONFIGURED),
		orePlacement((int) (SubtypeOre.titanium.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER),
			SubtypeOre.titanium.minY, SubtypeOre.titanium.maxY));
	PlacementUtils.register(context, ORE_THORIUM_PLACED, holderGetter.getOrThrow(ORE_THORIUM_CONFIGURED),
		orePlacement((int) (SubtypeOre.thorium.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER),
			SubtypeOre.thorium.minY, SubtypeOre.thorium.maxY));
	PlacementUtils.register(context, ORE_URANIUM_PLACED, holderGetter.getOrThrow(ORE_URANIUM_CONFIGURED),
		orePlacement((int) (SubtypeOre.uranium.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER),
			SubtypeOre.uranium.minY, SubtypeOre.uranium.maxY));
	PlacementUtils.register(context, ORE_VANADIUM_PLACED, holderGetter.getOrThrow(ORE_VANADIUM_CONFIGURED),
		orePlacement((int) (SubtypeOre.vanadium.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER),
			SubtypeOre.vanadium.minY, SubtypeOre.vanadium.maxY));
	...
	context.register(ORE_ALUMINUM_MODIFIER, new AddFeaturesBiomeModifier(overworld,
		HolderSet.direct(placedLookup.getOrThrow(ORE_ALUMINUM_PLACED)), Decoration.UNDERGROUND_ORES));
	context.register(ORE_CHROMIUM_MODIFIER, new AddFeaturesBiomeModifier(overworld,
		HolderSet.direct(placedLookup.getOrThrow(ORE_CHROMIUM_PLACED)), Decoration.UNDERGROUND_ORES));
	context.register(ORE_FLUORITE_MODIFIER, new AddFeaturesBiomeModifier(overworld,
		HolderSet.direct(placedLookup.getOrThrow(ORE_FLUORITE_PLACED)), Decoration.UNDERGROUND_ORES));
	context.register(ORE_LEAD_MODIFIER, new AddFeaturesBiomeModifier(overworld,
		HolderSet.direct(placedLookup.getOrThrow(ORE_LEAD_PLACED)), Decoration.UNDERGROUND_ORES));
	context.register(ORE_LITHIUM_MODIFIER, new AddFeaturesBiomeModifier(overworld,
		HolderSet.direct(placedLookup.getOrThrow(ORE_LITHIUM_PLACED)), Decoration.UNDERGROUND_ORES));
	context.register(ORE_MOLYBDENUM_MODIFIER, new AddFeaturesBiomeModifier(overworld,
		HolderSet.direct(placedLookup.getOrThrow(ORE_MOLYBDENUM_PLACED)), Decoration.UNDERGROUND_ORES));
	context.register(ORE_MONAZITE_MODIFIER, new AddFeaturesBiomeModifier(overworld,
		HolderSet.direct(placedLookup.getOrThrow(ORE_MONAZITE_PLACED)), Decoration.UNDERGROUND_ORES));
	context.register(ORE_NITER_MODIFIER, new AddFeaturesBiomeModifier(overworld,
		HolderSet.direct(placedLookup.getOrThrow(ORE_NITER_PLACED)), Decoration.UNDERGROUND_ORES));
	context.register(ORE_SALT_MODIFIER, new AddFeaturesBiomeModifier(overworld,
		HolderSet.direct(placedLookup.getOrThrow(ORE_SALT_PLACED)), Decoration.UNDERGROUND_ORES));
	context.register(ORE_SILVER_MODIFIER, new AddFeaturesBiomeModifier(overworld,
		HolderSet.direct(placedLookup.getOrThrow(ORE_SILVER_PLACED)), Decoration.UNDERGROUND_ORES));
	context.register(ORE_SULFUR_MODIFIER, new AddFeaturesBiomeModifier(overworld,
		HolderSet.direct(placedLookup.getOrThrow(ORE_SULFUR_PLACED)), Decoration.UNDERGROUND_ORES));
	context.register(ORE_SYLVITE_MODIFIER, new AddFeaturesBiomeModifier(overworld,
		HolderSet.direct(placedLookup.getOrThrow(ORE_SYLVITE_PLACED)), Decoration.UNDERGROUND_ORES));
	context.register(ORE_TIN_MODIFIER, new AddFeaturesBiomeModifier(overworld,
		HolderSet.direct(placedLookup.getOrThrow(ORE_TIN_PLACED)), Decoration.UNDERGROUND_ORES));
	context.register(ORE_TITANIUM_MODIFIER, new AddFeaturesBiomeModifier(overworld,
		HolderSet.direct(placedLookup.getOrThrow(ORE_TITANIUM_PLACED)), Decoration.UNDERGROUND_ORES));
	context.register(ORE_THORIUM_MODIFIER, new AddFeaturesBiomeModifier(overworld,
		HolderSet.direct(placedLookup.getOrThrow(ORE_THORIUM_PLACED)), Decoration.UNDERGROUND_ORES));
	context.register(ORE_URANIUM_MODIFIER, new AddFeaturesBiomeModifier(overworld,
		HolderSet.direct(placedLookup.getOrThrow(ORE_URANIUM_PLACED)), Decoration.UNDERGROUND_ORES));
	context.register(ORE_VANADIUM_MODIFIER, new AddFeaturesBiomeModifier(overworld,
		HolderSet.direct(placedLookup.getOrThrow(ORE_VANADIUM_PLACED)), Decoration.UNDERGROUND_ORES));
    }
