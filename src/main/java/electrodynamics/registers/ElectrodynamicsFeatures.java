...
public class ElectrodynamicsFeatures {
	...
	public static final DeferredRegister<ConfiguredFeature<?, ?>> CONFIGURED_FEATURES = DeferredRegister.create(Registry.CONFIGURED_FEATURE_REGISTRY, Electrodynamics.ID);
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> ORE_CHROMIUM_CONFIGURED = configured("ore_chromium", SubtypeOre.chromium, SubtypeOreDeepslate.chromium);
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> ORE_LITHIUM_CONFIGURED = configured("ore_lithium", SubtypeOre.lithium, SubtypeOreDeepslate.lithium);
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> ORE_SALT_CONFIGURED = configured("ore_salt", SubtypeOre.salt, SubtypeOreDeepslate.salt);
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> ORE_TITANIUM_CONFIGURED = configured("ore_titanium", SubtypeOre.titanium, SubtypeOreDeepslate.titanium);
	public static final RegistryObject<ConfiguredFeature<?, ?>> ORE_THORIUM_CONFIGURED = configured("ore_thorium", SubtypeOre.thorium, SubtypeOreDeepslate.thorium);
	public static final RegistryObject<ConfiguredFeature<?, ?>> ORE_URANIUM_CONFIGURED = configured("ore_uranium", SubtypeOre.uranium, SubtypeOreDeepslate.uranium);
	public static final RegistryObject<ConfiguredFeature<?, ?>> ORE_VANADIUM_CONFIGURED = configured("ore_vanadium", SubtypeOre.vanadium, SubtypeOreDeepslate.vanadium);
	...
	public static final DeferredRegister<PlacedFeature> PLACED_FEATURES = DeferredRegister.create(Registry.PLACED_FEATURE_REGISTRY, Electrodynamics.ID);
	...
	public static final RegistryObject<PlacedFeature> ORE_CHROMIUM_PLACED = placed("ore_chromium", ORE_CHROMIUM_CONFIGURED, (int) (SubtypeOre.chromium.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER), SubtypeOre.chromium.minY, SubtypeOre.chromium.maxY);
	...
	public static final RegistryObject<PlacedFeature> ORE_LITHIUM_PLACED = placed("ore_lithium", ORE_LITHIUM_CONFIGURED, (int) (SubtypeOre.lithium.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER), SubtypeOre.lithium.minY, SubtypeOre.lithium.maxY);
	...
	public static final RegistryObject<PlacedFeature> ORE_SALT_PLACED = placed("ore_salt", ORE_SALT_CONFIGURED, (int) (SubtypeOre.salt.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER), SubtypeOre.salt.minY, SubtypeOre.salt.maxY);
	...
	public static final RegistryObject<PlacedFeature> ORE_TITANIUM_PLACED = placed("ore_titanium", ORE_TITANIUM_CONFIGURED, (int) (SubtypeOre.titanium.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER), SubtypeOre.titanium.minY, SubtypeOre.titanium.maxY);
	public static final RegistryObject<PlacedFeature> ORE_THORIUM_PLACED = placed("ore_thorium", ORE_THORIUM_CONFIGURED, (int) (SubtypeOre.thorium.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER), SubtypeOre.thorium.minY, SubtypeOre.thorium.maxY);
	public static final RegistryObject<PlacedFeature> ORE_URANIUM_PLACED = placed("ore_uranium", ORE_URANIUM_CONFIGURED, (int) (SubtypeOre.uranium.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER), SubtypeOre.uranium.minY, SubtypeOre.uranium.maxY);
	public static final RegistryObject<PlacedFeature> ORE_VANADIUM_PLACED = placed("ore_vanadium", ORE_VANADIUM_CONFIGURED, (int) (SubtypeOre.vanadium.veinsPerChunk * OreConfig.ORE_GENERATION_MULTIPLIER), SubtypeOre.vanadium.minY, SubtypeOre.vanadium.maxY);
	...
	private static ResourceLocation modifier(String name) {
		return new ResourceLocation(Electrodynamics.ID, name);
	}
}
