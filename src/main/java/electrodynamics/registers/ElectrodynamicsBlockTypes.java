...
public class ElectrodynamicsBlockTypes {
    ...
    public static final RegistryObject<BlockEntityType<TileCoalGenerator>> TILE_COALGENERATOR = BLOCK_ENTITY_TYPES.register(SubtypeMachine.coalgenerator.tag(), () -> new BlockEntityType<>(TileCoalGenerator::new, Sets.newHashSet(getSafeBlock(SubtypeMachine.coalgenerator), getSafeBlock(SubtypeMachine.coalgeneratorrunning)), null));
    ...
    public static final RegistryObject<BlockEntityType<TileElectricFurnace>> TILE_ELECTRICFURNACE = BLOCK_ENTITY_TYPES.register(SubtypeMachine.electricfurnace.tag(), () -> new BlockEntityType<>(TileElectricFurnace::new, Sets.newHashSet(getSafeBlock(SubtypeMachine.electricfurnace), getSafeBlock(SubtypeMachine.electricfurnacerunning)), null));
    ...
    public static final RegistryObject<BlockEntityType<TileElectricFurnaceTriple>> TILE_ELECTRICFURNACETRIPLE = BLOCK_ENTITY_TYPES.register(SubtypeMachine.electricfurnacetriple.tag(), () -> new BlockEntityType<>(TileElectricFurnaceTriple::new, Sets.newHashSet(getSafeBlock(SubtypeMachine.electricfurnacetriple), getSafeBlock(SubtypeMachine.electricfurnacetriplerunning)), null));

    public static final RegistryObject<BlockEntityType<TileElectricArcFurnace>> TILE_ELECTRICARCFURNACE = BLOCK_ENTITY_TYPES.register(SubtypeMachine.electricarcfurnace.tag(), () -> new BlockEntityType<>(TileElectricArcFurnace::new, Sets.newHashSet(getSafeBlock(SubtypeMachine.electricarcfurnace), getSafeBlock(SubtypeMachine.electricarcfurnacerunning)), null));
