...
public class ElectrodynamicsSounds {
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> SOUND_HYDROELECTRICGENERATOR = sound(
	    "hydroelectricgenerator");
    public static final DeferredHolder<SoundEvent, SoundEvent> SOUND_WINDMILL = sound("windmill");
    public static final DeferredHolder<SoundEvent, SoundEvent> SOUND_CERAMICPLATEBREAKING = sound(
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> SOUND_RAILGUNKINETIC_NOAMMO = sound(
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> SOUND_RAILGUNPLASMA_NOPOWER = sound(
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> SOUND_ELECTROLYTICSEPARATOR = sound(
	    "electrolyticseparator");
    public static final DeferredHolder<SoundEvent, SoundEvent> SOUND_NIGHTVISIONGOGGLESON = sound(
	    "nightvisiongoggleson");
    public static final DeferredHolder<SoundEvent, SoundEvent> SOUND_NIGHTVISIONGOGGLESOFF = sound(
