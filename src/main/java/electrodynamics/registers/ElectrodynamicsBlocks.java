...
public class ElectrodynamicsBlocks {
    ...
    public static final BulkRegistryObject<BlockGasPipe, SubtypeGasPipe> BLOCKS_GASPIPE = new BulkRegistryObject<>(SubtypeGasPipe.values(), subtype -> BLOCKS.register(subtype.tag(), () -> new BlockGasPipe(subtype)));
    ...
    public static final RegistryObject<BlockCompressor> BLOCK_COMPRESSOR = BLOCKS.register("compressor", () -> new BlockCompressor(false));
    public static final RegistryObject<BlockCompressor> BLOCK_DECOMPRESSOR = BLOCKS.register("decompressor", () -> new BlockCompressor(true));
    public static final RegistryObject<BlockAdvancedCompressor> BLOCK_ADVANCEDCOMPRESSOR = BLOCKS.register("advancedcompressor", () -> new BlockAdvancedCompressor(false));
    public static final RegistryObject<BlockAdvancedCompressor> BLOCK_ADVANCEDDECOMPRESSOR = BLOCKS.register("advanceddecompressor", () -> new BlockAdvancedCompressor(true));
    public static final RegistryObject<BlockGasTransformerSide> BLOCK_COMPRESSOR_SIDE = BLOCKS.register("compressorside", BlockGasTransformerSide::new);
    public static final RegistryObject<BlockGasTransformerAddonTank> BLOCK_COMPRESSOR_ADDONTANK = BLOCKS.register("compressoraddontank", BlockGasTransformerAddonTank::new);
