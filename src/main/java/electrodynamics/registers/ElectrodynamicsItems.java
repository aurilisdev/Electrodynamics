...
public class ElectrodynamicsItems {
	...
	public static final BulkRegistryObject<ItemVoltaic, SubtypeRawOre> ITEMS_RAWORE = new BulkRegistryObject<>(SubtypeRawOre.values(), subtype -> ITEMS.register(subtype.tag(), () -> new ItemVoltaic(new Item.Properties(), () -> ElectrodynamicsCreativeTabs.MAIN)));
	...
	public static final RegistryObject<ItemCompositeArmor> ITEM_COMPOSITEHELMET = ITEMS.register("compositearmorhelmet", () -> new ItemCompositeArmor(EquipmentSlot.HEAD));
	public static final RegistryObject<ItemCompositeArmor> ITEM_COMPOSITECHESTPLATE = ITEMS.register("compositearmorchestplate", () -> new ItemCompositeArmor(EquipmentSlot.CHEST));
	public static final RegistryObject<ItemCompositeArmor> ITEM_COMPOSITELEGGINGS = ITEMS.register("compositearmorleggings", () -> new ItemCompositeArmor(EquipmentSlot.LEGS));
	public static final RegistryObject<ItemCompositeArmor> ITEM_COMPOSITEBOOTS = ITEMS.register("compositearmorboots", () -> new ItemCompositeArmor(EquipmentSlot.FEET));

	public static final RegistryObject<ItemRubberArmor> ITEM_RUBBERBOOTS = ITEMS.register("rubberboots", () -> new ItemRubberArmor(EquipmentSlot.FEET, new Item.Properties().stacksTo(1).durability(100000), () -> ElectrodynamicsCreativeTabs.MAIN));
	...
	public static final RegistryObject<ItemCombatArmor> ITEM_COMBATHELMET = ITEMS.register("combatarmorhelmet", () -> new ItemCombatArmor(new ElectricItemProperties().capacity(1666666.66667).extract(TransferPack.joulesVoltage(1666666.66667 / (120.0 * 20.0), 120)).receive(TransferPack.joulesVoltage(1666666.66667 / (120.0 * 20.0), 120)).stacksTo(1).fireResistant(), EquipmentSlot.HEAD, () -> ElectrodynamicsCreativeTabs.MAIN));
	public static final RegistryObject<ItemCombatArmor> ITEM_COMBATCHESTPLATE = ITEMS.register("combatarmorchestplate", () -> new ItemCombatArmor(new Item.Properties().stacksTo(1).fireResistant(), EquipmentSlot.CHEST, () -> ElectrodynamicsCreativeTabs.MAIN));
	public static final RegistryObject<ItemCombatArmor> ITEM_COMBATLEGGINGS = ITEMS.register("combatarmorleggings", () -> new ItemCombatArmor(new ElectricItemProperties().capacity(1666666.66667).extract(TransferPack.joulesVoltage(1666666.66667 / (120.0 * 20.0), 120)).receive(TransferPack.joulesVoltage(1666666.66667 / (120.0 * 20.0), 120)).stacksTo(1).fireResistant(), EquipmentSlot.LEGS, () -> ElectrodynamicsCreativeTabs.MAIN));
	public static final RegistryObject<ItemCombatArmor> ITEM_COMBATBOOTS = ITEMS.register("combatarmorboots", () -> new ItemCombatArmor(new Item.Properties().stacksTo(1), EquipmentSlot.FEET, () -> ElectrodynamicsCreativeTabs.MAIN));
