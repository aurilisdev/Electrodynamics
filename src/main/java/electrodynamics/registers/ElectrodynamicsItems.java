...
public class ElectrodynamicsItems {
	...
	public static final RegistryObject<Item> ITEM_CONCRETEMIX = ITEMS.register("concretemix", supplier(() -> new ItemDescriptable(new Item.Properties().stacksTo(64).tab(References.CORETAB), ElectroTextUtils.tooltip("concretemixjoke")))); //TODO add translation
	...
	public static final RegistryObject<Item> ITEM_ELECTRICBATON = ITEMS.register("electricbaton", supplier(() -> new ItemElectricBaton((ElectricItemProperties) new ElectricItemProperties().capacity(1666666.66667 * 4).extract(TransferPack.joulesVoltage(4 * 1666666.66667 / (120.0 * 20.0), 240)).receive(TransferPack.joulesVoltage(4 * 1666666.66667 / (120.0 * 20.0), 240)).tab(References.CORETAB).stacksTo(1))));
	...
	public static final RegistryObject<Item> ITEM_SEISMICSCANNER = ITEMS.register("seismicscanner", supplier(() -> new ItemSeismicScanner((ElectricItemProperties) new ElectricItemProperties().capacity(1666666.66667).extract(TransferPack.joulesVoltage(1666666.66667 / (120.0 * 20.0), 120)).receive(TransferPack.joulesVoltage(1666666.66667 / (120.0 * 20.0), 120)).tab(References.CORETAB).stacksTo(1))));
	public static final RegistryObject<Item> ITEM_MECHANIZEDCROSSBOW = ITEMS.register("mechanizedcrossbow", supplier(() -> new ItemMechanizedCrossbow((ElectricItemProperties) new ElectricItemProperties().capacity(1666666.66667).extract(TransferPack.joulesVoltage(1666666.66667 / (120.0 * 20.0), 120)).receive(TransferPack.joulesVoltage(1666666.66667 / (120.0 * 20.0), 120)).tab(References.CORETAB).stacksTo(1))));
