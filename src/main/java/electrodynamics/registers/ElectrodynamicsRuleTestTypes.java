...
public class ElectrodynamicsRuleTestTypes {
    ...
    public static final DeferredRegister<RuleTestType<?>> RULE_TEST_TYPES = DeferredRegister
	    .create(Registry.RULE_TEST_REGISTRY, Electrodynamics.ID);

    public static final RegistryObject<RuleTestType<?>> TEST_CONFIG_ORESPAWN = RULE_TEST_TYPES
	    .register("configorespawn", () -> new RuleTestType<RuleTestOre>() {
