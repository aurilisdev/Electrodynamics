...
public class ElectrodynamicsRecipies {
    ...
    // Deferred Register
    public static final DeferredRegister<RecipeSerializer<?>> RECIPE_SERIALIZER = DeferredRegister.create(Registries.RECIPE_SERIALIZER, Electrodynamics.ID);
    
    public static final DeferredRegister<RecipeType<?>> RECIPE_TYPES = DeferredRegister.create(Registries.RECIPE_TYPE, Electrodynamics.ID);

    
    /* RECIPE TYPES */

    // Item2Item
    public static final DeferredHolder<RecipeType<?>, RecipeType<WireMillRecipe>> WIRE_MILL_TYPE = RECIPE_TYPES.register(WireMillRecipe.RECIPE_GROUP, VoltaicRecipeType::new);
    public static final DeferredHolder<RecipeType<?>, RecipeType<MineralGrinderRecipe>> MINERAL_GRINDER_TYPE = RECIPE_TYPES.register(MineralGrinderRecipe.RECIPE_GROUP, VoltaicRecipeType::new);
    public static final DeferredHolder<RecipeType<?>, RecipeType<MineralCrusherRecipe>> MINERAL_CRUSHER_TYPE = RECIPE_TYPES.register(MineralCrusherRecipe.RECIPE_GROUP, VoltaicRecipeType::new);
    public static final DeferredHolder<RecipeType<?>, RecipeType<LatheRecipe>> LATHE_TYPE = RECIPE_TYPES.register(LatheRecipe.RECIPE_GROUP, VoltaicRecipeType::new);
    public static final DeferredHolder<RecipeType<?>, RecipeType<OxidationFurnaceRecipe>> OXIDATION_FURNACE_TYPE = RECIPE_TYPES.register(OxidationFurnaceRecipe.RECIPE_GROUP, VoltaicRecipeType::new);
    public static final DeferredHolder<RecipeType<?>, RecipeType<EnergizedAlloyerRecipe>> ENERGIZED_ALLOYER_TYPE = RECIPE_TYPES.register(EnergizedAlloyerRecipe.RECIPE_GROUP, VoltaicRecipeType::new);
    public static final DeferredHolder<RecipeType<?>, RecipeType<ReinforcedAlloyerRecipe>> REINFORCED_ALLOYER_TYPE = RECIPE_TYPES.register(ReinforcedAlloyerRecipe.RECIPE_GROUP, VoltaicRecipeType::new);

    // FluidItem2Fluid
    public static final DeferredHolder<RecipeType<?>, RecipeType<ChemicalMixerRecipe>> CHEMICAL_MIXER_TYPE = RECIPE_TYPES.register(ChemicalMixerRecipe.RECIPE_GROUP, VoltaicRecipeType::new);
    public static final DeferredHolder<RecipeType<?>, RecipeType<FermentationPlantRecipe>> FERMENTATION_PLANT_TYPE = RECIPE_TYPES.register(FermentationPlantRecipe.RECIPE_GROUP, VoltaicRecipeType::new);
    public static final DeferredHolder<RecipeType<?>, RecipeType<MineralWasherRecipe>> MINERAL_WASHER_TYPE = RECIPE_TYPES.register(MineralWasherRecipe.RECIPE_GROUP, VoltaicRecipeType::new);

    // Fluid2Item
    public static final DeferredHolder<RecipeType<?>, RecipeType<ChemicalCrystalizerRecipe>> CHEMICAL_CRYSTALIZER_TYPE = RECIPE_TYPES.register(ChemicalCrystalizerRecipe.RECIPE_GROUP, VoltaicRecipeType::new);

    // Fluid2Gas
    public static final DeferredHolder<RecipeType<?>, RecipeType<ElectrolyticSeparatorRecipe>> ELECTROLYTIC_SEPERATOR_TYPE = RECIPE_TYPES.register(ElectrolyticSeparatorRecipe.RECIPE_GROUP, VoltaicRecipeType::new);

    public static final DeferredHolder<RecipeType<?>, RecipeType<ChemicalReactorRecipe>> CHEMICAL_REACTOR_TYPE = RECIPE_TYPES.register(ChemicalReactorRecipe.RECIPE_GROUP, VoltaicRecipeType::new);

    // Fluid2Fluid

    public static final DeferredHolder<RecipeType<?>, RecipeType<ElectrolosisChamberRecipe>> ELECTROLOSIS_CHAMBER_TYPE = RECIPE_TYPES.register(ElectrolosisChamberRecipe.RECIPE_GROUP, VoltaicRecipeType::new);
