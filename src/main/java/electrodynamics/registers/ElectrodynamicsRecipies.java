...
public class ElectrodynamicsRecipies {
    ...
    // Fluid2Gas
    public static final RegistryObject<RecipeSerializer<?>> ELECTROLYTIC_SEPARATOR_SERIALIZER = RECIPE_SERIALIZER.register(ElectrolyticSeparatorRecipe.RECIPE_GROUP, () -> new Fluid2GasRecipeSerializer<>(ElectrolyticSeparatorRecipe::new));
