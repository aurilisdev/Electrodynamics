...
public abstract class O2OProcessingRecipeCategory implements IRecipeCategory<O2OProcessingRecipe>{
	...
	public O2OProcessingRecipeCategory(IGuiHelper guiHelper, String modID, String recipeGroup, 
			String guiTexture, ItemStack inputMachine, ArrayList<int[]> inputCoordinates, int smeltTime,
			int textYHeight, IDrawableAnimated.StartDirection arrowStartDirection) {
		/*
