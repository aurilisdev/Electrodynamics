...
public abstract class SolAndLiqToSolidRecipeCategory implements IRecipeCategory<PsuedoSolAndLiqToSolidRecipe> {
    ...
    public SolAndLiqToSolidRecipeCategory(IGuiHelper guiHelper, String modID, String recipeGroup, String guiTexture, ItemStack inputMachine,
	...
	OutputItemOffset = inputCoordinates.get(6);
