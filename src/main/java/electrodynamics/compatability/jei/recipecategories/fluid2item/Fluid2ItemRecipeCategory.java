...
public abstract class Fluid2ItemRecipeCategory extends ElectrodynamicsRecipeCategory<Fluid2ItemRecipe> {
	...
	/* DOCUMENTATION NOTES:
	 * 
	 * > Items supercede bucket slots in position 
    ...
    public Fluid2ItemRecipeCategory(IGuiHelper guiHelper, String modID, String recipeGroup, ItemStack inputMachine,
    ...
    private List<List<FluidStack>> getFluidInputs(Fluid2ItemRecipe recipe) {
    ...
    private List<List<ItemStack>> getItemInputs(Fluid2ItemRecipe recipe) {
    ...
    private List<ItemStack> getItemOutputs(Fluid2ItemRecipe recipe){
