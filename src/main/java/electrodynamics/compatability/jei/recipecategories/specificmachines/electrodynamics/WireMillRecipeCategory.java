...
public class WireMillRecipeCategory extends O2OProcessingRecipeCategory {
    ...
    private static String recipeGroup = "wiremill";
    private static String guiTexture = "textures/gui/jei/o2o_recipe_gui.png";
    private static ItemStack inputMachine = new ItemStack(DeferredRegisters.SUBTYPEBLOCK_MAPPINGS.get(SubtypeMachine.wiremill));
