...
public class MineralGrinderRecipeCategory extends O2OProcessingRecipeCategory{
	...
	private static ItemStack inputMachine = 
			new ItemStack(DeferredRegisters.SUBTYPEBLOCK_MAPPINGS.get(SubtypeMachine.mineralgrinder));
