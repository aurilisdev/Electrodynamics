...
public class ExtruderRecipeCategory extends O2ORecipeCategory{
    ...
    private static String RECIPE_GROUP = "extruder";
    private static String GUI_TEXTURE = "textures/gui/jei/o2o_recipe_gui.png";

    public static ItemStack INPUT_MACHINE = new ItemStack(DeferredRegisters.SUBTYPEBLOCK_MAPPINGS.get(SubtypeMachine.extruder));
