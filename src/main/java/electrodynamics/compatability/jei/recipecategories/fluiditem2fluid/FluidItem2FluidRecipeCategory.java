package electrodynamics.compatability.jei.recipecategories.fluiditem2fluid;
...
public abstract class FluidItem2FluidRecipeCategory extends ElectrodynamicsRecipeCategory<FluidItem2FluidRecipe> {
	...
	/* DOCUMENTATION NOTES:
	 * 
	 * > Items supercede bucket slots in order
    ...
    public FluidItem2FluidRecipeCategory(IGuiHelper guiHelper, String modID, String recipeGroup, ItemStack inputMachine,
    ...
    private List<List<FluidStack>> getFluidInputs(FluidItem2FluidRecipe recipe) {
    ...
    private List<List<ItemStack>> getItemInputs(FluidItem2FluidRecipe recipe) {
    ...
    private List<ItemStack> getItemOutputs(FluidItem2FluidRecipe recipe){
    ...
    private List<FluidStack> getFluidOutputs(FluidItem2FluidRecipe recipe){
