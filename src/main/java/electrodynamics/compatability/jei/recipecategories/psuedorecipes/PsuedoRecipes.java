...
public class PsuedoRecipes {
	...
	public static ArrayList<ArrayList<ItemStack>> ELECTRODYNAMICS_ITEMS = new ArrayList<ArrayList<ItemStack>>();
	public static ArrayList<Fluid> ELECTRODYNAMICS_FLUIDS = new ArrayList<Fluid>();
