...
public abstract class Fluid2ItemRecipeCategory extends ElectrodynamicsRecipeCategory<Fluid2ItemRecipe>{
	...
	public Fluid2ItemRecipeCategory(IGuiHelper guiHelper, String modID, String recipeGroup, String guiTexture, ItemStack inputMachine,
			ArrayList<int[]> inputCoordinates, int smeltTime, StartDirection majorArrowDirection, StartDirection minorArrowDirection,int textYHeight) {
		 ...
		 * 
		 * fifth array is offset of input fluid tank [startx,endy,width,height,maxcapacity]
		 * 
		 ...
		 *
		 *
		 * seventh array is offset of Major Processing arrow 
		 * Eighth array is offset of Minor Processing arrow
		 * 
		 * 
		 * 
		 */
