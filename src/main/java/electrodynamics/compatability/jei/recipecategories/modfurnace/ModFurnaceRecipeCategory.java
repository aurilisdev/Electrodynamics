package electrodynamics.compatability.jei.recipecategories.modfurnace;
...
public abstract class ModFurnaceRecipeCategory implements IRecipeCategory<SmeltingRecipe> {
    ...
    public ModFurnaceRecipeCategory(IGuiHelper guiHelper, String modID, String recipeGroup, ItemStack inputMachine,
	    BackgroundWrapper wrapper, int animTime) {
