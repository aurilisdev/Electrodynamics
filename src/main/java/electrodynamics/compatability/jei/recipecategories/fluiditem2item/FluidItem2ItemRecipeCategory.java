...
public abstract class FluidItem2ItemRecipeCategory extends ElectrodynamicsRecipeCategory<FluidItem2ItemRecipe> {
    ...
    public FluidItem2ItemRecipeCategory(IGuiHelper guiHelper, String modID, String recipeGroup, ItemStack inputMachine,
    ...
    private List<List<FluidStack>> getFluidInputs(FluidItem2ItemRecipe recipe) {
    ...
    private List<List<ItemStack>> getItemInputs(FluidItem2ItemRecipe recipe) {
    ...
    private List<ItemStack> getItemOutputs(FluidItem2ItemRecipe recipe){
