package physica.content.common.effect.damage;
...
public class DamageSourceRadiation extends DamageSource {
	...
	public IChatComponent func_151519_b(EntityLivingBase entity) {
		if (entity instanceof EntityPlayer) return new ChatComponentText(((EntityPlayer) entity).getDisplayName() + " died from radiation exposure");
