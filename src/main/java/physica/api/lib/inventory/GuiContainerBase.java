...
import physica.api.lib.inventory.slot.IRenderableSlot;
...
public class GuiContainerBase<T extends IInventory & IPlayerUsing> extends GuiContainer {
	public static final ResourceLocation	GUI_COMPONENTS			= new ResourceLocation(References.DOMAIN, References.GUI_TEXTURE_DIRECTORY + "gui_components.png");
	public static final ResourceLocation	GUI_BASE				= new ResourceLocation(References.DOMAIN, References.GUI_TEXTURE_DIRECTORY + "gui_base.png");
	...
	protected void drawGuiContainerBackgroundLayer(float f, int mouseX, int mouseY) {
		...
		drawTexturedModalRect(this.containerWidth, this.containerHeight, 0, 0, xSize, ySize);
	...
	protected void drawElectricityTopBar(float scale) {
		drawElectricity(0, -1 - electricityMeterHeight, scale);
	}
