...
public class PacketBase implements IPacket {
	protected List<Object>	writeData	= new ArrayList();
	...
	protected void writeData(Object object, ByteBuf buffer) {
		...
		} else throw new IllegalArgumentException("PacketBase: Unsupported write method for " + object.getClass().getSimpleName());
	}
