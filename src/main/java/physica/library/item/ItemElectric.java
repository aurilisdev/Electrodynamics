...
public class ItemElectric extends Item implements IElectricItem {
	...
	public void addInformation(ItemStack stack, EntityPlayer player, @SuppressWarnings("rawtypes") List info, boolean par4)
	{
		...
		info.add(EnumChatFormatting.AQUA + "Energy Stored: " + EnumChatFormatting.GRAY + ElectricityDisplay.getDisplay(ElectricityUtilities.convertEnergy(getElectricityStored(stack), Unit.RF, Unit.WATTHOUR), Unit.WATTHOUR));
	}
