...
public class ItemUpdateUranium implements IItemUpdate {
	...
	public void onEntityItemUpdate(ItemStack stack, EntityItem entity) {
		...
		List<EntityLivingBase> entities = entity.worldObj.getEntitiesWithinAABB(EntityLivingBase.class, AxisAlignedBB.getBoundingBox(entity.posX - scale, entity.posY - scale, entity.posZ - scale, entity.posX + scale, entity.posY + scale, entity.posZ + scale));
