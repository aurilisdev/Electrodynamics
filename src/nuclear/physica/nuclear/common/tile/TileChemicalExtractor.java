...
public class TileChemicalExtractor extends TileBasePoweredContainer implements IGuiInterface, IFluidHandler {
	...
	public boolean isItemValidForSlot(int slot, ItemStack stack) {
		return slot != SLOT_OUTPUT && stack != null && (slot == SLOT_ENERGY ? AbstractionLayer.Electricity.isItemElectric(stack) : slot == SLOT_INPUT && stack.getItem() == Items.water_bucket || RecipeSystem.isRecipeInput(getClass(), stack));
	}
