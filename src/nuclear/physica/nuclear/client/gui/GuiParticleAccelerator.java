...
public class GuiParticleAccelerator extends GuiContainerBase<TileParticleAccelerator> implements IBaseUtilities {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
	{
		...
		drawString("Used: " + ElectricityDisplay.getDisplayShort(ElectricityUtilities.convertEnergy(host.getSessionUse() * host.getCurrentSessionTicks() / 3600.0, Unit.RF, Unit.WATT), Unit.WATT) + "h", 8, 52);
