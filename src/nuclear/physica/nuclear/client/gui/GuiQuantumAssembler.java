...
public class GuiQuantumAssembler extends GuiContainerBase<TileQuantumAssembler> {
	...
	public static final ResourceLocation GUI_ASSEMBLER = new ResourceLocation(NuclearReferences.DOMAIN, CoreReferences.GUI_TEXTURE_DIRECTORY + "gui_assembler.png");
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
	{
		...
		fontRendererObj.drawString("Progress: " + (int) ((float) host.getOperatingTicks() / host.getTicksRequired() * 100) + "%", xSize / 2 - 80, ySize - 106, 0x404040);
