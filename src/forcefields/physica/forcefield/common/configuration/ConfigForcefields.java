...
public class ConfigForcefields implements IContent {
	...
	public void register(LoadPhase phase) {
		if (phase == LoadPhase.ConfigRegister) {
			...
			FORCEFIELD_INTERIOR_MODULE_DOWNSIZE = configuration.getFloat("forcefieldInteriorModuleDownsize", CATEGORY, FORCEFIELD_INTERIOR_MODULE_DOWNSIZE, 1f, 100f, "Interior module downsizer. The max radius for the interior module will be the radius of the forcefield divided by this value.");
			configuration.save();
		}
	}
}
