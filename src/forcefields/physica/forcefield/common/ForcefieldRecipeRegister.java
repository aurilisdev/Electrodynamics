...
public class ForcefieldRecipeRegister implements IContent, IBaseUtilities {
	...
	public void register(LoadPhase phase)
	{
		if (phase == LoadPhase.OnStartup)
		{
			...
			// Modules Upgrade
			addRecipe(new ItemStack(ForcefieldItemRegister.moduleMap.get("moduleUpgradeSpeed").getItem(), 3, ForcefieldItemRegister.moduleMap.get("moduleUpgradeSpeed").getItemDamage()), "FFF", "RRR", "FFF", 'F',
					ForcefieldItemRegister.itemFocusMatrix, 'R', Items.redstone);
			addRecipe(new ItemStack(ForcefieldItemRegister.moduleMap.get("moduleUpgradeCapacity").getItem(), 2, ForcefieldItemRegister.moduleMap.get("moduleUpgradeCapacity").getItemDamage()), "FCF", 'F',
					ForcefieldItemRegister.itemFocusMatrix, 'C', "phyBattery");
			...
			addRecipe(ForcefieldItemRegister.moduleMap.get("moduleUpgradeColorChange"), "FLF", "BWR", "FGF", 'F', ForcefieldItemRegister.itemFocusMatrix, 'L', new ItemStack(Items.dye, 1, 4), 'B', new ItemStack(Items.dye, 1, 12), 'R',
					new ItemStack(Items.dye, 1, 1), 'G', new ItemStack(Items.dye, 1, 2), 'W', Item.getItemFromBlock(Blocks.wool));

			addRecipe(ForcefieldItemRegister.moduleMap.get("moduleUpgradeAntiHostile"), " F ", "GFB", " G ", 'F', Items.rotten_flesh, 'G', Items.gunpowder, 'F', ForcefieldItemRegister.itemFocusMatrix, 'B', Items.bone, 'G',
					Items.ghast_tear);
			addRecipe(ForcefieldItemRegister.moduleMap.get("moduleUpgradeAntiFriendly"), " H ", "LFC", " S ", 'H', Item.getItemFromBlock(Blocks.hay_block), 'L', Items.leather, 'F', ForcefieldItemRegister.itemFocusMatrix, 'C',
					Items.cooked_porkchop, 'S', Items.slime_ball);
			...
			addRecipe(new ItemStack(ForcefieldItemRegister.moduleMap.get("moduleManipulationTranslate").getItem(), 2, ForcefieldItemRegister.moduleMap.get("moduleManipulationTranslate").getItemDamage()), "FSF", 'F',
					ForcefieldItemRegister.itemFocusMatrix, 'S', ForcefieldItemRegister.moduleMap.get("moduleManipulationScale").getItem());
