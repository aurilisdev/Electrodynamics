...
public class ForcefieldRecipeRegister implements IContent, IBaseUtilities {
	...
	public void loadComplete()
	{
		...
		addRecipe(new ItemStack(ForcefieldItemRegister.moduleMap.get("moduleUpgradeCapacity").getItem(), 2, ForcefieldItemRegister.moduleMap.get("moduleUpgradeCapacity").getItemDamage()), "FCF", 'F', ForcefieldItemRegister.itemFocusMatrix,
				'C', "phyBattery");
