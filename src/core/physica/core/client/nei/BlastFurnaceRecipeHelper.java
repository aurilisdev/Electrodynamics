...
public class BlastFurnaceRecipeHelper extends PhysicaRecipeHandlerBase {
	...
	public void loadCraftingRecipes(String outputId, Object... results) {
		if (outputId.equals(getRecipeID()) || "item".equals(outputId) && results[0] != null && results[0] instanceof ItemStack && ("item." + CoreItemRegister.itemMetaIngot.subItems.get(2)).equals(((ItemStack) results[0]).getUnlocalizedName())) {
			findFuels();
	...
	public void loadUsageRecipes(String inputId, Object... ingredients) {
		if (inputId.equals(getRecipeID()) || "fuel".equals(inputId) || "item".equals(inputId) && ingredients[0] != null && ingredients[0] instanceof ItemStack && ("item." + CoreItemRegister.itemMetaIngot.subItems.get(2)).equals(((ItemStack) ingredients[0]).getUnlocalizedName())) {
			findFuels();
			arecipes.add(new SmeltingPair(new ItemStack(Items.iron_ingot), new ItemStack(CoreItemRegister.itemMetaIngot, 1, 2)));
		}
	}
