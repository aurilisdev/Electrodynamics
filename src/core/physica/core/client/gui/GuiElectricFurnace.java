...
public class GuiElectricFurnace extends GuiContainerBase<TileElectricFurnace> {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
	{
		...
		drawString(ElectricityDisplay.getDisplayShort(ElectricityUtilities.convertEnergy(TileElectricFurnace.POWER_USAGE, Unit.RF, Unit.WATT), Unit.WATT), 82, 58, 4210752);
