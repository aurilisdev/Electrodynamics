...
public class Quat4d extends Tuple4d implements java.io.Serializable {
	...
	public final void mul(Quat4d q1)
	{
		...
		x = this.w * q1.x + q1.w * this.x + this.y * q1.z - z * q1.y;
		y = this.w * q1.y + q1.w * this.y - this.x * q1.z + z * q1.x;
		z = this.w * q1.z + q1.w * z + this.x * q1.y - this.y * q1.x;
		this.w = w;
		this.x = x;
		this.y = y;
	}
