...
public abstract class Tuple3d implements java.io.Serializable, Cloneable {
	...
	/**
	 * Sets the value of this tuple to the value of the xyz coordinates located in
	 ...
	 * different Tuple3d objects with identical data values (i.e., Tuple3d.equals
	...
	/**
	 * Returns true if the Object t1 is of type Tuple3d and all of the data members
	 * of t1 are equal to the corresponding data members in this Tuple3d.
	 *
	 * @param t1
