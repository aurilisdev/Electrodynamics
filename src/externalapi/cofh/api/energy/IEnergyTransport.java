...
public interface IEnergyTransport extends IEnergyProvider, IEnergyReceiver {
	...
	public enum InterfaceType {
		 ...
		 * {@link IEnergyProvider#extractEnergy}) should check that they contain less
		 * power than the source IEnergyTransport.
		 */
		BALANCE;
		 ...
		 *            {@link IEnergyTransport#getTransportState} (<tt>true</tt>) or to
	 ...
	 * IEnergyTransport, if its mode has changed from the opposite of your own mode
	 * on that side, you should change your mode to the opposite of its mode.
	 * <p>
	 ...
	 *
	 * @return The type of connection to establish on this side. <b>null is NOT a
	 *         valid value</b>
	 */
	InterfaceType getTransportState(ForgeDirection from);

	/**
	 * This method is provided primarily for the purposes of automation tools, and
	 * should not need to be called by another IEnergyTransport.
	 * <p>
	 * Calls to this method may fail if this IEnergyTransport has been secured by a
	 * user.
	 *
