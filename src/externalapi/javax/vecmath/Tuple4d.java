...
public abstract class Tuple4d implements java.io.Serializable, Cloneable {
	...
	/**
	 * Constructs and initializes a Tuple4d from the coordinates contained in the
	 * array.
	 *
	 * @param t
	...
	/**
	 * Gets the value of this tuple and places it into the array t of length four in
	 * x,y,z,w order.
	 *
	 * @param t
	...
	/**
	 * Sets the value of this tuple to the difference of itself and tuple t1 (this =
	 * this - t1).
	 *
	 * @param t1
	 *            the other tuple
	...
	/**
	 * Sets the value of this tuple to the scalar multiplication by s of tuple t1
	...
	/**
	 * Returns true if the Object t1 is of type Tuple4d and all of the data members
	 * of t1 are equal to the corresponding data members in this Tuple4d.
	 *
	 * @param t1
	 ...
	 * different Tuple4d objects with identical data values (i.e., Tuple4d.equals
