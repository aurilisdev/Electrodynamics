...
public abstract class Tuple2f implements java.io.Serializable, Cloneable {
	 ...
	 * different Tuple2f objects with identical data values (i.e., Tuple2f.equals
	...
	/**
	 * Returns true if the Object t1 is of type Tuple2f and all of the data members
	 * of t1 are equal to the corresponding data members in this Tuple2f.
	 *
	 * @param t1
