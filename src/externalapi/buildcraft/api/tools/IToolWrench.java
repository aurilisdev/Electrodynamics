...
public interface IToolWrench {
	...
	/***
	 * Callback after the wrench has been used. This can be used to decrease durability or for other purposes. To get the ItemStack that was used, check player.inventory.getCurrentItem()
	 *
	 * @param player - The player doing the wrenching
