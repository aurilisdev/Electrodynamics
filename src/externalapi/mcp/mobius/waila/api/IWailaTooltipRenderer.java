...
public interface IWailaTooltipRenderer {
	 ...
	 * 
	 * @param params
	 *            Array of string parameters as passed to the RENDER arg in the
	 *            tooltip ({rendername,param1,param2,...})
	 * @param accessor
	...
	/**
	 * Draw method for the renderer. The GL matrice is automatically moved to the
	 * top left of the reserved zone.<br>
